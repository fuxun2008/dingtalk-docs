...
| **Before** | **After** |
|---|---|
| YiDA attachment downloads could only be disabled or enabled as a whole, with no control by app.<br />![](https://gw.alicdn.com/imgextra/i4/O1CN014CJWKWbwJMI4s7YG_!!6000000002943-2-tps-2400-1688.png) | Configure attachment controls flexibly by combining conditions such as **specific network IP segments**, **specific organization groups**, and **specific YiDA Apps**.<br />![](https://gw.alicdn.com/imgextra/i2/O1CN01EfVns1nlxcC4s7YG_!!6000000006180-2-tps-2400-1688.png) |
