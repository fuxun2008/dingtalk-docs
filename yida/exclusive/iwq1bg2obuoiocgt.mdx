...
<Steps>
  ...
  <Step title="Step 3">
    Select the page you want to publish separately, then click <Icon <img className="inline-icon" src="https://gw.alicdn.com/imgextra/i3/O1CN01aOJXYIVdCrB02GUA_!!6000000003690-2-tps-18-12.png" width="18" alt="" /> icon="ellipsis" /> > **Publish page**.
  </Step>
  <Step title="Step 4">
