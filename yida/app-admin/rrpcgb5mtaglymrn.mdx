...
<Accordion id="q2" title="Q: How do I resolve Data Source errors (partial list)?">
  ...
  |---|---|
| data source validate failed.connectionInfo isn't correct | YiDA only supports the public network. If the database does not expose a public network endpoint, YiDA cannot access it.<br />![](https://gw.alicdn.com/imgextra/i4/O1CN01baOt8ON4c9F1MT3v_!!6000000002770-2-tps-671-600.png) |
...
| If your organization's database uses a public network IP allowlist,<br />add the following entries to avoid being blocked by firewalls or other network settings:<br />• 106.11.0.0/16<br />• 203.119.128.0/17<br />• 59.82.0.0/16<br />• 140.205.0.0/16 | Failed to connect to a database-type Data Source, with a prompt to check the firewall.<br />![](https://gw.alicdn.com/imgextra/i4/O1CN01HbadQ7TwTMK2pzF4_!!6000000004603-2-tps-1398-1420.png) |
  |---|---|
</Accordion>
