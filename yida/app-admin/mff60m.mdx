...
By default, a YiDA form redirects after submission. The redirect target may be the success prompt page (PC), the details page (mobile), or a page specified by the user ([Form settings](https://docs.aliwork.com/docs/yida_support/yida_qalist/uop0b0ndpgc0gevb/ovg9ul)).
