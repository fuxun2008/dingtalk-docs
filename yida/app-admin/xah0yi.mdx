...
<AccordionGroup>
<Accordion title="4.1 Why did acceleration fail?">
...
<Accordion title="4.2 Why does configuring a data source return an error?">
  (1) Error 1
...
<Accordion title="4.3 Can the default update interval for a MySQL database connected in data preparation be changed?">
