...
|---|---|---|
| Fill in Form: Modify current Form | The Admin specifies the fields to be modified.<br />![](https://gw.alicdn.com/imgextra/i2/O1CN01xRiz6Yo249B6nSLm_!!6000000004405-2-tps-3348-1722.png) | In access mode, clicking the Button opens a dialog that shows the editable fields.<br />![](https://gw.alicdn.com/imgextra/i3/O1CN01ieQxKfE9S4D6mCJ0_!!6000000002137-2-tps-3338-1728.png) |
| Fill in Form: Fill in an associated form | The Admin selects the associated form to be filled in when the Button is clicked.<br />![](https://gw.alicdn.com/imgextra/i3/O1CN01atM6mvtVf5I6nSKo_!!6000000004514-2-tps-3348-1662.png) | If the associated form is configured with association-fill logic, the current Form's field values are auto-filled into the associated form when the custom Button is triggered.<br />Example: In the "Follow-up record" form, an associated form "Customer" is set, and association-fill is configured.<br />Result: On the "Customer" form detail page, click "Fill in follow-up record".<br />The customer's basic information is automatically filled into the "Follow-up record" form.<br />![](https://gw.alicdn.com/imgextra/i3/O1CN01ALjEIRV4mdG3C0vo_!!6000000004999-2-tps-1573-955.png)<br />![](https://gw.alicdn.com/imgextra/i2/O1CN01xd0XFcSkApF6mhWc_!!6000000001819-2-tps-3342-1732.png)<br />![](https://gw.alicdn.com/imgextra/i4/O1CN01h1einLlzC5C6nCk6_!!6000000005414-2-tps-3346-1728.png) |
| Execute an integration & automation flow | • Create a new integration & automation flow. This redirects you to the flow designer and automatically creates an automation flow with the trigger type "Manual trigger - Custom button trigger", with the current Form pre-selected.<br />• If the current Form already has an automation flow of type "Manual trigger - Custom button trigger", you can also select one from the drop-down list.<br />When creating a new integration & automation flow, you can choose to create it with the trigger type "Manual trigger - Custom button trigger" and select the target Form.<br />![](https://gw.alicdn.com/imgextra/i1/O1CN019FSk48Vk2pI6mhVc_!!6000000001170-2-tps-3342-1670.png)<br />![](https://gw.alicdn.com/imgextra/i3/O1CN01MXIoKnYttiB6oDA2_!!6000000007523-2-tps-3354-1656.png)<br />![](https://gw.alicdn.com/imgextra/i2/O1CN014XRWSVdtjaF6nSKe_!!6000000003445-2-tps-3348-1652.png) | ![](https://gw.alicdn.com/imgextra/i4/O1CN01od9ABZsJQCK6mx8O_!!6000000001872-2-tps-3344-1732.png) |
