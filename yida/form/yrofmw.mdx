...
## 2. Video tutorial on report formulas
...
Report formula fields can use only the functions listed in this document. Using functions outside this document triggers an error. See the following error screenshot:
