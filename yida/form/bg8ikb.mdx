...
<Warning>
The paid edition of the data management page supports searching 30,000 records **(the Free plan supports searching only 5,000 records; see the** [**upgrade prerequisites**](https://docs.aliwork.com/docs/yida_support/yida_updates/mw0bmqngpgz6sxba/bxefi9)**)**. If this limit is exceeded, an error appears. Use the Filter component to narrow the search scope.
</Warning>
...
| [**Sort**](https://docs.aliwork.com/docs/yida_support/yida_updates/_3/iglusc) | When there are many records, sort them in ascending or descending order by a specific field. Supported components: Single-line text, Multi-line text, Numerical, Select, Rating, and Date. |
...
Regular forms provide a quick copy feature for record details with no additional configuration required. Just open the record details page to use it. For workflow forms, enable the [**Copy workflow**](https://docs.aliwork.com/docs/yida_support/yida_qalist/uop0b0ndpgc0gevb/ovg9ul) button in Basic settings.
...
<Accordion title="3.3 Why are global search results inaccurate?">
  If the current app uses old storage, global search results may be inaccurate. For details about the search capability upgrade, see the [**upgrade notes**](https://docs.aliwork.com/docs/yida_support/yida_updates/mw0bmqngpgz6sxba/bxefi9).
