---
title: "Custom Component Example: Page Footer"
description: "Page footers appear at the bottom of web pages and typically contain copyright information and related links. This document explains how to build a page footer by creating a custom component and enabling the schema import feature."
polished: true
---
...
- Refer to this component to learn how to configure attributes, adapt to multiple devices, and more.
- This component is provided for learning purposes only and is not an official standard component.
</Note>

## 1. Use Case

The **page footer** appears at the bottom of web pages. It typically contains copyright information and related links, making it easier for visitors to navigate between pages.

## 3. Steps

##### 2. Enable the schema import feature. The process is the same as in the YiDA form designer. For details, refer to:
...
##### 3. Paste the schema below into the schema console of the component designer, then click Import schema.
