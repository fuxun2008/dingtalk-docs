---
title: "Image Cropping and Upload (Advanced)"
description: "This page explains how to implement image cropping and upload by packaging a custom component, covering the background, demo, and detailed steps. Note that this component is provided for learning purposes only and is not an official standard component."
polished: true
---

<Note>
- This component is further encapsulated based on [Custom component example - Image cropping and upload (intermediate)](/yida/form/eu0e6k), which reduces the usage cost for users.

- Note: This component is for learning purposes only and is not a standard component officially provided.
</Note>
