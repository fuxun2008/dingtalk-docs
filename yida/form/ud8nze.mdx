...
Configure an Associated table to display aggregated data on the relevant pages of the referenced form, and easily add, delete, modify, and query associated data.
