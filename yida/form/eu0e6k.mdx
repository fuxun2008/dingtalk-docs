---
title: "Image Crop Upload (Intermediate)"
description: "Learn how to build a form component from a general component, focusing on the implementation of the image crop upload feature. For learning purposes only — this is not an official standard component. Covers use cases, an effect demonstration, and detailed steps."
polished: true
---
