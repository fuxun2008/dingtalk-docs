...
Special thanks to [@n233333](https://www.yuque.com/n233333) for the simple bank card validation solution.
...
<AccordionGroup>
<Accordion title="4.1 What is the maximum number of components per form page?">
...
<Accordion title="4.2 Why isn't the Required setting taking effect?">
...
[Assign values to invisible fields](https://www.yuque.com/go/doc/30443554)