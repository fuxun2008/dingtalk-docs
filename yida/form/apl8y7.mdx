---
title: "Custom component example - App list"
description: "Learn how to create and configure a custom component that displays an app list. This guide covers use cases, an effect demo, and specific steps such as creating the component and enabling schema import."
polished: true
---
...
- Use this component as a reference for configuring attributes and multi-device support.
- This component is provided for learning purposes only and is not a standard component offered by the platform.
</Note>

## 1. Use case

The **App list** feature is commonly used on display pages.
...
##### 2. Enable the schema import feature. The process is the same as in the Yida form designer. For details, see the following:

- Open the component designer, open the browser console, and run the code below.
