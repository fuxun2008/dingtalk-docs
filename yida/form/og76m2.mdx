...
In a Connector Data Source, a Connector serves as the Data Source. This is designed to break through cross-origin and Authentication restrictions between systems and web Pages. For details, see [Use a Custom Connector to resolve cross-origin issues](https://www.yuque.com/yida/subject/vddims).
