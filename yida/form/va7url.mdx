...
<AccordionGroup>
<Accordion title="3.1 Why did the bulk submission fail?">
...
<Accordion title="3.2 How do I approve when the initiator is set to [YiDA platform] during bulk import?">
  ...
  In this case, use the following open API to perform the approval. For more details, see [**this reference**](https://www.yuque.com/yida-old/help/ihxi9r#evqcsm).
  ...
  | systemToken | App secret | Yes | hexxyyddd | Obtain from [App Data](https://www.yuque.com/yida/help/wre21z#qOo9q). |
