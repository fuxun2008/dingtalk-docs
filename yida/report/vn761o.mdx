...
The secondary metric works the same way as the year-over-year field in the [**2.0 report Metrics card**](https://docs.aliwork.com/docs/yida_support/yida_qalist/yxgxg6/izt5u6). It shows the trend of a specific metric value. For example, to compare the number of submissions today with yesterday, configure it as follows:
...
[HR and administration case study — Employee management system integrated with the workbench](https://docs.aliwork.com/docs/yida_support/yida_qalist/_1/_1/wzobdp)

[How do I display data from two tables in a single report component?](https://www.yuque.com/yida/subject/xn3uby#SXM9W)