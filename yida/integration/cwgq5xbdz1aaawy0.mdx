...
By combining Yida with connectors, you can submit a form to query employee check-in information, such as whether the employee has checked in, the check-in time, the check-in location, and more. This article explains how to query employee check-in information through a form.
