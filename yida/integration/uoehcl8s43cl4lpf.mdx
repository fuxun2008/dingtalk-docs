...
YiDA workflows let low-code developers add **Script** developer nodes when designing a workflow or integration & automation flow. Within a script node, developers can use JavaScript to manually insert static variables into the business flow, or format data returned by upstream nodes, making workflow configuration more flexible.
