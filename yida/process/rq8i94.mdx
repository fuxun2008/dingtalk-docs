...
<Steps>
  ...
  <Step title="Step 2">
    Select a workflow form, click the down arrow next to the workflow form, and then select **Workflow design**. <img className="inline-icon" src="https://gw.alicdn.com/imgextra/i2/O1CN01mNzMmzsdhoH07YI8_!!6000000003924-2-tps-60-56.png" width="20" alt="" />
  </Step>
</Steps>
