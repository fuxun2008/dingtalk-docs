...
![Practical example of a self-hosted Approval Center, where the approval task list supports filtering by source and batch approval](https://img.alicdn.com/imgextra/i4/O1CN01kjKGkqMTMqK3icNW_!!6000000000311-2-tps-1832-1138.png)
</Frame>
...
![Practical example of process handover: querying the pending approval task list for a specified employee in the Admin Console](https://img.alicdn.com/imgextra/i3/O1CN01C8Q3SI7RofJ2XE96_!!6000000004219-2-tps-1249-627.png)
</Frame>
...
![Practical example of process handover: after selecting pending tasks, a transfer approval form dialog appears to batch transfer tasks](https://img.alicdn.com/imgextra/i2/O1CN01Ldd11se4j1H4YjWa_!!6000000006052-2-tps-2246-1250.png)
</Frame>
...
![Before-and-after comparison of the custom business group practical case: a second-level business source group is added under the OA Approval category in the To-Do Center](https://img.alicdn.com/imgextra/i3/O1CN016wf8fZw2NmE2f1zB_!!6000000002172-2-tps-1311-446.png)
</Frame>
...
![Before-and-after comparison of the custom quick approval practical case: third-party system tasks can be directly accepted or declined on the To-Do Center list page](https://img.alicdn.com/imgextra/i3/O1CN01PdRcd0r7nwC2gAED_!!6000000007492-2-tps-1320-449.png)
</Frame>
...
![Practical example of approval page hosting: a third-party proprietary approval form is displayed in the DingTalk official details page style](https://img.alicdn.com/imgextra/i4/O1CN01ETz95tL9iQG4yv38_!!6000000005210-2-tps-2454-1872.png)
</Frame>
...
![Mobile details page for the approval page hosting practical case: the bottom action area displays custom Decline and Accept buttons](https://img.alicdn.com/imgextra/i3/O1CN01AQToOyGN7bE2Ros4_!!6000000007057-2-tps-1206-1874.png)
</Frame>
</div>
...
![Before-and-after comparison of the approval page hosting practical case: PC details page action area buttons can be customized and error messages can be surfaced](https://img.alicdn.com/imgextra/i1/O1CN01HIvzbC6bmRK51BXG_!!6000000001194-2-tps-2472-1882.png)
</Frame>
...
![App permissions management page in the Developer Backend, where you can select the required API permissions under the OA Approval category](https://img.alicdn.com/imgextra/i3/O1CN01oYmIaSY0ZpJ4QvZw_!!6000000007579-2-tps-2184-1024.png)
</Frame>
