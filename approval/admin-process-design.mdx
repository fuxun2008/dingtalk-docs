...
<AccordionGroup>
  <Accordion title="Specified users">
  ...
  <Accordion title="Initiator themselves">
  ...
  <Accordion title="Initiator picks">
  ...
  <Accordion title="Direct manager">
  ...
  <Accordion title="Multiple levels of managers">
  ...
  <Accordion title="Manager of a department field">
  ...
  <Accordion title="Role for a department field">
  ...
  <Accordion title="Contact field in the form">
...
<CardGroup cols={2}>
  <Card title="How to set up conditional approval" href="/zh/approval/set-conditional-approval">
    Route approval forms down different branches based on department, amount, and other conditions.
  </Card>
  <Card title="How to set up role-based approval" href="/zh/approval/set-role-approval">
    Set roles as approvers and configure management scope.
  </Card>
  <Card title="How to set up direct manager approval" href="/zh/approval/set-direct-manager-approval">
    Set up tier-by-tier approval by direct managers.
  </Card>
  <Card title="How to set node action permissions" href="/zh/approval/set-node-permission">
