...
description: "In this episode, Li Meng, Knowledge Management Director of Joyvio Group, joins us as Cheese Officer to share how Joyvio Group leverages knowledge management to **strengthen the 'core knowledge competitiveness' of the group and each business segment**, break down information barriers between and within departments"
---
...
🧀 About the Cheese Officer 1

🧀 About Joyvio Group 1

🧀 Why does Joyvio Group invest in knowledge management? 1

🧀 What is Joyvio Group's knowledge management philosophy? 1

🧀 Joyvio Group's knowledge management methodology 1

🧀 How it works in practice: case study sharing 1

Case study \[Priority: 1\]: Assess the knowledge management maturity of each department 1

Case study \[Priority: 2\]: Roll out a departmental knowledge management framework to guide each department in consciously accumulating knowledge 1

Case study \[Priority: 3\]: Aggregate core enterprise knowledge from departmental knowledge and build platforms to enable the flow and reach of enterprise knowledge 1

Case study \[Priority: 4\]: Group-level knowledge distribution map 1

🧀 Recap: Top 10 quotes from the Cheese Officer 1

🧀 Apply to become a "Cheese Officer" 1

## 🧀 About the Cheese Officer

---

\[Heart] Hi everyone, I'm Li Meng, and I currently lead knowledge management at Joyvio Group.
...
---
<Note>
### Case study [Priority: 1]: Assess the knowledge management maturity of each department
</Note>

Knowledge asset assessment model

Radar of knowledge asset assessment by department
...
<Note>
### Case study [Priority: 2]: Roll out a departmental knowledge management framework to guide each department in consciously accumulating knowledge
</Note>
...
<Note>
### Case study [Priority: 3]: Aggregate core enterprise knowledge from departmental knowledge and build platforms to enable the flow and reach of enterprise knowledge
</Note>
...
<Note>
### Case study [Priority: 4]: Group-level knowledge distribution map
</Note>
...
**Scan the QR code in DingTalk or click** [**the group invitation link**](dingtalk://dingtalkclient/page/link?pc_slide=true&url=https%3A%2F%2Fn.dingtalk.com%2Fdingding%2Fpublic-service-group%2Fjoin-group-code%2Findex.html%3FcorpId%3Ddingd8e1123006514592%26teamId%3D768007%26joinGroupCode%3Dp3cAnJVnxMOAYuBIcYVJLJw92RiiOQ4tnVSNfoNJt7jroiSOkEUMbVuTniPkJB4LDwG)
