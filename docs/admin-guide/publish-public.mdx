...
description: "After enabling Public within organization in the admin console, any user in your organization who receives the document or file can access the public content. You can set or cancel public access within the organization for documents and files."
---
