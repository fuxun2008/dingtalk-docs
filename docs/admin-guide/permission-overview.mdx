...
1.  _Security settings of the Knowledge Base_

2.  _Permission settings for a single document cannot be adjusted to more permissive options:_

## 5. How do I modify collaborator permissions?
...
## 6. How do I make a document public to everyone in my organization?
...
## 7. More permission control settings
...
*   [Click here to learn more about permission control settings](https://docs.dingtalk.io/i/p/gx9JOGOjR6Rm4QLAY7kmbAEMBp7ZKXLq)
