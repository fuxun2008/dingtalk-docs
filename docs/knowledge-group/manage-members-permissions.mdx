...
description: "After you create a Knowledge Group, manage its users. Using a blank group as an example, you can add or remove users, and set user types that correspond to different permissions."
---
