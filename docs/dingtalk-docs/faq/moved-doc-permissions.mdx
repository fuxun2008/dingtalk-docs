...
description: "How permissions change when moving a document between Knowledge Bases: inherited collaborators from the original parent are removed and replaced by those of the new parent, while collaborators added directly to the document are retained."
---
