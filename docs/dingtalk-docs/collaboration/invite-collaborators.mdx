...
description: "How to manage collaborators and permissions in DingTalk Docs: invite individuals, groups, or departments with role-based access (manage/edit/view), enable organization-wide sharing, and adjust or remove collaborator permissions at any time."
---
