...
![](/aitable/automation/oa-approval/images/image_7J-PklmVID.png)
...
![](/aitable/automation/oa-approval/images/image_tYqsCgC9fl.png)
...
![](/aitable/automation/oa-approval/images/image_jTjYXXHNKq.png)
...
- **How do I create an OA approval?**
  - See: [OA approval — DingTalk handbook](https://alidocs.dingtalk.com/i/p/Y7kmbokZp3pgGLq2/docs/lo1YvX0prG98keM3X7aqVPw7xzbmLdEZ "OA approval — DingTalk handbook")
- **How do I get OA admin permission?**
  1. Find your org admin in **Contacts** → **People directory** — explain why you need it and ask them to grant **Sub-admin: OA approval permission**.
     ...
     ![](/aitable/automation/oa-approval/images/image_1_5IQsb04E.png)
  2. The admin grants permission via:
     ...
     - Click **Security & permissions** → **Permission management**.
       ...
       ![](/aitable/automation/oa-approval/images/image_ALt_VuRgkg.png)
     - Add you as a sub-admin with scope **OA approval permission**.

       ![](/aitable/automation/oa-approval/images/image_nQys5MDqu8.png)
