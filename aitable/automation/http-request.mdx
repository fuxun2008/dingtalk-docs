...
description: "Send HTTP requests in AI Table automation: supports GET, POST, PUT, PATCH, and DELETE methods to call external APIs. Pass field values or intermediate workflow data in headers, query params, or request body; the JSON response feeds downstream steps for closed-loop automation."
---
