...
description: "Reference guide for variables in AI Table automation: which field types can be inserted into each action — create record, update record, when condition met, on record change, and send message. Includes a per-action compatibility table and step-by-step examples of referencing upstream data."
---
