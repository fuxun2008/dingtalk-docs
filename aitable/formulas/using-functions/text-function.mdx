...
### Extract birthday from a Chinese ID number

```sql
TEXT(MID([ID number],7,8),"0-00-00")
```

![](/aitable/formulas/using-functions/text-function/images/DingTalk录屏_2025-04-14%20162320_44JmgGnh0y.gif)
