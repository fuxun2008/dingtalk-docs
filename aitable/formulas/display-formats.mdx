...
![](/aitable/formulas/display-formats/images/image_yqEUQKvDDh.png)

![](/aitable/formulas/display-formats/images/image_GCOliP2rBe.png)

![](/aitable/formulas/display-formats/images/image_bsqGkpHMHW.png)
...
- **Formula**: `[Pre-sale qty] / [Target qty]`
...
![](/aitable/formulas/display-formats/images/image_aXQNeZ3xdl.png)

![](/aitable/formulas/display-formats/images/image_YGhr4WF_TM.png)
...
![](/aitable/formulas/display-formats/images/image_OLQU6WjMpG.png)

![](/aitable/formulas/display-formats/images/image_be9GNr6ZCr.png)

#### 3. Currency formatting

**Scenario**: sales total comes back as `19900` — no symbol, no thousands separator.

- **Formula**: `[Live price] * [Pre-sale qty]`
- **Format**: pick **Currency**.
- **Params**: symbol `¥`, 2 decimals.
- **Result**: `¥ 19,900.00` — clean for finance.

![](/aitable/formulas/display-formats/images/image_HIgWownGaz.png)

![](/aitable/formulas/display-formats/images/image_KMW539Ze7f.png)
