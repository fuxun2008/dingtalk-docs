---
title: "Button"
description: "The button component triggers specific actions or flows on a dashboard. Configure one or more buttons to fire predefined data operations, page navigation, or system commands — task-driven, fast."
---
...
![](/aitable/application-mode/button/images/image_JHbHlpQ4sM.png)

![](/aitable/application-mode/button/images/image_AjsZC8OGj3.png.mark.png)

### **Basic config**

After adding, use the **Basic config** in the right panel to set:

![](/aitable/application-mode/button/images/image_lJUCBbec3b.png.mark.png)
...
- **Action (on click)**
  ...
  - **Open link**: jump to an external URL or internal resource. Enter a valid URL (e.g., `https://example.com`).
    ...
    ![](/aitable/application-mode/button/images/image_OY8N8g-OF-.png.mark.png)
  - **Open page**: jump to another page in the current app. Pick from the dropdown.

    ![](/aitable/application-mode/button/images/image_WGDqpGFAL-.png.mark.png)
...
![](/aitable/application-mode/button/images/image_Rok8KZWroq.png.mark.png)
...
- **Action menu**
  ...
  ![](/aitable/application-mode/button/images/image_lPuHUxoI6z.png.mark.png)
...
- **Resize and move**
  ...
  ![](/aitable/application-mode/button/images/2025-12-23%2020.23.37_EzGSQ_Ct5o.gif)
