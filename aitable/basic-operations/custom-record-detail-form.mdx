---
title: "Custom record detail and entry pages"
...
1. **Open the detail page**: in a table, hover over a cell in the leftmost field and click the **Expand record** icon that appears.
   ...
   ![](/aitable/basic-operations/custom-record-detail-form/images/image_2HwFcEg77I.png)
2. **Enter custom mode**: click **Customize** at the top-right of the detail page to open the customization panel.

   ![](/aitable/basic-operations/custom-record-detail-form/images/image_dXWbeErXLD.png)
...
![](/aitable/basic-operations/custom-record-detail-form/images/image_5pCodIu5xR.png)

1. **Page title and title size**: pick a field as the detail-page title, and adjust title font size.

   ![](/aitable/basic-operations/custom-record-detail-form/images/image_usYLnBxj7V.png)
2. **Banner image**: pick an image-type field as the banner. After picking, set fill mode (Fill / Fit / Stretch) and layout (top-bottom / left-right). With left-right layout, set image size (Small / Medium / Large).
   ...
   ![](/aitable/basic-operations/custom-record-detail-form/images/image_NiagvwNokJ.png)

   ![](/aitable/basic-operations/custom-record-detail-form/images/image_n6rBGQD9tb.png)

   ![](/aitable/basic-operations/custom-record-detail-form/images/image_xJWDfpnFfY.png)
3. **Action buttons**: pin button-type fields from the table to the top of the detail page for quick action.
   - Use the master toggle to add buttons.
     ...
     ![](/aitable/basic-operations/custom-record-detail-form/images/image_bRpF6wg5gP.png)
   - Click **+ New button** to create a new button field.

     ![](/aitable/basic-operations/custom-record-detail-form/images/image_OU3bjH5mMz.png)

     ![](/aitable/basic-operations/custom-record-detail-form/images/image_tWPm2p2cgO.png)
...
1. **Add a tab group**: click **+ Add group** > **Tab group**.
   ...
   ![](/aitable/basic-operations/custom-record-detail-form/images/image_ddvhKuP9Ch.png)
2. **Configure the tab group**: select it; the right panel shows:

   ![](/aitable/basic-operations/custom-record-detail-form/images/image_FJOAWQFykD.png)
...
3. **Add content to a tab**: expand a tab and click **+ Add component** to drop fields or layout components in. Everything reorders by drag, including dragging in from outside the tab.
   ...
   ![](/aitable/basic-operations/custom-record-detail-form/images/image_wx0R4YIofe.png)
...
1. **Add an existing field**: select a regular group or tab group, click **+ Add component**, and pick an existing field from the table.
   ...
   ![](/aitable/basic-operations/custom-record-detail-form/images/image_BG6VqXBirF.png)
2. **Create a new field**: **+ Add component** > **+ Add field** creates a new one. After config, the field appears in the table too.

   ![](/aitable/basic-operations/custom-record-detail-form/images/image_IZ8JkR_1Xn.png)
3. **Remove a field**: select it, click **︙** > **Delete**.

   ![](/aitable/basic-operations/custom-record-detail-form/images/image_XfZHQkyD-1.png)
4. **Change field config and style**: select it, edit in the right **Field** panel.

   ![](/aitable/basic-operations/custom-record-detail-form/images/image_2vk-zcy8w5.png)
...
1. Open the entry page: in a grid view, click **Add record** — the new-record entry page opens.
   ...
   ![](/aitable/basic-operations/custom-record-detail-form/images/image_zFbdwJxF3T.png)
