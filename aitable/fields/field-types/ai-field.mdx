---
title: "AI field"
description: "AI fields in AI Table generate content automatically using a custom prompt and references to other fields. They update dynamically by reading the current record — analyzing docs, images, and video. Pick a preset from the AI field center or write your own prompt. Output types include text, number, single/multi-select, currency, image, and video."
---
