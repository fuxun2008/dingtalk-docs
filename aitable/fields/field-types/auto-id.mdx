---
title: "Auto number"
description: "Auto number generates a unique, auto-incrementing ID for each record. Beyond plain numeric IDs, custom rules can include creation date, fixed text, etc."
---
...
![](/aitable/fields/field-types/auto-id/images/image_L3_ZZVjjvc.png)

![](/aitable/fields/field-types/auto-id/images/image_fA2wM1WXiU.png)

## Set auto number type

Pick between **Incrementing number** and **Custom number**.

![](/aitable/fields/field-types/auto-id/images/image_RcZgpcGItl.png)
...
![](/aitable/fields/field-types/auto-id/images/image__jUjTvZo50.png)
