---
title: "Auto number"
description: "AI Table auto number field: generates a unique, auto-incrementing ID for each record. Choose plain incrementing numbers or build a custom format combining a counter, creation date, and fixed text. Deleted numbers are never reused and don't affect other records."
---
