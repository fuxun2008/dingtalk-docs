...
![](/aitable/scenarios/mark-duplicates/images/image_8ukz9PjBe1.png)

## How to set it up

**Step 1.** Add an **Auto Number** field to give each row a sequence number.

![](/aitable/scenarios/mark-duplicates/images/image_eNkk9Ztnht.png)
...
![](/aitable/scenarios/mark-duplicates/images/image_vDSbtOBeEf.png)
...
![](/aitable/scenarios/mark-duplicates/images/image_fJgLTxqo9R.png)

**Step 4.** Set **Row color** to fill the **entire row** — duplicate rows now turn red.

![](/aitable/scenarios/mark-duplicates/images/image_DUiEY6kuAU.png)
