...
1. Open the [Obtain the access token of an internal app](/open/development/obtain-the-access-token-of-an-internal-app) API page and click the **API Debug** button on the right to open the [Server-side debugging tool](https://open.dingtalk.io/document/download/api-explorer).
