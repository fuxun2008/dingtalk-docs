...
| eventId | String | Yes | The event ID. Call the [Query an event list](https://open.dingtalk.io/document/development/query-an-event-list#) API to obtain the id value. |
