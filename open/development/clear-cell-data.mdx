...
| sheetId | String | Yes | The ID or title of the worksheet.   - For an internal app, call the [Get all worksheets](https://open.dingtalk.io/document/development/obtain-all-worksheets#) API to get the ID, or pass the worksheet title. - For a third-party enterprise app, pass the worksheet title.   See the figure below for how to view the worksheet title. |
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| operatorId | String | Yes | The unionId of the operator. Call the [Query user details](https://open.dingtalk.io/document/development/query-user-details#) API to get it. |
