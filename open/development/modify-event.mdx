...
description: "Call this API to update the information of a single event, with request and response details."
---
...
- To add or remove event attendees, use the [Add event attendees](/open/development/add-schedule-participant#) and [Remove event attendees](/open/development/delete-schedule-participant#) APIs.
