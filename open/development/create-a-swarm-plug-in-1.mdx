...
description: "Explains how to configure the URL for the group plugin shortcut entry, covering jumps to plain pages, H5 micro-apps, and mini programs, plus how to retrieve source group information from the link."
---
