...
description: "Guides developers to upload local files to the My Docs directory in DingTalk Docs, covering prerequisites, the development flow, app creation, and web app configuration."
---
