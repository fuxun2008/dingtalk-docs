...
description: "Call this API to get the basic information of the immediate sub-departments under a specified department; recursive retrieval of all sub-department levels is not supported."
---
