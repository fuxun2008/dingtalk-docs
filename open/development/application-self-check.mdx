...
3. Click the target app to open its details page, select **App Self-Inspection**, and then click **Start Check**.
   ...
   - **Function Self-Inspection**
     ...
     | Whether the server outbound IP is set | Set the server outbound IP in the app's development information. | [Development Overview](https://open.dingtalk.com/document/isvapp/isvapp-development-overview#) |
     | Whether a valid push type is set | Complete the push settings in the app's development information. | [Overview](https://open.dingtalk.com/document/isvapp/callback-events-overview#) |
     ...
     | Whether Monitoring Center integration is complete | Complete the integration in Monitoring Center and generate monitoring data. | [Monitoring Center](https://open.dingtalk.com/document/isvapp/monitoring-center#) |
     | Whether the server is deployed on Alibaba Cloud or Jushita | Select Alibaba Cloud or Jushita as the app cloud deployment method. For more information, see the app deployment documentation. | [Deployment Overview](https://open.dingtalk.com/document/isvapp/deployment-overview#) |
     | Whether a mini program version is published | Publish a mini program version in the app's version management. | [Version Management and Publishing](https://open.dingtalk.com/document/isvapp/publish-and-install-isvapp#) |
...
5. Referring to the [Security Access Evaluation Guide](https://open.dingtalk.com/document/isvapp/security-access-evaluation-guide#), complete and submit the materials for the app listing security review evaluation items.
6. After you submit, the **Stability Monitoring** page opens.

   **Note**

   Complete the stability review before you list the app on the DingTalk Marketplace. After you integrate the stability monitoring system, DingTalk collects and displays the following app data and notifies you when the data falls below the standard. For more information, see [Stability Certification Standards](https://open.dingtalk.com/document/isvapp/stabilistandards#).
