...
description: "Call this API for the meeting host to close an ongoing video meeting."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| unionId | String | Yes | The unique identifier of an employee within the current developer's Enterprise Account scope. Call the [Query user details](/open/development/query-user-details#) API to obtain the value of the unionid parameter. |
