...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| unionId | String | Yes | The unique identifier of an employee within the current developer's Enterprise Account scope. Call the [Query user details](https://open.dingtalk.io/document/development/query-user-details#) API to obtain the value of the unionid parameter. |
...
| --- | --- | --- |
| code | Long | The return code of the close audio and video API result. |
| cause | String | If the return code is 200, this field returns success. Otherwise, it returns the failure reason. |
...
| 400 | resourceClose | The meeting has ended | The meeting has already been closed. |
| 404 | waterLimitError | waterLimitError:%s | Rate limit reached for the number of participants. |
