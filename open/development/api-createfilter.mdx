...
description: "Call this API to create a global filter with a specified range on a target worksheet in DingTalk Spreadsheet, suitable for row-level filtering scenarios such as displaying data by region or status."
---
