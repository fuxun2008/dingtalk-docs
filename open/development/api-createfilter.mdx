...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| workbookId | String | Yes | The spreadsheet file ID. The `nodeId(dentryUuid)` returned by the [Knowledge Base API](https://open.dingtalk.io/document/orgapp/knowledge-base-overview) is the `workbookId` of the spreadsheet. You can call the [Get node](https://open.dingtalk.io/document/orgapp/get-node) and [Create knowledge base document](https://open.dingtalk.io/document/orgapp/create-team-space-document) APIs to obtain it. |
| sheetId | String | Yes | The ID or name of the worksheet. Call the [Get all worksheets](https://open.dingtalk.io/document/orgapp/obtain-all-worksheets) API to obtain the value of the id or name parameter. |
