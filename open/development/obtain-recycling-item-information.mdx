...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| recycleBinId | String | Yes | The Recycle Bin ID. Call the [Get information about the Recycle Bin](https://open.dingtalk.io/document/development/obtain-information-about-the-recycle-bin#) API to obtain it. |
| recycleItemId | String | Yes | The recycle item ID. Call the [Get the list of recycle items](https://open.dingtalk.io/document/development/gets-the-list-of-recycle-items#) API to obtain the value of the `id` parameter. |
