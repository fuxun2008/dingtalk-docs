...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| userId | String | Yes | The unionId of the user to whom the resource of this request belongs.   - For internal apps and third-party enterprise apps, call the [Query user details](https://open.dingtalk.io/document/development/query-user-details#) API to obtain the value of the unionid parameter. - For third-party personal apps, call the [Get user contacts profile](https://open.dingtalk.io/document/development/dingtalk-retrieve-user-information#) API to obtain the value of the unionId parameter. |

### Request body

| Name | Type | Required | Description |
| --- | --- | --- | --- |
| userIds | Array of String | Yes | The unionId of the target user to query.   - For internal apps and third-party enterprise apps, call the [Query user details](https://open.dingtalk.io/document/development/query-user-details#) API to obtain the value of the unionid parameter. - For third-party personal apps, call the [Get user contacts profile](https://open.dingtalk.io/document/development/dingtalk-retrieve-user-information#) API to obtain the value of the unionId parameter.       The maximum length of the user list is 20. |
