...
description: "Obtain the access credential for an app to call DingTalk OpenAPI on behalf of a signed-in user through four steps: app creation, OAuth authorization, credential retrieval, and API call."
---
