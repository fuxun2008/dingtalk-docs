...
description: "Call this API to batch query the read status of bot messages in one-on-one bot chats, ideal for confirming message reads within 24 hours of internal communication."
---
...
If an error occurs when you call this API, look up the error message in the [Global error codes](/open/development/server-api-error-codes-1) document for the solution.
