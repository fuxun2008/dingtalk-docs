...
description: "Call this API to clear all content in a worksheet cell range, including both data and styles."
---
...
| sheetId | String | Yes | The ID or title of the worksheet.   - For an internal app, call the [Get all worksheets](/open/development/obtain-all-worksheets#) API to obtain the ID, or pass the title of the worksheet. - For a third-party enterprise app, we recommend passing the title of the worksheet.   The steps to view the worksheet title are shown in the figure below. |
