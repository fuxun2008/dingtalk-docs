---
title: "Rate limits"
description: "Explains the default rate limit mechanism for server-side APIs, covering terminology, global and IP-level throttling rules, and best practices to avoid limits."
---
