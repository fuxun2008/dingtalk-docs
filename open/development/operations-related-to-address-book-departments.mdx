...
description: "This guide explains how to create, get, update, and delete departments using Contacts management APIs in an internal app, covering credential retrieval and permission setup."
---
