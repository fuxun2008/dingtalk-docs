---
title: "Create a role"
description: "Call this API to create a new role under a specified role group, after which members can be assigned to the role and permissions configured."
---
