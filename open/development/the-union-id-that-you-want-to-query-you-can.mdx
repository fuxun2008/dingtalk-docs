...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| unionId | String | Yes | The unionId of the original standard account. To obtain the value of the unionid parameter, call the [Obtain user information by using a silent login code](https://open.dingtalk.io/document/development/obtain-the-userid-of-a-user-by-using-the-log-free#) API. |
...
If an error is returned when you call this API, find the solution by looking up the error message in the [Global error codes](https://open.dingtalk.io/document/development/server-api-error-codes-1) document.
