...
description: "Call this API to create a conditional formatting rule in a specified worksheet that automatically applies font or background colors based on cell values or duplicates, ideal for data visualization scenarios."
---
