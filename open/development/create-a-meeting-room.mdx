...
| groupId | Long | No | The Group ID. Call the [Query the Room group list](https://open.dingtalk.io/document/development/query-meeting-rooms-groups) API to obtain it. |
...
| memberId | String | No | The ID of the user. Set based on memberType:   - **User**: The unionId of the user. Call the [Query user details](https://open.dingtalk.io/document/development/query-user-details) API to obtain it. - **Department**: The department ID, dept_id. Call the [Obtain the department list](https://open.dingtalk.io/document/development/obtain-the-department-list-v2) API to obtain it. |
