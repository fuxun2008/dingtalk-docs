...
description: "Call this API to add access control to a specified calendar to restrict accessible users or roles, with full request parameters and response field references."
---
