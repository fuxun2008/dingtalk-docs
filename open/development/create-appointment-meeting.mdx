...
description: "Call this API to create a booked meeting by specifying the creator, meeting title, and start and end times, with full request parameters and response field references."
---
