...
description: "Call this API to empty all files in a Recycle Bin by its ID; files removed by this operation cannot be restored."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| recycleBinId | String | Yes | The Recycle Bin ID. To obtain it, call the [Get Recycle Bin information](/open/development/obtain-information-about-the-recycle-bin#) API. |
