...
Call this API to empty Recycle Bin files based on the Recycle Bin ID. Deleted files cannot be restored.
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| recycleBinId | String | Yes | The Recycle Bin ID. To obtain it, call the [Get Recycle Bin information](https://open.dingtalk.io/document/development/obtain-information-about-the-recycle-bin#) API. |
