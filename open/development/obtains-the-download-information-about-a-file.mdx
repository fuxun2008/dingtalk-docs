...
Step 1: Call this API to get the file download information, including the download URL and headers.

Step 2: Execute the download. See the following example:

```java
public static void main(String[] args) {
        String url = ""; // The internalResourceUrls returned by the get download information API.
        String path = "/Users/xxxxx/Downloads/test.txt"; // The target path for the file download.
        // The headers returned by the get download information API.
        Map<String, String> headers = "" // The headers obtained from the get download information API.
...
<Note>
If the file is too large and you need to retrieve it in segments, add the headers field in the example above: `headers.put("Range","bytes=0-499");`. For details, see [Download partial content by specifying Range](/open/development/use-range-download-a-part-of-content).
</Note>
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| spaceId | String | Yes | The space ID. Call the [Add space](https://open.dingtalk.io/document/development/add-space#) API to obtain the id parameter value. |
| dentryId | String | Yes | The file ID. Call the [Get the list of files or folders](https://open.dingtalk.io/document/development/get-a-list-of-files-or-folders#) API or the [Get spaceId by dentryUuid](https://open.dingtalk.io/document/development/api-getdentryidbyuuid#) API to obtain the id parameter value. |
...
| version | Long | No | The file version number. Call the [Get the list of file versions](https://open.dingtalk.io/document/development/obtains-a-list-of-file-versions#) API to obtain the version. |
...
If an error is returned when you call this API, find solutions based on the error message in the [Global error codes](https://open.dingtalk.io/document/development/server-api-error-codes-1) document.
