...
description: "Call this API to get download information of a file in the storage space, including the download URL, used to implement file download."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| spaceId | String | Yes | The space ID. Call the [Add space](/open/development/add-space#) API to obtain the id parameter value. |
| dentryId | String | Yes | The file ID. Call the [Get the list of files or folders](/open/development/get-a-list-of-files-or-folders#) API or the [Get spaceId by dentryUuid](/open/development/api-getdentryidbyuuid#) API to obtain the id parameter value. |
...
| version | Long | No | The file version number. Call the [Get the list of file versions](/open/development/obtains-a-list-of-file-versions#) API to obtain the version. |
...
If an error is returned when you call this API, find solutions based on the error message in the [Global error codes](/open/development/server-api-error-codes-1) document.
