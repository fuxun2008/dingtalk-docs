...
description: "Call this API to update the name, range, or filter criteria of a specified filter view; all fields are optional and only those provided are updated, suitable for adjusting existing filter views."
---
