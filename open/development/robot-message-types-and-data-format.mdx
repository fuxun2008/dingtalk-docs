...
For details on how to send messages through a Webhook, see [Send Group Chat Messages Using a Webhook with an Internal Bot](https://open.dingtalk.com/document/group/assign-a-webhook-url-to-an-internal-chatbot#topic-2192358) and [Custom Bot Integration](https://open.dingtalk.com/document/group/custom-robot-access#topic-2026027).
