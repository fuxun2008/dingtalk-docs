...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| uploadKey | String | Yes | The unique upload identifier. Call the [Initialize a multipart upload object](https://open.dingtalk.io/document/development/initialize-a-multipart-upload-object#) API to obtain the `uploadKey`. |
