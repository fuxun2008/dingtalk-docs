...
description: "Call this API to get the upload information for each part when performing multipart file upload, used to implement large file multipart upload."
---
