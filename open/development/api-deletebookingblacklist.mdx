---
title: "Delete users from the room booking blocklist"
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| blacklistUnionIds | Array of String | No | The unionIds of the blocklist users. The number of unionIds cannot exceed 100. |
| unionId | String | No | The unionId of the operator. |
...
| --- | --- | --- |
| result | Boolean | Whether the API call is successful. |
...
| 400 | user.over.limit | User Over Limit | The number of blocklist user IDs exceeds the limit |
