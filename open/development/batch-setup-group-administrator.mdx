...
description: "Use this API to batch-assign or batch-revoke admin roles in an organization's group chat, ideal for large groups or after organizational restructuring."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| openConversationId | String | Yes | The open group ID. To obtain the value of `openConversationId`, call the [Create a group chat](https://open.dingtalk.io/document/development/create-common-group-new-version-v2) API. |
| userIds | Array of String | Yes | The list of `userid` values of employees in the organization. To obtain the value of `userid_list`, call the [Query the list of department user IDs](https://open.dingtalk.io/document/development/query-the-list-of-department-userids) API. |
