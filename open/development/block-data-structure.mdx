...
description: "Describes the tree structure and nesting rules of online document block elements, covering InlineElement, common data structures, and the complete Emoji enum list."
---
