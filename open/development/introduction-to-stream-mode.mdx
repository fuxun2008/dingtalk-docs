...
- #### **Sample Code**
  ...
  **Event Subscription Callback**
  ...
  For details, see [Configure Stream Push](https://open.dingtalk.com/document/orgapp/stream).
  ...
  **Card Callback**
  ...
  For details, see [Interactive Card Stream](https://open.dingtalk.com/document/orgapp/event-callback-card#a0cb7b50dfnlu).
