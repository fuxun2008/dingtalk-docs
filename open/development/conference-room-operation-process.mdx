...
description: "A complete walkthrough for using an internal app to call the smart meeting room APIs to create, update, query, and delete rooms, covering credential acquisition and API permission setup."
---
