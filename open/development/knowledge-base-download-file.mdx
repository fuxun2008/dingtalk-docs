...
description: "Call this API to retrieve download information for a file in Knowledge Base, with request and response details."
---
...
If an error is returned when calling this API, look up the solution based on the error message in the [Global error codes](/open/development/server-api-error-codes-1) document.
