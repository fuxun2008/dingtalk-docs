...
| --- | --- | --- | --- | --- |
| access_token | String | Yes | BE3xxxx | The app credential for calling this API. Obtain it by calling the API that retrieves the [access_token of an internal app](/open/development/obtain-orgapp-token). |
