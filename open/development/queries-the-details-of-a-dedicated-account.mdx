...
description: "Call this API to get the details of a specified Enterprise Account user. Only available to organizations that have enabled Enterprise Account."
---
