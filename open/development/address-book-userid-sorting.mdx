...
description: "Call this API to sort a list of user IDs by the pinyin of user names, with error codes returned for troubleshooting."
---
...
| Field | Value |
| --- | --- |
| HTTP URL | https://api.dingtalk.io/v1.0/contact/users/sort |
| HTTP Method | POST |
...
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Yes | The access credential for calling this API. Obtain it by calling [Obtain the access token of an authorized organization for a third-party app](https://open.dingtalk.com/document/development/obtain-the-access-token-of-the-authorized-enterprise-1#). |

### Request body

| Name | Type | Required | Description |
| --- | --- | --- | --- |
| userIdList | Array of String | Yes | The user IDs. Obtain the userid parameter value by calling [Obtain the user ID by using the silent login code](/open/development/obtain-the-userid-of-a-user-by-using-the-log-free#). |
