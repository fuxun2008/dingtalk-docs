...
This document explains how to publish a DingTalk internal app. Follow the steps in this document to complete the publishing of an internal app.

## **Prerequisites**

Complete the [Create an App](https://open.dingtalk.com/document/orgapp/create-an-application) process.
...
You can only use the [Install Cool Apps to a Single Chat Session in Batches](https://open.dingtalk.com/document/isvapp-client/install-cool-apps-to-a-single-chat-session-in-batches) API to install a Direct Message cool app to a Direct Message chat.
...
If you need to monitor a mini program app or web app, you can [Monitor an App](https://open.dingtalk.com/document/orgapp/monitor-miniapp-and-webapp).
