...
description: "Call this API to update the basic information and members of a specified group chat by its chatid, including group name, group owner, member list, and group avatar."
---
...
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Yes | The access credential for calling this API. Obtain it through the [Get the access token of an internal app](/open/development/obtain-the-access-token-of-an-internal-app) API. |

### Request body

| Name | Type | Required | Description |
| --- | --- | --- | --- |
| chatid | String | Yes | The group chat ID. Obtain it from the chatid parameter returned by the [Create a group chat](/open/development/create-common-group-new-version-v2) API.  The chatid obtained by calling the frontend JSAPI is not supported. |
| name | String | No | The group name. Length: 1 to 20 characters. |
| owner | String | No | The userId of the group owner. Obtain the userId through the [Query users by phone number](/open/development/query-users-by-phone-number) API.  The user must be one of the members in the useridlist of the chat. |
...
| add_extidlist | Array of String | No | The unionId list. Obtain it through the [Query user details](/open/development/query-users-by-phone-number) API. |
| del_extidlist | Array of String | No | The unionId list. Obtain it through the [Query user details](/open/development/query-users-by-phone-number) API. |
| icon | String | No | The mediaId of the group profile photo. Obtain the media_id parameter through the [Upload media files](/open/development/upload-media-files) API. |
