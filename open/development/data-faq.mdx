...
> This is a legacy product from the early Open Platform. We recommend calling OpenAPI through an internal app instead. For details, see [Get the access_token of an internal app](https://open.dingtalk.io/document/orgapp/obtain-the-access_token-of-an-internal-app).
