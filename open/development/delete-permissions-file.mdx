...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| dentryUuid | String | Yes | The file UUID. To obtain this value, call the [File Search](/open/development/search-for-files) API or the [Get dentryUuid](/open/development/api-getuuidbydentryid) API, and read the `dentryUuid` field from the response. |
