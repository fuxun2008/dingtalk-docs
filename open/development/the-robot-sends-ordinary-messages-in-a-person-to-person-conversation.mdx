...
description: "Call this API to send a plain message from a bot in a one-on-one chat. Documents the API call method, request parameters, and response structure."
---
