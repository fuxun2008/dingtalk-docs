...
description: "Call this API to retrieve all filter views on a specified worksheet, returning each view's ID, name, range, and filter conditions, suitable for enumerating or batch-reading view configurations."
---
