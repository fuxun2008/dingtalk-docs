...
description: "This document describes how to sync your organization's OA system contacts with DingTalk Contacts."
---
...
Complete the [Create an app](/open/dingstart/create-and-configure-an-application) process.
