...
| data | String | No | `{"name":"淘宝 6","name2":"http://www.taobao.com"}` | The values assigned to the dynamic parameters of the message template. **Note**  Both key and value must be strings. |
