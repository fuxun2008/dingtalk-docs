...
description: "Uploads a file to a Knowledge Base (Team space) directory in three steps: obtaining the upload credential, uploading the file to OSS, and committing the file."
---
