...
description: "Call this API to query the basic information of a video meeting, including meeting name, duration, start time, end time, and total number of participants."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| conferenceId | String | Yes | The conferenceId of the meeting. Call the [Create a video meeting](/open/development/create-a-video-conference#) API to obtain the conferenceId. |
