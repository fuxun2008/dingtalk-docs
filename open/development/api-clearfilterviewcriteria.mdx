...
description: "Call this API to clear the filter criteria of a specific column within a designated filter view, suitable for scenarios where other columns' filter states must be retained in a personal filter view."
---
...
| sheetId | String | Yes | The worksheet ID or name. Obtain the id or name parameter value by calling the [Get all worksheets](/open/development/obtain-all-worksheets) API. |
