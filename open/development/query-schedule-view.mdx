...
description: "Call this API to query the event view list of a user within a specified time range, including event title, start date, start time, end date, and end time."
---
