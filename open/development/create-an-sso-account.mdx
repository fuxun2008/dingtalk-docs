...
| --- | --- | --- | --- | --- |
| access_token | String | Yes | BE3xxxx | The app credential used to call this API. Obtain it through the Get the [access_token of an internal app](/open/development/obtain-orgapp-token) API. |
