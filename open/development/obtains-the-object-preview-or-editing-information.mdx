...
description: "Call this API to get the preview or edit link of a file in the storage space, allowing authorized users to preview or edit the file via the link."
---
