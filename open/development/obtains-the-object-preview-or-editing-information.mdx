...
| version | Long | No | The version number of the specified file. Call the [Get a list of files or folders](https://open.dingtalk.io/document/development/get-a-list-of-files-or-folders) API to obtain the value of the id parameter. |
...
If an error is returned when calling this API, look up the error message in the [Global error codes](https://open.dingtalk.io/document/development/server-api-error-codes-1) document to find a solution.
