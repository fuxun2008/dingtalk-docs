...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| roomId | String | Yes | The meeting room ID. Call the [Query the meeting room list](https://open.dingtalk.io/document/development/check-the-meeting-room-list) API to obtain it. |
...
| memberId | String | The ID of the user. Set based on memberType:  User: the unionId of the user. Call the [Query user details](https://open.dingtalk.io/document/development/query-user-details) API to obtain it.  Department: the department ID, dept_id. Call the [Obtain the department list](https://open.dingtalk.io/document/development/obtain-the-department-list-v2) API to obtain it. |
