...
description: "Explains how to send direct messages with an enterprise bot, covering requirements, prerequisites, a quick demo, step-by-step instructions, and related references."
---
