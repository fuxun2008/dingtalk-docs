...
description: "Call this API to authorize Enterprise Accounts of your organization, after joining other organizations, to allow those organizations to view specified fields of your organization's Enterprise Account information."
---
...
If the API call fails, refer to the [Global error codes](/open/development/server-api-error-codes-1) document to find a solution based on the error message.
