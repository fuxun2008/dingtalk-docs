...
description: "Add or modify settings that restrict users, departments, or roles from viewing the Contacts."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| id | Long | No | The setting ID.   - Do not pass this parameter when adding a new setting. - To modify an existing setting, specify this parameter. Obtain the ID by calling the [Get the list of Contacts visibility restriction settings](https://open.dingtalk.io/document/development/gets-a-list-of-address-book-limit-visibility-settings#) API. |
| name | String | No | The setting name. |
| description | String | No | The setting description. |
| subjectUserIds | Array of String | No | The list of user IDs whose Contacts visibility is restricted. Obtain `userid` by calling the [Get the user ID list of a department](https://open.dingtalk.io/document/development/query-the-list-of-department-userids#) API.      The total number of elements across `subjectUserIds`, `subjectDeptIds`, and `subjectTagIds` cannot exceed 50. |
| subjectDeptIds | Array of Long | No | The list of department IDs whose Contacts visibility is restricted. Obtain `dept_id` by calling the [Get the department list](https://open.dingtalk.io/document/development/obtain-the-department-list-v2#) API.      The total number of elements across `subjectUserIds`, `subjectDeptIds`, and `subjectTagIds` cannot exceed 50. |
| subjectTagIds | Array of Long | No | The list of role IDs whose Contacts visibility is restricted. Obtain the role IDs by calling the [Get the role list](https://open.dingtalk.io/document/development/obtains-a-list-of-enterprise-roles#) API.      The total number of elements across `subjectUserIds`, `subjectDeptIds`, and `subjectTagIds` cannot exceed 50. |
...
| excludeUserIds | Array of String | No | The user IDs in the allowlist. Obtain `userid` by calling the [Get the user ID list of a department](https://open.dingtalk.io/document/development/query-the-list-of-department-userids#) API.       - The total number of elements across `excludeUserIds`, `excludeDeptIds`, and `excludeTagIds` cannot exceed 50. - The allowlist takes effect only when `type` is set to `excludeNode`. |
| excludeDeptIds | Array of Long | No | The department IDs in the allowlist. Obtain them by calling the [Get the department list](https://open.dingtalk.io/document/development/obtain-the-department-list-v2#) API.       - The total number of elements across `excludeUserIds`, `excludeDeptIds`, and `excludeTagIds` cannot exceed 50. - The allowlist takes effect only when `type` is set to `excludeNode`. |
| excludeTagIds | Array of Long | No | The role IDs in the allowlist. Obtain them by calling the [Get the role list](https://open.dingtalk.io/document/development/obtains-a-list-of-enterprise-roles#) API.       - The total number of elements across `excludeUserIds`, `excludeDeptIds`, and `excludeTagIds` cannot exceed 50. - The allowlist takes effect only when `type` is set to `excludeNode`. |
...
If an error is returned when calling this API, look up the solution in the [Global error codes](https://open.dingtalk.io/document/development/server-api-error-codes-1) documentation based on the error message.
