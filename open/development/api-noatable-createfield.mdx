...
description: "Call this API to create a field in a table of an AI Table, with request parameters and response details."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| baseId | String | Yes | The ID of the AI Table. To obtain it, refer to [Data structure](/open/development/data-structure#). |
...
| property | `Map<String, Any>` | No | The field attributes. For details about the format, refer to [Field properties](https://open.dingtalk.com/document/development/field-properties#). |
...
| type | String | The field type. For supported types, refer to [Field properties](https://open.dingtalk.com/document/development/field-properties#). |
| property | `Map<String, Any>` | The field attributes. For details about the format, refer to [Field properties](https://open.dingtalk.com/document/development/field-properties#). |
