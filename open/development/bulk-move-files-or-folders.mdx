...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| spaceId | String | Yes | The ID of the space where the source files or folders reside. Call the [Add space](https://open.dingtalk.io/document/development/add-space) API to obtain the value of the `id` parameter. |
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| targetSpaceId | String | Yes | The ID of the target space. Call the [Add space](https://open.dingtalk.io/document/development/add-space) API to obtain the value of the `id` parameter. |
| targetFolderId | String | Yes | The ID of the target folder. The ID of the root directory is `0`. Call the [Get a list of files or folders](https://open.dingtalk.io/document/development/get-a-list-of-files-or-folders) API to obtain the value. |
| dentryIds | Array of String | Yes | The list of IDs of the source files or folders. Up to 30 items are supported. Call the [Get a list of files or folders](https://open.dingtalk.io/document/development/get-a-list-of-files-or-folders) or [Get spaceId and dentryId by dentryUuid](https://open.dingtalk.io/document/development/api-getdentryidbyuuid) API to obtain the value of the `id` parameter. |
...
If an error is returned when this API is called, refer to the [Global error codes](https://open.dingtalk.io/document/development/server-api-error-codes-1) document to find a solution based on the error message.
