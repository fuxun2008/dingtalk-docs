...
description: "Call this API to create or update contact hiding settings via a PUT request, submitting fields such as name, description, objectStaffIds, objectDeptIds, objectTagIds, and excludeStaffIds."
---
...
| objectStaffIds | Array of String | No | The list of `userId` values of the employees to hide. To obtain the `userId`, call [Get user information by silent login code](/open/development/obtain-the-userid-of-a-user-by-using-the-log-free#).      The total number of elements across `objectStaffIds`, `objectDeptIds`, and `objectTagIds` cannot exceed 50. |
| objectDeptIds | Array of Long | No | The list of department IDs to hide. To obtain the `dept_id`, call [Get the department list](https://open.dingtalk.com/document/development/obtain-the-department-list-v2#).      The total number of elements across `objectStaffIds`, `objectDeptIds`, and `objectTagIds` cannot exceed 50. |
| objectTagIds | Array of Long | No | The list of `roleId` values of the roles to hide. To obtain the `id`, call [Get the role list](/open/development/obtains-a-list-of-enterprise-roles#).      The total number of elements across `objectStaffIds`, `objectDeptIds`, and `objectTagIds` cannot exceed 50. |
| excludeStaffIds | Array of String | No | The list of `userId` values of the employees not affected by this hiding setting. To obtain the `userId`, call [Get user information by silent login code](/open/development/obtain-the-userid-of-a-user-by-using-the-log-free#).      The total number of elements across `excludeStaffIds`, `excludeDeptIds`, and `excludeTagIds` cannot exceed 50. |
| excludeDeptIds | Array of Long | No | The list of department IDs not affected by this hiding setting. To obtain the `dept_id`, call [Get the department list](https://open.dingtalk.com/document/development/obtain-the-department-list-v2#).      The total number of elements across `excludeStaffIds`, `excludeDeptIds`, and `excludeTagIds` cannot exceed 50. |
| excludeTagIds | Array of Long | No | The list of role IDs not affected by this hiding setting. To obtain the `id`, call [Get the role list](/open/development/obtains-a-list-of-enterprise-roles#).      The total number of elements across `excludeStaffIds`, `excludeDeptIds`, and `excludeTagIds` cannot exceed 50. |
...
If an error is returned when you call this API, see the [Global error codes](/open/development/server-api-error-codes-1) document for the solution.
