---
title: "Overview"
description: "AI Table is an intelligent data management tool provided by the DingTalk Open Platform. It is essentially a Document (Base) that contains multiple Tables (Sheets), used to efficiently store, process, and automate business workflows."
---
