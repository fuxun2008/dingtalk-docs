---
title: "Add a space"
description: "Call this API to create a new storage space under the enterprise DingTalk Drive, after which folders can be created and files uploaded inside it."
---
