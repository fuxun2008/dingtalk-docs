...
description: "Call this API to update file permissions for members by file uuid, Knowledge Base rootNodeId or nodeId, operator unionId, and role id."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| dentryUuid | String | Yes | The file uuid. Call the [File Search](/open/development/search-for-files) API or the [Get dentryUuid information](/open/development/api-getuuidbydentryid) API to obtain the dentryUuid field from the response parameters. |

### Query parameter

| Name | Type | Required | Description |
| --- | --- | --- | --- |
| unionId | String | Yes | The user unionId. Call the [Query user details](/open/development/query-user-details) API to obtain it. |
