...
Call this API to update room information.

## API call description

Update room information. Only Admins with App Management permissions on the Smart meeting room are allowed to perform this action.
...
| roomId | String | Yes | The Room ID. Call the [Query the meeting room list](https://open.dingtalk.io/document/development/check-the-meeting-room-list) API to obtain it. |
...
| groupId | Long | No | The Group ID that the Room belongs to. Call the [Query the meeting room Group list](https://open.dingtalk.io/document/development/query-meeting-rooms-groups) API to obtain it. |
...
| memberId | String | No | The User ID, configured based on memberType:   - **User**: the User's unionId. Call the [Query user details](https://open.dingtalk.io/document/development/query-user-details) API to obtain it. - **Department**: the Department ID (dept_id). Call the [Obtain the department list](https://open.dingtalk.io/document/development/obtain-the-department-list-v2) API to obtain the dept_id parameter value. |
...
If an error is returned when calling this API, refer to the [Global error codes](https://open.dingtalk.io/document/development/server-api-error-codes-1) document for the solution.
