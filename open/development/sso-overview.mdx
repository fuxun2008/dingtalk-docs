---
title: "Overview"
description: "Explains the DingTalk single sign-on mechanism, covering target users, supported SSO scenarios, and SSO implementation for both internal apps and the app admin console."
---
