---
title: "Update filter"
description: "Call this API to batch update filter criteria for multiple columns in the global filter at once, suitable for simultaneously setting, modifying, or clearing filter rules across multiple columns."
---
