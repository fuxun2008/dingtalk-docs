...
description: "Call this API to send a file to a specified chat for members to view and download."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| spaceId | String | Yes | The space ID. Obtain the value of the id parameter by calling the [Add a space](/open/development/add-space#) API. |
| dentryId | String | Yes | The file ID. Obtain the value of the id parameter by calling the [Obtain the list of files or folders](https://open.dingtalk.com/document/development/obtain-the-file-list-storage#) API. |
