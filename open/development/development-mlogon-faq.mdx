...
To learn how to create the corresponding app type, see [Introduction to app types](https://open.dingtalk.io/document/development/introduction-to-application-types).
