...
description: "This guide explains how to call file storage and message notification APIs in an internal app to upload media files and send work notifications end-to-end."
---
