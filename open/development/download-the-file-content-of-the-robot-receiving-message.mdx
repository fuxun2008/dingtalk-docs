...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| downloadCode | String | Yes | The download code returned by the bot to the developer after a user sends a file message to the bot. For more information, see [Bot receives messages](https://open.dingtalk.io/document/dingstart/receive-message#). |
| robotCode | String | Yes | The code of the bot. For more information, see [Bot ID](https://open.dingtalk.io/document/development/robot-overview#). |
