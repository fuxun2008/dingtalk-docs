...
description: "Call this API to query the list of resignation records of an enterprise, including the resignation date, mobile number, and exit method of each resigned employee."
---
