...
description: "Call this API to create an organization shared storage space as the container for subsequent file storage and management."
---
...
| unionId | String | Yes | The unionId of the user. To obtain it, call the [Query user details](/open/development/query-user-details#) API. |
...
If the API call fails, refer to the [Global error codes](/open/development/server-api-error-codes-1) document and locate a solution based on the error message.
