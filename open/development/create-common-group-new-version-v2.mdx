...
description: "Call this API to quickly create internal and regular group chats for enterprise bulk group creation scenarios, with full request parameters and response field references."
---
