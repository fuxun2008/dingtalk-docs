...
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Yes | The access credential used to call this API. Obtain it via the [Get the access token of an internal app](https://open.dingtalk.io/document/development/obtain-the-access-token-of-an-internal-app) API. |
...
| icon | String | No | The group profile photo. Pass a mediaId, which can be obtained via the [Upload media files](https://open.dingtalk.io/document/development/upload-media-files) API. |
