...
description: "Call this API to grant access permissions to file members based on parameters such as the file uuid, operator unionId, and permission ID."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| dentryUuid | String | Yes | The file UUID. Call the [File Search](/open/development/search-for-files) API or the [Get dentryUuid information](/open/development/api-getuuidbydentryid) API to obtain the value of the `dentryUuid` response parameter. |
