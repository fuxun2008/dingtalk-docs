...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| workbookId | String | Yes | The spreadsheet file ID. The `nodeId(dentryUuid)` returned by the [Knowledge Base API](https://open.dingtalk.io/document/orgapp/knowledge-base-overview) is the spreadsheet `workbookId`. To obtain it, call the [Get node](https://open.dingtalk.io/document/orgapp/get-node) or [Create a Knowledge Base document](https://open.dingtalk.io/document/orgapp/create-team-space-document) API. |
| sheetId | String | Yes | The worksheet ID or name. To obtain the value of the id or name parameter, call the [Get all worksheets](https://open.dingtalk.io/document/orgapp/obtain-all-worksheets) API. |

### Query parameters

| Name | Type | Required | Description |
| --- | --- | --- | --- |
| operatorId | String | Yes | The unionId of the operator.   - To obtain the value of the unionid parameter, call the [Obtain user information by using the silent login code](https://open.dingtalk.io/document/orgapp/obtain-the-userid-of-a-user-by-using-the-log-free) API. - To obtain the value of the unionid parameter, call the [Query user details](https://open.dingtalk.io/document/orgapp/query-user-details) API.       If the operator does not have permission, the API returns the error `The operator has no permission`. |
...
If the API returns an error, refer to the [Global error codes](https://open.dingtalk.io/document/development/server-api-error-codes-1) documentation to find a solution based on the error message.
