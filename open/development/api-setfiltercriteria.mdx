...
description: "Call this API to set or update filter criteria for a specified column in the global filter, suitable for precisely controlling the visibility range of a single column."
---
