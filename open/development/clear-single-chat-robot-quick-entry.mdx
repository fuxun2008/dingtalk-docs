...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| robotCode | String | Yes | The code of the bot. To obtain the `robotCode`, see the [Bot glossary - robotCode](https://open.dingtalk.io/document/development/robot-overview#) topic. |
