...
description: "Call this API to delete the visibility settings of an enterprise employee attribute field, with request parameters and response fields."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| settingId | Long | Yes | The setting ID. Obtain the id parameter value by calling the [Set user attribute visibility](/open/development/add-or-update-the-hidden-settings-of-the-employee-property#) API. |
