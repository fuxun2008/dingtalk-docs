...
description: "Explains the Enterprise Account concept, how to enable it, and the open API capabilities, with key terminology to help developers quickly understand the scope."
---
