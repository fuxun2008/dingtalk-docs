...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| dentryUuid | String | Yes | The file UUID. Obtain the value of the `dentryUuid` response parameter by calling the [File Search](https://open.dingtalk.io/document/development/search-for-files) or [Get dentryUuid information](https://open.dingtalk.io/document/development/api-getuuidbydentryid) API. |

### Query parameter

| Name | Type | Required | Description |
| --- | --- | --- | --- |
| unionId | String | Yes | The unionId of the user. Obtain the value of the unionid parameter by calling the [Query user details](https://open.dingtalk.io/document/development/query-user-details) API. |
