...
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Yes | The access credential used to call this API. To obtain it, see [Get the access token of an internal app](https://open.dingtalk.io/document/development/obtain-the-access-token-of-an-internal-app). |

### Path parameters

| Name | Type | Required | Description |
| --- | --- | --- | --- |
| baseId | String | Yes | The ID of the AI Table. To obtain it, see [Data structure](https://open.dingtalk.io/document/development/data-structure). |
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| operatorId | String | Yes | The unionId of the operator. You can obtain it in either of the following ways:   - Call the [Query user details](https://open.dingtalk.io/document/development/query-user-details) API. - Call the [Obtain user information using the silent login code](https://open.dingtalk.io/document/development/obtain-the-userid-of-a-user-by-using-the-log-free) API. |
...
| value | Array of Any | No | The condition value. See [Record value format](https://open.dingtalk.io/document/development/record-value-format). |
