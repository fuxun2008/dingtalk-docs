...
description: "Append one or more rows of data after the last existing record in a DingTalk Spreadsheet worksheet."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| workbookId | String | Yes | The spreadsheet file ID. Pass `nodeId` (dentryUuid), which serves as the spreadsheet `workbookId`. You can obtain it by calling the [Get a node](https://open.dingtalk.io/document/development/get-knowledge-base-acquisition-node) or [Create a Knowledge Base document](https://open.dingtalk.io/document/development/create-team-space-document) API. |
| sheetId | String | Yes | The ID or title of the worksheet. You can obtain it by calling the [Get all worksheets](https://open.dingtalk.io/document/development/obtain-all-worksheets.md) API, or pass the worksheet title directly. |

### Query parameters

| Name | Type | Required | Description |
| --- | --- | --- | --- |
| operatorId | String | Yes | The unionId of the operator. You can obtain it by calling either the [Obtain user information by silent login code](https://open.dingtalk.io/document/development/obtain-the-userid-of-a-user-by-using-the-log-free) API or the [Query user details by userId](https://open.dingtalk.io/document/development/query-user-details) API. |
...
If the API call returns an error, find the solution in the [Global error codes](https://open.dingtalk.io/document/development/server-api-error-codes-1) documentation based on the error message.
