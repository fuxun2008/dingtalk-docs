...
description: "Describes how to change permissions on documents, files, and folders in the Knowledge Base, covering feature and permission notes plus add, modify, and delete workflows."
---
