...
description: "Call this API to update information of a specified Enterprise Account user, available only to organizations that have purchased and enabled Enterprise Accounts."
---
