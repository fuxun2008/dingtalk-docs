...
description: "Call this API to create a filter view on a target worksheet in DingTalk Spreadsheet, specifying the view name and filter range; filter criteria can then be configured per column."
---
