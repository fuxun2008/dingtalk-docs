...
description: "Call this API to delete a specified department by its department ID, ensuring that the department has no sub-departments or members before deletion."
---
