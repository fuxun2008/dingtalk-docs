...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| spaceId | String | Yes | The ID of the source space where the file or folder is located. Call the [Add a space](https://open.dingtalk.io/document/development/add-space) API to obtain the value of the id parameter. |
| dentryId | String | Yes | The ID of the file or folder to be copied. Call the [Get a list of files or folders](https://open.dingtalk.io/document/development/get-a-list-of-files-or-folders) API or the [Get spaceId and dentryId by dentryUuid](https://open.dingtalk.io/document/development/api-getdentryidbyuuid) API to obtain the value of the id parameter. |
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| targetSpaceId | String | Yes | The ID of the target space. Call the [Add a space](https://open.dingtalk.io/document/development/add-space) API to obtain the value of the id parameter. |
| targetFolderId | String | Yes | The ID of the parent folder at the target location. Call the [Get a list of files or folders](https://open.dingtalk.io/document/development/get-a-list-of-files-or-folders) API to obtain the value of the id parameter. |
