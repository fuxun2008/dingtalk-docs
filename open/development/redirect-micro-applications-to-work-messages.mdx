...
description: "Explains the prerequisites and steps for redirecting from a Work Notification to an H5 micro-app, so the app can connect notifications to in-app pages."
---
