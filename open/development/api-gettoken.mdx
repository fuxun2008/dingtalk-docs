...
- Internal app: Called the [Obtain the access token of an internal app](https://open.dingtalk.io/document/development/obtain-the-access-token-of-an-internal-app#) API to obtain the credential for calling APIs of your organization.
- Third-party enterprise app: Called the [Obtain the access token of the authorized enterprise](https://open.dingtalk.io/document/development/obtain-the-access-token-of-the-authorized-enterprise-1#) API to obtain the credential for calling APIs on behalf of the enterprise that authorized the third-party app.
