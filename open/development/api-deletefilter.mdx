...
description: "Call this API to remove the global filter on a specified worksheet and restore rows hidden by filter conditions, suitable for clearing filters or restoring the full data view before exporting."
---
