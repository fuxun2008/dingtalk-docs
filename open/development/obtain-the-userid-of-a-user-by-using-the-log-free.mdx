...
description: "Call this API to get user information by silent login code, suitable for identifying the current user in silent-login scenarios within DingTalk client apps."
---
