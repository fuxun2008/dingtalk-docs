...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| spaceId | String | Yes | The space ID. Call the [Add a space](https://open.dingtalk.io/document/development/add-space#) API and use the value of the returned `id` parameter. |
...
If an error occurs when you call this API, refer to the [Global error codes](https://open.dingtalk.io/document/development/server-api-error-codes-1) document for solutions based on the error message.
