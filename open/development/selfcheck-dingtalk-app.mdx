...
3. Click Start Check to complete the feature self-check.
   ...
   | Whether a valid push type is set | Complete the push settings in the app's development information. If you use SyncHTTP push, the callback URL must use a [DingTalk secure domain](https://open.dingtalk.com/document/isvapp/configure-update-secure-domain-name). |
...
4. After the feature self-check is complete, click **Next** to proceed with the security review. Refer to [Security Access Evaluation](https://open.dingtalk.com/document/isvapp/security-access-evaluation-guide), and fill in and submit the materials for the security review evaluation items required for app listing.
5. After submission, go to the stability monitoring page. For detailed requirements, refer to [Stability Certification Standards](https://open.dingtalk.com/document/isvapp/stabilistandards).
...
After submitting your app for listing, fill in the app listing information. Refer to [List Your Product](https://open.dingtalk.com/document/isvapp/submit-your-product-to-the-shelves).
