...
| **Image** | No | The image in the message. Supports an image link or a media_id format.  This configuration item is set separately, and each message supports only one image. The image is pinned to the top. |
...
| **Template Name** | No | Specifies the template name.  Name it based on the template's use case and type, for example: New Ticket Notification Template. |
| **Use Case** | No | Describes the use case of the template. |
| **Image** | No | The image in the message. Supports an image link or a media_id format. This configuration item is set separately, and each message supports only one image. |
...
| **Image in Message Body** | No | The image in the message. Supports an image link or a media_id format. This configuration item is set separately, and each message supports only one image. |
