...
description: "Walks through creating an internal app and using Contacts management APIs to create, retrieve, update, and delete employees, covering the full onboarding flow and prerequisites."
---
