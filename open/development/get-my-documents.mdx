...
description: "Call this API to retrieve the My Docs Knowledge Base information of the current operator, used to access the personal private document space."
---
...
If an error occurs when you call this API, locate the solution in the [Global error codes](/open/development/server-api-error-codes-1) document based on the error message.
