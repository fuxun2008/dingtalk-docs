---
title: "Get the Knowledge Base information of My Docs"
---
...
If an error occurs when you call this API, locate the solution in the [Global error codes](https://open.dingtalk.io/document/development/server-api-error-codes-1) document based on the error message.
