---
title: "Get file or folder information"
---

Call this API to obtain information about a file or folder when adding it to a storage space.

## API call description

When obtaining file or folder information, the file size and file extension are not returned for folder-type entries.
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| spaceId | String | Yes | The space ID. Call the [Add a space](https://open.dingtalk.io/document/development/add-space) API to obtain the `id` parameter value. |
| dentryId | String | Yes | The file or folder ID. Call the [Get a list of files or folders](https://open.dingtalk.io/document/development/get-a-list-of-files-or-folders) API or the [Get spaceId and dentryId by dentryUuid](https://open.dingtalk.io/document/development/api-getdentryidbyuuid) API to obtain the `id` parameter value. |
