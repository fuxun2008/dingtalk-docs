...
description: "Call this API to get information when adding a folder or file in a storage space, with API description and request/response details."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| spaceId | String | Yes | The space ID. Call the [Add a space](/open/development/add-space) API to obtain the `id` parameter value. |
| dentryId | String | Yes | The file or folder ID. Call the [Get a list of files or folders](/open/development/get-a-list-of-files-or-folders) API or the [Get spaceId and dentryId by dentryUuid](/open/development/api-getdentryidbyuuid) API to obtain the `id` parameter value. |
