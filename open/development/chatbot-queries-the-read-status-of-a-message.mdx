---
title: "Query the read status of an enterprise bot's group chat message"
---

Call this API to retrieve information such as the message delivery status and the userIds of users who have read the message. For example, after an enterprise bot sends a group chat message in an internal group chat, you can use this API to query the userIds of users who have read the message.
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| openConversationId | String | No | The group ID. Obtain the openConversationId of a group chat through the client-side [chooseChat](https://open.dingtalk.io/document/development/jsapi-choose-chat#) JSAPI.  This must be the same as the openConversationId used in the [Send a group chat message with a bot](https://open.dingtalk.io/document/development/the-robot-sends-a-group-message#) API. |
| robotCode | String | No | The bot code. For more information, see [Bot ID](https://open.dingtalk.io/document/development/robot-overview#).  This must be the same as the robotCode used in the [Send a group chat message with a bot](https://open.dingtalk.io/document/development/the-robot-sends-a-group-message#) API. |
| processQueryKey | String | Yes | The unique identifier of the message. Obtain it from the processQueryKey field in the response of the [Send a group chat message with a bot](https://open.dingtalk.io/document/development/the-robot-sends-a-group-message#) API. |
