...
description: "Call this API to query the send status of an enterprise bot's group chat message and the userIds of members who have read it."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| openConversationId | String | No | The group ID. Obtain the openConversationId of a group chat through the client-side [chooseChat](https://open.dingtalk.com/document/development/jsapi-choose-chat#) JSAPI.  This must be the same as the openConversationId used in the [Send a group chat message with a bot](/open/development/the-robot-sends-a-group-message#) API. |
| robotCode | String | No | The bot code. For more information, see [Bot ID](https://open.dingtalk.com/document/development/robot-overview#).  This must be the same as the robotCode used in the [Send a group chat message with a bot](/open/development/the-robot-sends-a-group-message#) API. |
| processQueryKey | String | Yes | The unique identifier of the message. Obtain it from the processQueryKey field in the response of the [Send a group chat message with a bot](/open/development/the-robot-sends-a-group-message#) API. |
