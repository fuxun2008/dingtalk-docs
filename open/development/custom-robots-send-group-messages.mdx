...
description: "Call this API to send messages to a specified group chat using a custom bot, with usage notes, request parameters, and response field references."
---
