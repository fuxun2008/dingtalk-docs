...
description: "Call this API to retrieve thumbnail information for multiple DingTalk Drive files in one call, specifying the permission scope and target files via header, path, and query parameters."
---
