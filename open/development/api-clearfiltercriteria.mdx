...
description: "Call this API to clear the filter criteria of a specified column in the global filter of DingTalk Spreadsheet, suitable for temporarily releasing a column's filter constraint in multi-column filtering scenarios."
---
