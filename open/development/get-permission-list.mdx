...
description: "Call this API to query a user's file permission list by file uuid, Knowledge Base rootNodeId or nodeId, and operator ID."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| dentryUuid | String | Yes | The file uuid. Call the [File Search](/open/development/search-for-files) API or the [Get dentryUuid information](/open/development/api-getuuidbydentryid) API to obtain the dentryUuid field from the response. |
