...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| spaceIds | Array of String | Yes | The list of space IDs. You can pass in up to 30 IDs. Call the [Get the space list](https://open.dingtalk.io/document/development/queries-a-space-list) API to obtain them. |
...
If an error occurs when calling this API, find the solution by error message in the [Global error codes](https://open.dingtalk.io/document/development/server-api-error-codes-1) documentation.
