...
description: "Call this API to retrieve the list of all data tables in an AI Table workbook for inspecting table structure and index information."
---
...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| operatorId | String | Yes | The unionId of the operator. Obtain it in either of the following ways:   - Call the [Query user details](/open/development/query-user-details#) API. - Call the [Obtain the user ID of a user by using the silent login code](/open/development/obtain-the-userid-of-a-user-by-using-the-log-free#) API. |
...
If an error occurs when you call this API, find a solution in the [Global error codes](/open/development/server-api-error-codes-1) documentation based on the error message.
