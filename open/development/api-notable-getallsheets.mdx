...
| Name | Type | Required | Description |
| --- | --- | --- | --- |
| operatorId | String | Yes | The unionId of the operator. Obtain it in either of the following ways:   - Call the [Query user details](https://open.dingtalk.io/document/development/query-user-details#) API. - Call the [Obtain the user ID of a user by using the silent login code](https://open.dingtalk.io/document/development/obtain-the-userid-of-a-user-by-using-the-log-free#) API. |
...
If an error occurs when you call this API, find a solution in the [Global error codes](https://open.dingtalk.io/document/development/server-api-error-codes-1) documentation based on the error message.
