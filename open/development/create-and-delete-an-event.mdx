...
Prerequisite: Complete the [Create and configure an app](/open/dingstart/create-and-configure-an-application) flow.
...
Complete the [Create and configure an app](/open/dingstart/create-and-configure-an-application) flow.
