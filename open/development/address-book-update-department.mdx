...
description: "Call this API to update information for a specified department, including configuration fields such as department name, parent department, and visibility."
---
