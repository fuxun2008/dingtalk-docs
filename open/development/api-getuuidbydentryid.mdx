...
description: "Call this API to retrieve the dentryUuid of a file by its spaceId and dentryId."
---
...
| operatorId | String | Yes | The unionId of the operator. Call the [Query user details](/open/development/query-user-details) API to obtain the value of the unionid parameter. |
