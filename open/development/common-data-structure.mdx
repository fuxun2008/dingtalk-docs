...
description: "Introduces the common data structures used by Knowledge Base APIs, including DentryModel, DentryVO, LinkSourceInfo, OpenActionModel, and SpaceModel."
---
...
| url | String | https://docs.dingtalk.io/i/spaces/n9XJ\*\*\*\*\*\*\*Xy/overview | The access URL of the Knowledge Base. |
