...
description: "Call this API to change the DingTalk ID bound to an enterprise account, providing account information in the request and receiving the modification result in the response."
---
