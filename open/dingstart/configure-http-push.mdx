---
title: "Configure HTTP Push (Not Recommended)"
...
After the configuration is complete, you need to develop the event subscription server. For more information, see <a href="https://open.dingtalk.com/document/orgapp/develop-http-push-server" target="_blank">Develop an HTTP push server</a>.
</Step>
<Step title="Save">
...
<Frame>
  <img src="https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9545080071/p737446.png" alt="Configure HTTP push" />
</Frame>
</Step>
</Steps>
...
<Note>Verify that the content in <a href="https://open.dingtalk.com/document/orgapp/develop-http-push-server" target="_blank">Develop an HTTP push server</a> is correct.</Note>
