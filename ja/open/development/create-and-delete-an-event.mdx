...
description: "社内アプリで予定 API を利用して、予定の作成・変更・照査・削除を実現します"
---
...
ステップ 1 で取得した Client ID と Client Secret に基づき、アプリのアクセス認証情報として[社内アプリの access_token を取得](/ja/open/development/obtain-orgapp-token)します。
