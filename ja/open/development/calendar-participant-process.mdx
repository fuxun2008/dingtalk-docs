...
description: "社内アプリで予定参加者の追加、取得、削除と招待レスポンスステータス設定をサーバー API で実現します"
---
...
ステップ 1 で取得したクライアント ID と Client Secret に基づき、[社内アプリの access_token を取得](/ja/open/development/obtain-orgapp-token)します。
