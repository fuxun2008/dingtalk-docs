...
description: "企業アプリで会議 API を使用し、ビデオ会議の作成・終了・検索とクラウド録画を管理します"
---
...
前提条件：[アプリの作成と設定](/ja/open/dingstart/create-application)のフローを完了します。
...
[アプリの作成と設定](/ja/open/dingstart/create-application)のフローを完了します。
