...
ステップ 2：[ファイル分割アップロード情報の取得](/zh/open/development/obtains-the-information-about-multipart-uploads-of-an-object) API を呼び出して、各分割ファイルのアップロード情報を取得します。

ステップ 3：各分割ファイルに対してアップロード操作を繰り返し実行します。

ステップ 4：ステップ 1 の API で取得したアップロード識別子 uploadKey を使用して、[ファイル送信](/zh/open/development/submittal-file) API を呼び出し、アップロードを完了します。
