...
description: "シングルチャットボットのクイック入口をクリアして、利用者の高速アクセスを削除します"
---
...
| 名前 | タイプ | 必須 | 説明 |
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | はい | 本インターフェースを呼び出すためのアクセス認証情報です。[社内アプリのアクセストークンを取得する](/ja/open/development/obtain-the-access-token-of-an-internal-app#)インターフェースを呼び出して取得します。 |

### リクエストボディ

| 名前 | タイプ | 必須 | 説明 |
| --- | --- | --- | --- |
| robotCode | String | はい | ボットのコードです。[ボット用語集 - robotCode](https://open.dingtalk.com/document/development/robot-overview#)のコンテンツを参照して、`robotCode` を取得してください。 |
