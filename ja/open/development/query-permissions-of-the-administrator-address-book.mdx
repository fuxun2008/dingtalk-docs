...
| 名前 | タイプ | 必須 | 例 | 説明 |
| --- | --- | --- | --- | --- |
| userid | String | はい | manger123 | 管理者の userid。[管理者リストを取得](/zh/open/development/query-the-administrator-list) インターフェースを呼び出して、現在の企業内の管理者 ID を取得できます。 |
...
本インターフェースの呼び出しでエラーが発生した場合、エラーメッセージをもとに [グローバルエラーコード](/zh/open/development/server-api-error-codes-1) ドキュメントで解決策を検索できます。
