...
| dept_ids | String | いいえ | 1,2,3 | 部門 ID リスト。[部門リストの取得](/zh/open/development/user-management-acquires-the-list-departments) API を呼び出して取得できます。指定しない場合は企業全体を検索します。 |
...
この API の呼び出し時にエラーが発生した場合は、エラーメッセージに基づき、[グローバルエラーコード](/zh/open/development/server-api-error-codes-1) ドキュメントから解決方法を検索してください。
