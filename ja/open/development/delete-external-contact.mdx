---
title: "外部連絡先の削除"
description: "企業の外部連絡先を削除して、連絡先情報を管理できます"
---
...
| 名前 | タイプ | 必須 | 例 | 説明 |
| --- | --- | --- | --- | --- |
| access_token | String | 必須 | 6d1bxxxx | 本インターフェースを呼び出すためのアプリ認証情報。[社内アプリの access_token を取得する](/ja/open/development/obtain-orgapp-token)インターフェースから取得します。 |
