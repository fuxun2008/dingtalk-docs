...
| name | String | 任意 | 張三 | 社員名。最大 80 文字。 |
...
| work_place | String | 任意 | 未来 park | 勤務地。最大 100 文字。 |
...
| extension_i18n | Json | 任意 | `{"爱好":{"zh_CN":"旅游","en_US":"travel","aJP":"旅行"}}` | 拡張属性の国際化値。 |
...
このインターフェースの呼び出し時にエラーが発生した場合、エラーメッセージをもとに [グローバルエラーコード](/zh/open/development/server-api-error-codes-1) ドキュメントで解決策を検索してください。
