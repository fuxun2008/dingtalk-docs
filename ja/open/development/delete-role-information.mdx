---
title: "ロールの削除"
description: "社員から解除されたロール ID を削除して、企業の役割管理体系を最適化します"
---
...
| 名前 | タイプ | 必須 | 例 | 説明 |
| --- | --- | --- | --- | --- |
| access_token | String | はい | 6ed1xxxx | 本 API を呼び出すためのアプリ認証情報です。[社内アプリの access_token を取得する](/ja/open/development/obtain-orgapp-token) API から取得します。 |

### リクエストボディ

| 名前 | タイプ | 必須 | 例 | 説明 |
| --- | --- | --- | --- | --- |
| role_id | Number | はい | 1581321999 | 削除対象のロール ID です。[ロールリストの取得](/ja/open/development/obtains-a-list-of-enterprise-roles) API を呼び出して取得できます。 「デフォルト」グループ内のロール（責任者、上司、スーパー管理者、サブ管理者）は変更できません。 |
