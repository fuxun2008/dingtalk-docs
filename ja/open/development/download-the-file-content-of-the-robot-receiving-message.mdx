...
description: "ボットが受信したチャットのファイルや画像、音声、動画をダウンロードリンクで取得します"
---
...
| 名前 | タイプ | 必須 | 説明 |
| --- | --- | --- | --- |
| downloadCode | String | はい | ユーザーがボットにファイルメッセージを送信した後、ボットからデベロッパーへのコールバックメッセージ内のダウンロードコード。詳細は [ボットによるチャット受信](/ja/open/development/receive-message#) を参照してください。 |
| robotCode | String | はい | ボットのコード。詳細は [ボット ID](https://open.dingtalk.com/document/development/robot-overview#) を参照してください。 |
