...
| 名前 | タイプ | 必須 | 説明 |
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | 必須 | このインターフェースを呼び出すためのアクセス認証情報です。[社内アプリの access_token を取得](/ja/open/development/obtain-the-access-token-of-an-internal-app) インターフェースから取得できます。 |
...
| userIds | Array of String | 必須 | 社員の userid リストです。[部門ユーザーの userid リストを取得](/ja/open/development/query-the-list-of-department-userids) インターフェースを呼び出して userid_list パラメータの値を取得できます。 |
