---
title: "業務通知の送信取消"
description: "送信から24時間以内の業務通知を取消し、社内アプリの誤送信に対応します"
---
...
| 名前 | タイプ | 必須 | 例 | 説明 |
| --- | --- | --- | --- | --- |
| access_token | String | 必須 | bE74xxxx | 本 API を呼び出すためのアプリ認証情報。   - 社内アプリの場合、[社内アプリの access_token 取得](/ja/open/development/obtain-orgapp-token) API より取得します。 - サードパーティ社内アプリの場合、サードパーティ企業の access_token 取得 API より取得します。 |
