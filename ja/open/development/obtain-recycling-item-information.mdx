---
title: "ゴミ箱項目情報の取得"
description: "ゴミ箱項目の詳細情報を取得し、元のスペース ID、パス、サイズなどを確認します"
---
...
| 名前 | タイプ | 必須 | 説明 |
| --- | --- | --- | --- |
| recycleBinId | String | はい | ゴミ箱 ID。[ゴミ箱情報の取得](/ja/open/development/obtain-information-about-the-recycle-bin#)インターフェースを呼び出して取得できます。 |
| recycleItemId | String | はい | ゴミ箱項目 ID。[ゴミ箱項目リストの取得](/ja/open/development/gets-the-list-of-recycle-items#)インターフェースを呼び出して id パラメータの値を取得できます。 |
