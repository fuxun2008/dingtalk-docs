...
description: "スペース配下のファイルおよびフォルダーをページング機能で一覧取得できます"
---
...
| 名前 | タイプ | 必須 | 説明 |
| --- | --- | --- | --- |
| spaceId | String | はい | スペースID。[スペース追加](/ja/open/development/add-space#)インターフェースを呼び出してidパラメータの値を取得します。 |

### クエリパラメータ

| 名前 | タイプ | 必須 | 説明 |
| --- | --- | --- | --- |
| unionId | String | はい | 操作ユーザーのunionId。[ユーザー詳細照会](/ja/open/development/query-user-details#)インターフェースを呼び出して取得できます。 |
