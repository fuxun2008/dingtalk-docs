...
description: "アプリの連絡先権限スコープを確認し、アクセス可能な部門と社員を把握できます"
---
...
| 名前 | タイプ | 必須 | 例 | 説明 |
| --- | --- | --- | --- | --- |
| access_token | String | はい | 6ed1bxxx | この API を呼び出すアプリ認証情報。   - 社内アプリは、[社内アプリの access_token を取得する](/ja/open/development/obtain-orgapp-token) API を通じて取得します。 - サードパーティ社内アプリは、サードパーティ企業の access_token を取得する API を通じて取得します。 |
