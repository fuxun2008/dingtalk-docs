...
| 名前 | タイプ | 必須 | 説明 |
| --- | --- | --- | --- |
| unionId | String | はい | 旧通常アカウントの unionId。[サイレントログインコードによるユーザー情報の取得](/ja/open/development/obtain-the-userid-of-a-user-by-using-the-log-free#) API を呼び出して unionid パラメータの値を取得できます。 |
