...
ステップ 3：[ファイルを送信](/zh/open/development/submittal-file) API を呼び出し、ファイルのアップロードを完了します。

### 説明

- ストレージスペースタイプが USER の場合、当該スペースに権限を持つユーザーは操作可能です。その他の社員が操作する場合は、[権限を追加](/zh/open/development/add-permissions-file) API を呼び出して権限付与を行ってください。
- ストレージスペースタイプが APP の場合、すべてのユーザーの操作には [権限を追加](/zh/open/development/add-permissions-file) API を呼び出した権限付与が必要です。
