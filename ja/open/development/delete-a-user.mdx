...
| **基本情報** | |
| --- | --- |
| HTTP URL | https://api.dingtalk.io/topapi/v2/user/delete |
| HTTP Method | POST |
...
| 名前 | タイプ | 必須 | 例 | 説明 |
| --- | --- | --- | --- | --- |
| access_token | String | はい | Be3xxxx | 本 API を呼び出すためのアプリ認証情報。[社内アプリの access_token 取得](/ja/open/development/obtain-orgapp-token) API から取得します。 |
