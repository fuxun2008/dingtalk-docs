---
title: "ロール名の更新"
description: "ロール名を更新します。責任者や上司などデフォルトロールは変更対象外になります。"
---
...
| 名前 | タイプ | 必須 | 例 | 説明 |
| --- | --- | --- | --- | --- |
| access_token | String | はい | 6d1bxxxx | 本インターフェースを呼び出すためのアプリ認証情報。[社内アプリの access_token を取得する](/ja/open/development/obtain-orgapp-token)インターフェースから取得します。 |
