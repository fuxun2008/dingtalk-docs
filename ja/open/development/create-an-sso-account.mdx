...
| avatarMediaId | String | いいえ | @lALPDfmVUw19YdrNA-jNA-g | 本組織の企業アカウントを作成する際にプロフィール写真の MediaId を指定できます。jpg/png のみサポートします。  [メディアファイルのアップロード](/zh/open/development/upload-media-files) API を呼び出して取得できます。  **説明**  企業アカウントのみ適用されます。 |
