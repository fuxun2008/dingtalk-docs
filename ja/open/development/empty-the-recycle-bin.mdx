...
| 名前 | タイプ | 必須 | 説明 |
| --- | --- | --- | --- |
| recycleBinId | String | はい | ゴミ箱 ID。[ゴミ箱情報を取得する](https://open.dingtalk.io/document/development/obtain-information-about-the-recycle-bin#)インターフェースを呼び出して取得できます。 |
...
本インターフェースの呼び出しでエラーが発生した場合、エラーメッセージに基づいて[グローバルエラーコード](https://open.dingtalk.io/document/development/server-api-error-codes-1)ドキュメントで解決方法を検索できます。
