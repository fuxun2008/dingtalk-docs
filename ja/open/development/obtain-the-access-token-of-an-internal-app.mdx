...
| 名前 | タイプ | 必須 | 例 | 説明 |
| --- | --- | --- | --- | --- |
| appKey | String | 必須 | dingeqqpkv3xxxxxx | 作成済みの社内アプリの Client ID。取得方法は [Client ID/Client Secret](/zh/open/dingstart/basic-concepts-beta) ドキュメントを参照してください。 |
| appSecret | String | 必須 | GT-lsu-taDAxxxsTsxxxx | 作成済みの社内アプリの Client Secret。取得方法は [Client ID/Client Secret](/zh/open/dingstart/basic-concepts-beta) ドキュメントを参照してください。  **説明**  Client Secret は厳重に管理し、漏洩しないようご注意ください。 |
