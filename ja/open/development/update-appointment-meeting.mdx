---
title: "会議予約の更新"
description: "会議予約のタイトルや開始・終了時刻を更新し、スケジュール変更を管理します"
---
...
| scheduleConferenceId | String | はい | 会議予約ID。[会議予約の作成](/ja/open/development/create-appointment-meeting#) APIを呼び出して、戻り値の `scheduleConferenceId` フィールドから取得できます。 |
...
このAPIの呼び出しでエラーが発生した場合、エラーメッセージに基づき [グローバルエラーコード](/ja/open/development/server-api-error-codes-1) ドキュメントで解決方法を検索できます。
