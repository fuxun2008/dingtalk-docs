...
description: "グループメンバー間の連絡先追加と個別チャットを禁止し、メンバー間のやり取り範囲を管理して企業情報セキュリティを保護します"
---
...
| 名前 | タイプ | 必須 | 例 | 説明 |
| --- | --- | --- | --- | --- |
| access_token | String | はい | 6d1bxxxx | 本 API を呼び出すためのアプリ認証情報です。[社内アプリの access_token 取得](/ja/open/development/obtain-orgapp-token) API から取得します。 |
