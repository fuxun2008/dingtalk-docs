...
description: "グループ内でメンバーの表示名を更新でき、管理者による一括変更と個別変更に対応します"
---
...
| 名前 | タイプ | 必須 | 例 | 説明 |
| --- | --- | --- | --- | --- |
| access_token | String | はい | beE3xxxx | この API を呼び出すためのアプリ認証情報。[社内アプリの access_token 取得](/ja/open/development/obtain-orgapp-token) API から取得します。 |
