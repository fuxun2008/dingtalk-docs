---
title: "DingTalk会議 Web版iframe統合ガイド"
description: "DingTalk会議をiframeでWebページに埋め込む方法を解説します。必要なpostMessageイベント、許可するorigin、サンドボックス属性、親ページからの会議制御まで、面接・研修などのカスタムシーンに対応する手順を紹介します。"
---
