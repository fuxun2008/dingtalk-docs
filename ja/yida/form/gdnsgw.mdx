...
参考：[一行テキストコンポーネントのスタイルとサイズを変更する方法](https://www.yuque.com/yida/subject/amsqtc)
...
注：詳細なチュートリアルは、[**Flexレイアウト構文チュートリアル**](https://www.yuque.com/yida-old/help/shdd40)を参照してください。
...
> 上記のヘルプドキュメントで問題が解決しない場合は、[Xingfudemianhuatang](https://yuque.com/yanxin)までお問い合わせください。