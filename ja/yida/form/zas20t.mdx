---
title: "カスタムコンポーネントの例 - ページフッター"
description: "Yidaのカスタムコンポーネントとスキーマインポート機能を活用し、著作権情報や関連リンクを含むページフッターを構築する方法を解説します。Webページ下部で共通に使われるフッターの実装手順を紹介します。"
polished: true
---
...
- 属性の設定方法や複数デバイスへの対応方法を学ぶ際は、このコンポーネントを参考にしてください。
- 注意：このコンポーネントは学習用途で提供されるものであり、公式の標準コンポーネントではありません。
</Note>

## 1. ユースケース

**ページフッター**は、Webページ下部でよく使われる要素です。通常は著作権情報や関連リンクを含み、訪問者がページ間をスムーズに移動できるようにします。
...
##### 2. スキーマインポート機能を有効化します。手順はYidaのフォームデザイナーと同じです。詳細は以下を参照してください。
...
##### 3. 以下のスキーマをコンポーネントデザイナーのスキーマコンソールに貼り付け、「スキーマをインポート」をクリックします。
  ...
  "componentsTree": [
    {
                                ...
                                "props": {
                                  ...
                                  "content": {
                                    ...
                                    "value": {
                                      "use": "zh_CN",
                                      "en_US": "お知らせのコンテンツ",
                                      "zh_CN": "QRコードを長押しでスキャンし、Yida公式アカウントをフォローしてください",
                                      "type": "i18n"
                                    },
                                    "variable": "item.desc"
                                  },
                            ...
                            "props": {
                              ...
                              "content": {
                                ...
                                "value": {
                                  "use": "zh_CN",
                                  "en_US": "お知らせのコンテンツ",
                                  "zh_CN": "DingTalk (China) Information Technology Co., Ltd. およびその関連会社",
                                  "type": "i18n"
                                },
      ...
      "defaultProps": {
        "copyright": "DingTalk (China) Information Technology Co., Ltd. およびその関連会社",
        "reportNo": "浙ICP備 18037475-4号",
      ...
      "propTypes": [
        {
          "defaultValue": "DingTalk (China) Information Technology Co., Ltd. およびその関連会社",
          "display": "block",
          "name": "copyright",
          "title": "著作権",
          "type": "string",
        ...
        {
          "defaultValue": "浙ICP備 18037475-4号",
          "display": "block",
          "name": "reportNo",
          "title": "ライセンス番号",
          "type": "string",
        ...
        "online": [
          {
            ...
            "name": "urlParams",
            "description": "URLクエリ文字列から解析されたオブジェクト",
