#!/usr/bin/env python3
"""import_attendance_zh.py — 把 ~/Downloads/2026-07-20_DingTalk_attendance/ 保留范围 → zh/attendance/<slug>.mdx。

范围：仅核心标准版内容（排除更新日志/客户案例/付费增值版）。TOC 目录页不入仓。
处理（含 2026-07-20 QA 走查 8 类修复）：
...
版本对比页（standard-edition-features）与 ai-photo-anomaly-detection 为手工页，脚本不覆盖。

用法:
    python3 scripts/import_attendance_zh.py --dry-run   # 看 skip/import 清单
    python3 scripts/import_attendance_zh.py             # 正式写入

产物:
  - zh/attendance/<slug>.mdx（净增，不动原始 19 篇）
  - scripts/output/attendance_zh/{nav-fragment.json, slug-map.json, import-report.md}
"""
...
DEFAULT_SOURCE = Path.home() / 'Downloads' / '2026-07-20_DingTalk_attendance'
ATT_DIR = REPO_ROOT / 'zh' / 'attendance'
OUTPUT_DIR = REPO_ROOT / 'scripts' / 'output' / 'attendance_zh'
...
MANUAL_KEEP = {'ai-photo-anomaly-detection', 'other-rules'}  # 源结构畸形/营销风格，已手工重构

# ---- frontmatter 标题简化（QA 走查：标题不要太长和冗余）----
SHORT_TITLES: dict[str, str] = {
    'admin-quick-start': '管理员快速上手',
    'employee-quick-start': '员工快速上手',
    'management-reminders': '考勤管理提醒',
    'default-notifications': '默认消息通知',
    'set-application-entry': '考勤申请入口',
    'multi-timezone-attendance': '多时区考勤',
    'set-fixed-shift': '固定班制考勤',
    'set-scheduling-shift': '排班制考勤',
    'set-alternating-week': '大小周考勤',
    'set-flexible-shift': '自由班制考勤',
    'set-location-clock-in': '地点打卡',
    'set-photo-clock-in': '拍照打卡',
    'set-bluetooth-clock-in': '智点·蓝牙打卡',
    'set-wifi-clock-in': 'Wi-Fi 打卡',
    'import-location-wifi': '批量导入地点/Wi-Fi',
    'set-attendance-machine': '考勤机打卡',
    'set-face-recognition': '人脸识别打卡',
    'clock-in-methods-comparison': '打卡方式对比',
    'export-attendance-report': '导出考勤报表',
    'view-team-attendance-mobile': '移动端团队出勤',
    'modify-abnormal-data': '修改异常考勤数据',
    'customize-report': '自定义考勤报表',
    'statistics-field-guide': '统计字段说明',
    'leave-permission-settings': '假期权限细分',
    'attendance-group-faq': '考勤组常见问题',
    'scheduling-faq': '排班常见问题',
    'shift-faq': '班次常见问题',
    'statistics-faq': '统计常见问题',
    'overtime-faq': '加班规则常见问题',
    'rules-faq': '考勤规则常见问题',
    'approval-settings-faq': '审批设置常见问题',
    'leave-faq': '假期常见问题',
    'employee-clock-in-faq': '打卡常见问题',
    'approval-submit-faq': '审批提交常见问题',
    'check-leave-balance': '查看假期余额',
}
TITLE_OVERRIDES: dict[str, str] = {
    'overtime-rules': '加班规则',   # 源 H1「设置和管理 | 员工加班」不达意
}

# ================= 结构表 =================
STRUCTURE: list[tuple[str, list, list]] = [
    ('快速上手', [
        ('admin-quick-start', '管理员快速上手考勤打卡.adoc.md', None),
        ('employee-quick-start', '员工快速上手考勤打卡.adoc.md', None),
    ], []),
    ('产品说明', [
        ('standard-edition-features', None, '标准版功能说明'),
    ], []),
    ('管理员手册', [
        ('shift-management', '管理员手册.adoc/班次管理.adoc.md', None),
        ('scheduling-management', '管理员手册.adoc/排班管理.adoc.md', None),
        ('auto-shift-matching-admin', '管理员手册.adoc/系统自动对班.adoc.md', None),
        ('set-attendance-admin', '管理员手册.adoc/设置考勤管理员.adoc.md', None),
        ('statistics-notification', '管理员手册.adoc/考勤统计通知.adoc.md', None),
        ('multi-timezone-attendance', '管理员手册.adoc/多时区考勤管理.adoc.md', None),
        ('management-reminders', '管理员手册.adoc/使用考勤管理提醒.adoc.md', None),
        ('default-notifications', '管理员手册.adoc/设置默认消息通知.adoc.md', None),
        ('set-application-entry', '管理员手册.adoc/设置考勤申请入口.adoc.md', None),
    ], [
        ('考勤组管理', [
            ('attendance-group-overview', '管理员手册.adoc/考勤组管理.adoc - 操作概览.adoc.md', None),
            ('set-fixed-shift', '管理员手册.adoc/考勤组管理.adoc - 管理员设置固定班制考勤.adoc.md', None),
            ('set-scheduling-shift', '管理员手册.adoc/考勤组管理.adoc - 管理员设置排班制考勤.adoc.md', None),
            ('set-alternating-week', '管理员手册.adoc/考勤组管理.adoc - 设置大小周考勤.adoc.md', None),
            ('set-flexible-shift', '管理员手册.adoc/考勤组管理.adoc - 管理员设置自由班制考勤.adoc.md', None),
            ('set-location-clock-in', '管理员手册.adoc/考勤组管理.adoc - 管理员设置地点打卡考勤.adoc.md', None),
            ('set-photo-clock-in', '管理员手册.adoc/考勤组管理.adoc - 管理员设置拍照打卡.adoc.md', None),
            ('set-field-clock-in', '管理员手册.adoc/考勤组管理.adoc - 设置外勤打卡.adoc.md', None),
            ('set-bluetooth-clock-in', '管理员手册.adoc/考勤组管理.adoc - 管理员设置智点·蓝牙打卡.adoc.md', None),
            ('set-wifi-clock-in', '管理员手册.adoc/考勤组管理.adoc - 管理员设置Wi-Fi打卡考勤.adoc.md', None),
            ('import-location-wifi', '管理员手册.adoc/考勤组管理.adoc - 批量导入地点_WiFi信息.adoc.md', None),
            ('set-attendance-machine', '管理员手册.adoc/考勤组管理.adoc - 设置考勤机打卡.adoc.md', None),
            ('set-face-recognition', '管理员手册.adoc/考勤组管理.adoc - 管理员设置人脸识别打卡.adoc.md', None),
            ('clock-in-methods-comparison', '管理员手册.adoc/考勤组管理.adoc - 不同打卡方式的区别.adoc.md', None),
        ]),
        ('考勤规则管理', [
            ('overtime-rules', '管理员手册.adoc/考勤规则管理.adoc - 加班规则.adoc - 设置和管理 _ 员工加班.adoc.md', None),
            ('makeup-clock-in-rules', '管理员手册.adoc/考勤规则管理.adoc - 补卡规则.adoc.md', None),
            ('other-rules', '管理员手册.adoc/考勤规则管理.adoc - 其他规则.adoc.md', None),
        ]),
        ('考勤统计', [
            ('ai-photo-anomaly-detection', '管理员手册.adoc/考勤统计.adoc - AI考勤拍照异常识别.adoc.md', None),
            ('report-management', '管理员手册.adoc/考勤统计.adoc - 报表管理.adoc.md', None),
            ('export-attendance-report', '管理员手册.adoc/考勤统计.adoc - 报表管理.adoc - 如何导出考勤报表.adoc.md', None),
            ('view-team-attendance-mobile', '管理员手册.adoc/考勤统计.adoc - 在移动端查看团队出勤数据.adoc.md', None),
            ('modify-abnormal-data', '管理员手册.adoc/考勤统计.adoc - 修改员工异常考勤数据.adoc.md', None),
            ('customize-report', '管理员手册.adoc/考勤统计.adoc - 自定义配置考勤报表.adoc.md', None),
            ('statistics-field-guide', '管理员手册.adoc/考勤统计.adoc - 考勤统计字段说明.adoc.md', None),
        ]),
        ('假期管理', [
            ('leave-management-overview', '管理员手册.adoc/假期管理.adoc.md', None),
            ('leave-permission-settings', '管理员手册.adoc/假期管理.adoc - 假期管理权限细分使用说明.adoc.md', None),
        ]),
    ]),
    ('常见问题', [], [
        ('管理员常见问题', [
            ('attendance-group-faq', '常见问题.adoc/管理员常见问题.adoc - 考勤组管理常见问题.adoc.md', None),
            ('scheduling-faq', '常见问题.adoc/管理员常见问题.adoc - 排班管理常见问题.adoc.md', None),
            ('shift-faq', '常见问题.adoc/管理员常见问题.adoc - 班次管理常见问题.adoc.md', None),
            ('statistics-faq', '常见问题.adoc/管理员常见问题.adoc - 考勤统计常见问题.adoc.md', None),
            ('overtime-faq', '常见问题.adoc/管理员常见问题.adoc - 加班规则设置常见问题.adoc.md', None),
            ('rules-faq', '常见问题.adoc/管理员常见问题.adoc - 考勤规则设置常见问题.adoc.md', None),
            ('approval-settings-faq', '常见问题.adoc/管理员常见问题.adoc - 考勤审批设置常见问题.adoc.md', None),
            ('leave-faq', '常见问题.adoc/管理员常见问题.adoc - 假期管理常见问题.adoc.md', None),
        ]),
        ('员工常见问题', [
            ('employee-clock-in-faq', '常见问题.adoc/员工常见问题.adoc - 考勤打卡常见问题.adoc.md', None),
            ('approval-submit-faq', '常见问题.adoc/员工常见问题.adoc - 考勤审批提交常见问题.adoc.md', None),
            ('check-leave-balance', '常见问题.adoc/员工常见问题.adoc - 员工如何查看假期余额.adoc.md', None),
        ]),
    ]),
]
...
def convert_links(body: str, title2slug: dict[str, str]) -> tuple[str, int, int]:
    ...
    def repl(m: re.Match) -> str:
        ...
        if is_doc and key in title2slug:
            n_int += 1
            return f'[{text}](/zh/attendance/{title2slug[key]})'
