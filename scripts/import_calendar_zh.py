...
DESCRIPTION_OVERRIDES: dict[str, str] = {
    'what-is-calendar': "钉钉日历是连接聊天、邮件、待办的时间管理利器，提供日程会议精确通知、自动生成会议群以及日/周/月/三日多视图。",
    'where-can-i-find-calendar': "移动端钉钉底部菜单第 2 个图标，或电脑端钉钉左侧导航点击「日历」即可进入，开始管理你的日程。",
    'what-is-on-calendar-home': "日历首页功能巡览——新建日程、显示/隐藏我的日历、打开日历设置、切换列表/日/周/月/三日视图、查看会议纪要并搜索日程。",
    'set-calendar-views': "一键切换列表、日、周、月以及移动端三日视图，自定义每周的起始日，开启第二时区方便跨境协作。",
