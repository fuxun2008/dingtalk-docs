...
<Step title="点击右上角【管理审批表单】，进入管理后台，搜索找到，需要添加【AI控件】的表单，点击【编辑】进入表单设计器-点击【表单设计】，并将【AI控件】添加到表单中">
...
<Step title="设置【AI控件】的标题、选择【使用场景】后会自动匹配模型，选择需要支持的字段，并在AI提示框内输入要求">
...
<Step title="发布表单后，在手机端和电脑端就能调用AI控件了">
