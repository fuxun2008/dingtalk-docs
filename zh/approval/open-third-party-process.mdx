...
![image](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/a/RV3Wwboa0iJkxNeP/b49137a5a4a0483494d69567bb788ca40794.png)
</Frame>
...
<Frame caption="差旅申请单页面示例">

![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/3BMqYybPMMZ1mqwZ/img/33bd21bc-aeac-44b7-b740-0e1079b42bb7.png)
</Frame>
...
![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/3BMqYybPMMZ1mqwZ/img/925b83f5-b755-4733-9347-c320abcc332e.png)
</Frame>
...
![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/3BMqYybPMMZ1mqwZ/img/e823e6be-44c4-4b5b-83a2-7603d50cb262.png)
</Frame>
</div>
...
8.  同步审批任务状态到钉钉：根据审批实例`processInstanceId`和审批待办任务taskId，可以调用 **更新流程中心任务状态** 接 口，同步完成自有审批待办状态的更新。在或签等场景，可以调用 **批量取消OA审批待处理任务** 接口，批量将审批实例下正在运行中的待办事项设置为CANCELED；
...
| 获取模板code | 根据模板名称查询process\_code。 | **获取模板code** |
...
## ![image.png](https://alidocs.oss-cn-zhangjiakou.aliyuncs.com/res/3BMqYybPMMZ1mqwZ/img/4d0089ed-8194-438f-a9b9-11bc956b5af2.png "（页面示例）")
