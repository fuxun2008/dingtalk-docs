---
title: "修改权限"
description: "调用本接口根据文件 uuid、知识库 rootNodeId 或 nodeId、操作者 unionId 与权限角色 id 等信息更新权限成员的文件权限。"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| dentryUuid | String | 是 | 文件uuid，可调用[搜索文件](/zh/open/development/search-for-files)接口或[获取dentryUuid信息](/zh/open/development/api-getuuidbydentryid)接口，获取返回参数dentryUuid字段。 |
