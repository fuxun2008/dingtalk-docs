...
接口请参考[获取文件上传信息](/zh/open/development/obtain-file-upload-informations)文档说明，如何调用请参考[如何调用服务端API](/document/development/how-to-call-apis#)文档介绍。
...
- 接口请参考[提交文件](/zh/open/development/submittal-file)文档说明，如何调用请参考[如何调用服务端API](/document/development/how-to-call-apis#)文档介绍。
