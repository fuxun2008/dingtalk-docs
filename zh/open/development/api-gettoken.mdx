...
- 企业内部应用：调用[获取企业内部应用的accessToken](https://open.dingtalk.io/document/development/obtain-the-access-token-of-an-internal-app#)接口，获取企业调用接口的凭证信息。
- 第三方企业应用：调用[获取第三方应用授权企业的accessToken](https://open.dingtalk.io/document/development/obtain-the-access-token-of-the-authorized-enterprise-1#)接口，获取第三方应用授权企业调用接口的凭证信息。
