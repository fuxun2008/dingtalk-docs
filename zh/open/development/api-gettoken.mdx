...
description: "调用本接口可获取应用的 access_token,用于后续接口鉴权调用。"
---
...
- 企业内部应用：调用[获取企业内部应用的accessToken](/zh/open/development/obtain-the-access-token-of-an-internal-app#)接口，获取企业调用接口的凭证信息。
