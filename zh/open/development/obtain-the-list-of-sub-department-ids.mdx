---
title: "获取子部门 ID 列表"
description: "调用本接口可获取企业部门下所有直属子部门的 ID 列表,本接口不受授权范围限制。"
---
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| dept_id | Number | 是 | 1 | 父部门ID，根部门传1，可调用[获取部门列表](/zh/open/development/user-management-acquires-the-list-departments)接口获取dept_id参数值。 |
