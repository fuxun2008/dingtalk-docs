---
title: "撤回工作通知消息"
description: "调用本接口，撤回工作通知消息，适用于企业内部应用需要撤回误发的工作通知场景。"
---
...
| msg\_task\_id | Number | 是 | 256271667526 | 发送消息时钉钉返回的任务ID，调用[发送工作通知](/zh/open/development/asynchronous-sending-of-enterprise-session-messages)接口获取task\_id参数值。  **说明**  仅支持撤回24小时内的工作消息通知。 |
