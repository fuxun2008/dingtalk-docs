...
| add\_extidlist | Array of String | 否 | unionid列表，可通过[查询用户详情](https://open.dingtalk.io/document/development/query-users-by-phone-number)接口获取。 |
| del\_extidlist | Array of String | 否 | unionId列表，可通过[查询用户详情](https://open.dingtalk.io/document/development/query-users-by-phone-number)接口获取。 |
| icon | String | 否 | 群头像的mediaId，可通过[上传媒体文件](https://open.dingtalk.io/document/development/upload-media-files)接口获取media\_id参数值。 |
