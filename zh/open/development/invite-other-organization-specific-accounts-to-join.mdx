---
title: "邀请其他组织企业账号加入"
description: "调用本接口将其他组织的企业账号邀请加入本组织,含请求参数与响应字段说明。"
---
...
| outer_exclusive_corpid | String | 是 | ding12345 | 需要添加的企业账号所属的corpId。 |
| outer_exclusive_userid | String | 是 | user01 | 需要添加的企业账号所属的userId。 |
