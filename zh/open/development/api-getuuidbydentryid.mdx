...
description: "调用本接口可根据文件的 spaceId 和 dentryId 获取该文件的 dentryUuid 信息。"
---
...
| operatorId | String | 是 | 操作人 unionId，调用[查询用户详情](/zh/open/development/query-user-details)接口获取 unionid 参数值。 |
