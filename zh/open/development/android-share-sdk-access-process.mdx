...
description: "本文介绍如何使用钉钉Android分享SDK接入钉钉分享。"
---

本文介绍如何使用钉钉Android分享SDK接入钉钉分享。
...
- 搭建Android开发环境。
- 下载[Android SDK](https://files.alicdn.com/tpsservice/e76b61f0c65ddda660bb07f265c35b19.zip) 。
- 安装钉钉客户端2.7.0及以上的版本。

## 步骤一：**接入钉钉分享**

1. 登录[开发者后台](https://open-dev.dingtalk.com/#/shareMan)，然后进入应用详情页。
2. 在应用详情页，单击**钉钉登录与分享**，进入登录与分享页面。

   ![进入分享](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5499666161/p255019.png)
3. 在**接入分享**栏，单击右侧**编辑**。![编辑](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/5499666161/p255020.png)
4. 单击开启**Android 分享**，然后依次填写**Android包名称**和**Android签名**，最后单击保存。

   **说明** 

   签名获取方式请参考[签名方法](https://open.dingtalk.com/document/isvapp-client/share-sdk-download#topic-1949255)。
