---
title: "查询企业账号用户详情"
description: "调用本接口获取指定企业账号用户的详细信息，仅支持已开通企业账号的组织使用。"
---
...
| mobile | String | 13800138000 | 手机号码。  **说明**     - 企业内部应用如果没有返回该字段，需要检查当前应用通讯录权限中**企业员工手机号信息权限**是否开启。 - 第三方企业应用不返回该字段；如需获取mobile，可以使用钉钉统一授权套件方式获取。 |
