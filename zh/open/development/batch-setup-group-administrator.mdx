...
| userIds | Array of String | 是 | 企业员工userid列表。可以调用[获取部门用户userid列表](https://open.dingtalk.io/document/development/query-the-list-of-department-userids)接口获取userid_list参数值。 |
