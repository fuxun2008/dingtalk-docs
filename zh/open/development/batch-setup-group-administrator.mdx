...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| openConversationId | String | 是 | 开放群ID，可以调用[创建群会话](https://open.dingtalk.io/document/development/create-common-group-new-version-v2)接口获取openConversationId参数值。 |
| userIds | Array of String | 是 | 企业员工userid列表。可以调用[获取部门用户userid列表](https://open.dingtalk.io/document/development/query-the-list-of-department-userids)接口获取userid\_list参数值。 |
