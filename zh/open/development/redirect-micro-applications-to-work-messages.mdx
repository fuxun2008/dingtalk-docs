---
title: "点击工作通知跳转到网页应用"
description: "本文档介绍发送的工作通知消息，如何点击实现跳转进入钉钉微应用"
---
...
2. 跳转链接的构造参考[消息链接说明](/zh/open/development/message-link-description)，如下提供这三种类型消息中链接的构造示例，完整的消息发送格式请参考[消息通知类型](/zh/open/development/message-types-and-data-format)。
   ...
   | app\_id | - 企业内部应用-H5微应用，该参数填写0\_agentId，由数字0、下划线和agentId拼接组成，agentId查看请参考[AgentId](/document/development/development-basic-concepts#884d363067bnq)。 - 第三方企业应用-H5微应用，该参数填写当前三方微应用的appId值，appId查看请参考[App ID](/document/development/development-basic-concepts#f20a795ad844u)。 |
