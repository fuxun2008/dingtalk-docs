---
title: "更新用户信息"
description: "调用本接口更新指定用户的信息，覆盖请求参数与响应结构说明。"
---
...
| force_update_fields | String | 否 | manager_userid | 强制更新的字段，支持清空指定的字段，多个字段之间使用逗号分隔。目前支持字段: `manager_userid`。 |
