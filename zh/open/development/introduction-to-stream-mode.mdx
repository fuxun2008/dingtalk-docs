...
- #### **示例代码**
  ...
  **事件订阅回调**
  ...
  详情参见[配置Stream推送](https://open.dingtalk.com/document/orgapp/stream)。
  ...
  **卡片回调**
  ...
  详情参见[互动卡片 Stream](https://open.dingtalk.com/document/orgapp/event-callback-card#a0cb7b50dfnlu) 。
