---
title: "查询会议录制中的文本信息"
description: "调用本接口可查询视频会议录制的语音转文字信息，包括文本内容、文本记录开始时间和文本记录结束时间。"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| conferenceId | String | 否 | 会议ID，可调用[创建视频会议](/zh/open/development/create-a-video-conference#)接口获取conferenceId参数值。 |

### 查询参数

| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 否 | 用户unionId，可调用[查询用户详情](/zh/open/development/query-user-details#)接口获取unionid参数值。 |
