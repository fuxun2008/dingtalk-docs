...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| conferenceId | String | 否 | 会议ID，可调用[创建视频会议](https://open.dingtalk.io/document/development/create-a-video-conference#)接口获取conferenceId参数值。 |

### 查询参数

| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 否 | 用户unionId，可调用[查询用户详情](https://open.dingtalk.io/document/development/query-user-details#)接口获取unionid参数值。 |
