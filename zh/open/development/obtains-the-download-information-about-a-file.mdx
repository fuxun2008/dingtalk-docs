---
title: "获取文件下载信息"
description: "调用本接口获取存储空间内文件的下载信息，包括下载地址等,用于实现文件下载。"
---
...
| dentryId | String | 是 | 文件Id，调用[获取文件或文件夹列表](/zh/open/development/get-a-list-of-files-or-folders#)或[根据 dentryUuid 获取 spaceId](/zh/open/development/api-getdentryidbyuuid#)接口获取id参数值。 |
