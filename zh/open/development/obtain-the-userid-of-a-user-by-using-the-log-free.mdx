...
| --- | --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| code | String | 是 | bab02f63c1e030fbbxxxx | 免登授权码，获取方式请参考：   - [小程序免登授权码](/document/orgapp/mini-program-free-login#) - [微应用免登授权码](/document/orgapp/logon-free-process#)   **说明**  此授权码五分钟内有效，且只能使用一次。 |
