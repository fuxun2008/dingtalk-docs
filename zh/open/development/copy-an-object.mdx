---
title: "复制文件或文件夹"
description: "调用本接口，可实现复制文件或文件夹到其他空间或目录。"
---
...
| dentryId | String | 是 | 需要被复制的文件或文件夹Id，可调用[获取文件或文件夹列表](https://open.dingtalk.com/document/development/get-a-list-of-files-or-folders)或[根据dentryUuid获取spaceId和dentryId](https://open.dingtalk.com/document/development/api-getdentryidbyuuid)接口获取id参数值。 |
...
| targetFolderId | String | 是 | 需要存放的位置父目录Id，可调用[获取文件或文件夹列表](https://open.dingtalk.com/document/development/get-a-list-of-files-or-folders)接口获取id参数值。 |
