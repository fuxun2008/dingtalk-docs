...
- [发送工作通知](https://open.dingtalk.com/document/isvapp/send-job-notification)
...
- [异步转译通讯录ID](https://open.dingtalk.com/document/isvapp/asynchronous-address-book-file-content-translation)
- [获取异步转译任务结果](https://open.dingtalk.com/document/isvapp/obtains-the-results-of-an-asynchronous-translation-task)

## **后续步骤**

接入安全渲染组件后，你需要[导入资源到计算巢](https://open.dingtalk.com/document/isvapp/import-resources-compute-nest)。
