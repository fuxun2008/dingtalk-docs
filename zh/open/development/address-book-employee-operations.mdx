...
description: "本文介绍了创建一个企业内部应用，使用通讯录管理提供的用户管理相关API，实现创建、获取、更新和删除企业员工等。"
---
...
- 服务端API差异详情参见[旧版API VS 新版API](/document/development/how-to-call-apis#section-8lr-id4-rbz)。
