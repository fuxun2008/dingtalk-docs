...
- 日程参与者的添加和删除：建议使用[添加日程参与者](https://open.dingtalk.io/document/development/add-schedule-participant#)和[删除日程参与者](https://open.dingtalk.io/document/development/delete-schedule-participant#)接口。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| userId | String | 是 | 日程组织者的unionId。   - 企业内部应用和第三方企业应用，调用[查询用户详情](https://open.dingtalk.io/document/development/query-user-details#)接口获取unionid参数值。 - 第三方个人应用，调用[获取用户通讯录个人信息](https://open.dingtalk.io/document/development/dingtalk-retrieve-user-information#)接口获取unionId参数值。 |
