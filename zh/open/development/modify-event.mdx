---
title: "修改日程"
description: "调用本接口修改单个日程的信息,含请求参数与响应字段说明。"
---
...
- 日程参与者的添加和删除：建议使用[添加日程参与者](/zh/open/development/add-schedule-participant#)和[删除日程参与者](/zh/open/development/delete-schedule-participant#)接口。
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| userId | String | 是 | 日程组织者的unionId。   - 企业内部应用和第三方企业应用，调用[查询用户详情](/zh/open/development/query-user-details#)接口获取unionid参数值。 - 第三方个人应用，调用[获取用户通讯录个人信息](/zh/open/development/dingtalk-retrieve-user-information#)接口获取unionId参数值。 |
