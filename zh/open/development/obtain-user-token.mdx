...
| code | String | 否 | abcd | OAuth 2.0 临时授权码，第三方企业应用需要[接入统一授权套件](/document/development/unified-licensing-suite-sdk#)/[获取登录用户的访问凭证](/zh/open/development/obtain-identity-credentials)，获取临时授权码authCode。 |
