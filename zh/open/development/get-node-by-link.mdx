---
title: "通过链接获取节点"
description: "调用本接口，根据操作者unionId和文档链接，获取节点信息。"
---
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| operatorId | String | 是 | 操作人unionId，可通过[查询用户详情](https://open.dingtalk.com/document/development/query-user-details#)接口获取。 |
