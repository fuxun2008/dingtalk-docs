...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| parentNodeId | String | 是 | 父节点id(父节点dentryUuid)，可通过调用[获取知识库列表](https://open.dingtalk.com/document/development/get-knowledge-base-list#)接口，获取返回参数`rootNodeId`字段。 |
