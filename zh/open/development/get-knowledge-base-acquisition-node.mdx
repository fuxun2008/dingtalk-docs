---
title: "获取节点"
description: "调用本接口可根据操作者 unionId 与节点 id 获取单个知识库节点的详细信息。"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| nodeId | String | 是 | 节点id(节点dentryUuid)，可通过调用[获取节点列表](/zh/open/development/get-node-list#)接口，获取返回参数`nodeId`字段。 |
