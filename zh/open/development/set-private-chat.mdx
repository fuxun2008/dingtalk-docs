---
title: "设置禁止群成员私聊"
description: "调用本接口设置群成员之间是否可以添加好友和私聊，适用于企业内部群需要管控成员交流范围、保护信息安全等场景。"
---
...
| --- | --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| chatid | String | 是 | chatdafe234xxxx | 企业会话ID。可以通过以下方式获取。   - 调用服务端[创建群](/document/development/session-management-creates-groups#)接口获取chatid参数值。 - 调用客户端[chooseChat](/document/development/jsapi-choose-chat#)获取chatId参数值。 |
