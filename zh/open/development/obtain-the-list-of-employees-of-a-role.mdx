---
title: "获取指定角色的员工列表"
description: "调用本接口可获取指定角色下的员工列表,用于查看该角色已分配的成员。"
---
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| role_id | Number | 是 | 1203141 | 角色roleId，可通过调用[获取角色列表](/zh/open/development/obtains-a-list-of-enterprise-roles)接口获取id参数值。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| request_id | String | f6249uw1kuus | 请求ID。 |
