---
title: "获取入群二维码链接"
description: "调用本接口，获取群入群二维码邀请链接，适用于企业需要快速邀请成员加入群聊的场景，如组织活动、项目协作等。"
---
...
| --- | --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| chatid | String | 是 | chat3234dfs423a | 群会话的chatid，可调用[创建群](/document/development/session-management-creates-groups#)接口获取chatid参数值。 |
