---
title: "获取员工人数"
description: "调用本接口获取企业员工总人数，覆盖请求参数与响应结构说明。"
---
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| only_active | Boolean | 是 | false | 是否包含未激活钉钉人数：   - **false**：包含未激活钉钉的人员数量。 - **true**：只包含激活钉钉的人员数量。 |
...
| 名称 | 类型 | 示例值 | 描述 |
| --- | --- | --- | --- |
| request_id | String | o38h5bztjouc | 请求ID。 |
| errcode | Number | 0 | 状态码，0表示调用成功。 |
| errmsg | String | 不合法的access_token | 调用失败时返回错误信息。 |
