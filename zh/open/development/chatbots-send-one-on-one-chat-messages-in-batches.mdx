...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| robotCode | String | 是 | 机器人的编码，该参数必须使用企业内部应用机器人的robotCode，详情参考[机器人 ID](https://open.dingtalk.io/document/development/development-robot-overview#447ec33014hrl)。 |
| userIds | Array of String | 是 | 接收消息的用户userId列表，每次最多传20个，可通过[查询用户详情](https://open.dingtalk.io/document/development/query-user-details#)或[获取部门用户userid列表](https://open.dingtalk.io/document/development/query-the-list-of-department-userids#)接口获取。 |
| msgKey | String | 是 | 消息模板key，详情参考[企业机器人发送消息的消息类型](https://open.dingtalk.io/document/dingstart/types-of-messages-sent-by-robots#)。 |
| msgParam | String | 是 | 消息模板参数，消息模板参数，详情参考[企业机器人发送消息的消息类型](https://open.dingtalk.io/document/dingstart/types-of-messages-sent-by-robots#)。 |
...
| 名称 | 类型 | 描述 |
| --- | --- | --- |
| processQueryKey | String | 消息id，可用于[批量查询人与机器人会话机器人消息是否已读](https://open.dingtalk.io/document/development/chatbot-batch-query-the-read-status-of-messages#)和[批量撤回人与机器人会话中机器人消息](https://open.dingtalk.io/document/development/batch-message-recall-chat#)接口，查询消息是否已读和撤回消息。 |
