...
企业调用[设置用户属性可见性](/document/app/add-or-update-the-hidden-settings-of-the-employee-property#)接口后，可调用本接口删除企业员工属性字段的隐藏设置信息。
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| settingId | Long | 是 | 设置的ID，可通过[设置用户属性可见性](https://open.dingtalk.com/document/development/add-or-update-the-hidden-settings-of-the-employee-property#)接口获取id参数值。 |
