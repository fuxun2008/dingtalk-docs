---
title: "删除用户属性可见性设置"
description: "调用本接口删除企业员工属性字段的可见性设置,含请求参数与响应字段说明。"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| settingId | Long | 是 | 设置的ID，可通过[设置用户属性可见性](/zh/open/development/add-or-update-the-hidden-settings-of-the-employee-property#)接口获取id参数值。 |
