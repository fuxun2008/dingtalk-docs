---
title: "更新群成员的群昵称"
description: "调用本接口更新群成员在群中的昵称，适用于群管理员统一规范群成员昵称和群成员自行修改昵称等场景。"
---
...
| chatid | String | 是 | chate3929fxxxx | 群会话ID，可通过[创建群](/document/development/session-management-creates-groups#)接口获取chatid参数值。 |
