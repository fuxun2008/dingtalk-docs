...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| downloadCode | String | 是 | 用户向机器人发送文件消息后，机器人回调给开发者消息中的下载码。详情参考[机器人接收消息](https://open.dingtalk.io/document/dingstart/receive-message#)。 |
| robotCode | String | 是 | 机器人的编码，详情参考[机器人 ID](https://open.dingtalk.io/document/development/robot-overview#)。 |
