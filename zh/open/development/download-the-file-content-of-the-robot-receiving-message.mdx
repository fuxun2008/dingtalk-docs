...
description: "调用本接口可获取机器人接收消息中的文件下载链接,用于下载用户发送给机器人的文件内容。"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| downloadCode | String | 是 | 用户向机器人发送文件消息后，机器人回调给开发者消息中的下载码。详情参考[机器人接收消息](/zh/open/development/receive-message#)。 |
