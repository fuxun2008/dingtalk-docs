...
| parentId | String | 否 | 父目录Id。根目录时，该参数是0，调用[获取文件或文件夹列表](https://open.dingtalk.io/document/development/obtain-the-file-list-storage#)接口获取parentId参数值。    用于同目录文件名冲突校验。 |
