---
title: "关闭视频会议"
description: "调用本接口，关闭视频会议，仅限该会议的主持人有关闭视频会议的权限。"
---
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| unionId | String | 是 | 员工在当前开发者企业账号范围内的唯一标识，可调用[查询用户详情](https://open.dingtalk.com/document/development/query-user-details#)接口获取unionid参数值。 |
