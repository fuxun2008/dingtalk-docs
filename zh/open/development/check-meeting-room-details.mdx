...
| memberId | String | 成员的id，memberType设置  人员：成员unionId，可调用[查询用户详情](https://open.dingtalk.io/document/development/query-user-details)接口获取获取。  部门：部门id，dept\_id，可调用[获取部门列表](https://open.dingtalk.io/document/development/obtain-the-department-list-v2)接口获取。 |
