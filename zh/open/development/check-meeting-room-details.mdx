---
title: "查询会议室详情"
description: "调用本接口查询会议室详情,包含名称、可容纳人数与位置等信息。"
---
...
| memberId | String | 成员的id，memberType设置  人员：成员unionId，可调用[查询用户详情](/zh/open/development/query-user-details)接口获取获取。  部门：部门id，dept_id，可调用[获取部门列表](https://open.dingtalk.com/document/development/obtain-the-department-list-v2)接口获取。 |
