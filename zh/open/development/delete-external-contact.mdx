---
title: "删除外部联系人"
description: "调用本接口删除企业的外部联系人,含请求参数与响应字段说明。"
---
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| user_id | String | 是 | 0125xxxx0251487 | 要删除的外部联系人的userId，可以调用[获取外部联系人列表](/zh/open/development/obtain-the-external-contact-list)接口获取userid参数值。 |
