---
title: "添加、获取及删除日程参与者"
description: "演示通过日程相关 API 完成参与者管理的完整流程，包括获取应用凭证、添加接口权限、创建日程、添加获取删除参与者及设置响应状态。"
---
...
根据步骤一中 的 Client ID 和 Client Secret，获取应用访问凭证[获取企业内部应用的access_token](/zh/open/development/obtain-orgapp-token)。
