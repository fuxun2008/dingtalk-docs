---
title: "添加、获取及删除日程参与者"
description: "本文档介绍了如何调用日程相关接口实现日程参与者的相关流程。首先创建一个企业内部应用，再使用日程提供的API，实现创建日程、添加日程参与者、获取日程参与者、设置日程响应邀请状态、删除日程参与者流程。"
---
...
- 日程创建成功后，如下图所示：
  ...
  ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2443542661/p486863.png)
- 添加日程参与者界面，如下图所示：

  ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2443542661/p486868.png)
- 查看日程响应状态，如下图所示：

  ![image](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/2443542661/p486894.png)
