---
title: "获取文件分片上传信息"
description: "调用本接口获取文件分片上传时每片文件对应的上传信息，用于实现大文件分片上传。"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| uploadKey | String | 是 | 上传唯一标识，调用[初始化文件分片上传](/zh/open/development/initialize-a-multipart-upload-object#)接口，获取上传标识uploadKey。 |
