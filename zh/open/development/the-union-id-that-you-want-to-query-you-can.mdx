...
description: "调用本接口可在普通账号迁移为企业账号后，根据原 unionId 查询迁移后的 unionId。"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 是 | 原普通账号的unionId，可调用[通过免登码获取用户信息](/zh/open/development/obtain-the-userid-of-a-user-by-using-the-log-free#)获取unionid参数值。 |
