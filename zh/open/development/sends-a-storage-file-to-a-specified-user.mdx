...
description: "调用本接口，以应用身份发送文件给指定用户。"
---
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| unionId | String | 是 | 接收文件的用户unionId，可调用[查询用户详情](https://open.dingtalk.com/document/development/query-user-details#)接口获取。 |
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| spaceId | String | 是 | 文件所在空间ID，调用[添加空间](https://open.dingtalk.com/document/development/add-space#)接口获取id参数值。 |
