...
description: "调用本接口可以应用身份将文件发送给指定用户，用于应用向个人定向推送文件。"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 是 | 接收文件的用户unionId，可调用[查询用户详情](/zh/open/development/query-user-details#)接口获取。 |

### 请求体

| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| spaceId | String | 是 | 文件所在空间ID，调用[添加空间](/zh/open/development/add-space#)接口获取id参数值。 |
