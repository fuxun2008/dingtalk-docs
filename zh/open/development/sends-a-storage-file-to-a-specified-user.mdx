...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 是 | 接收文件的用户unionId，可调用[查询用户详情](https://open.dingtalk.io/document/development/query-user-details#)接口获取。 |

### 请求体

| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| spaceId | String | 是 | 文件所在空间ID，调用[添加空间](https://open.dingtalk.io/document/development/add-space#)接口获取id参数值。 |
| dentryId | String | 是 | 文件ID，可调用[获取文件或文件夹列表](https://open.dingtalk.io/document/development/obtain-the-file-list-storage#)接口获取id参数值。 |
