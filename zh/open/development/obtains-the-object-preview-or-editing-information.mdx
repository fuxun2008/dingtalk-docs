---
title: "获取文件预览或编辑信息"
description: "调用本接口获取存储空间内文件的预览或编辑链接，授权用户可通过链接预览或编辑文件。"
---
...
| version | Long | 否 | 指定文件的版本号，可调用[获取文件或文件夹列表](/zh/open/development/get-a-list-of-files-or-folders)接口获取id参数值。 |
