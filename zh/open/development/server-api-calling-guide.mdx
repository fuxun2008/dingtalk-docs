...
1. 访问[获取企业内部应用的accessToken](/zh/open/development/obtain-the-access-token-of-an-internal-app)接口，通过右侧的**API调试**按钮打开[服务端调试工具](https://open.dingtalk.io/document/download/api-explorer)。
...
![支持与帮助](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/7516308771/p1071955.png)