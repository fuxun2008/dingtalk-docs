...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| dentryUuid | String | 是 | 文件uuid：可调用[搜索文件](https://open.dingtalk.io/document/development/search-for-files)接口或[获取dentryUuid信息](https://open.dingtalk.io/document/development/api-getuuidbydentryid)接口，获取返回参数`dentryUuid`字段。 |
