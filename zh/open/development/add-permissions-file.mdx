---
title: "添加权限"
description: "调用本接口可根据文件 uuid、操作者 unionId 与权限 ID 等参数,为文件成员添加访问权限。"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| dentryUuid | String | 是 | 文件uuid：可调用[搜索文件](/zh/open/development/search-for-files)接口或[获取dentryUuid信息](/zh/open/development/api-getuuidbydentryid)接口，获取返回参数`dentryUuid`字段。 |
