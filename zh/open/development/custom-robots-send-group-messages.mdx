---
title: "自定义机器人发送群消息"
description: "调用本接口可使用自定义机器人向指定群发送消息，附接口调用说明、请求参数和响应字段。"
---
...
| 名称 | 类型 | 是否必填 | 示例值 | 描述 |
| --- | --- | --- | --- | --- |
| access_token | String | 是 | BE3xxxx | 自定义机器人调用接口的凭证。  自定义机器人安装后webhook地址中的access_token值。详情参考[获取自定义机器人 Webhook 地址](/zh/open/dingstart/obtain-the-webhook-address-of-a-custom-robot)。 |
