...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| parentDentryUuid | String | 是 | 父节点dentryUuid，可调用[搜索文件](https://open.dingtalk.com/document/development/search-for-files#)或[获取 dentryUuid 信息](https://open.dingtalk.com/document/development/api-getuuidbydentryid#)接口，获取返回参数`dentryUuid`字段。    如果是空间根目录, 填空间根目录的dentryUuid。 |
