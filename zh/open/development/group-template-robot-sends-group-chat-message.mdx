---
title: "群模板机器人发送群聊消息"
description: "通过群模板机器人发送群聊消息的实操指南，覆盖需求明确、前提条件、快速体验与操作步骤。"
---
...
2. 替换 groupTemplateRobotGroupMessage 的 main 方法参数：
   ...
   | 配置项 | 说明 |
   | --- | --- |
   | GROUP_TEMPLATE_ID | 登录开发者后台，单击**开放能力** > **场景群** > **群模板，**复制 ID。  image.png |
   | ROBOT_CODE | 登录开发者后台，单击**开放能力** > **场景群** > **群模板** > **目标群模板**。复制机器人 ID。  image.png  如果群模板没有关联机器人，参考关联群模板机器人到群模板。 |
   | OWNER_USER_ID | 用户的 userId 信息，详情参考[用户 UserId](/zh/open/dingstart/basic-concepts-beta)。 |
   | CLIENT_ID | 应用的 Client ID，详情参考[Client ID](/zh/open/dingstart/basic-concepts-beta)。 |
   | CLIENT_SECRET | 应用的 Client Secret，详情参考[Client Secret](/zh/open/dingstart/basic-concepts-beta)。 |
...
2. 创建 main 方法，并启动。
   ...
   此时，将自动创建一个群聊会话，并且你可以在群内看到群模板机器人发送的消息了。![](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/9834868071/p768611.png)
