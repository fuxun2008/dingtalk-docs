---
title: "获取文件或文件夹信息"
description: "调用本接口可在存储空间内添加文件夹或文件时获取相关信息,含接口说明与请求响应。"
---
...
| dentryId | String | 是 | 文件或文件夹Id，可调用[获取文件或文件夹列表](/zh/open/development/get-a-list-of-files-or-folders)或[根据dentryUuid获取spaceId和dentryId](/zh/open/development/api-getdentryidbyuuid)接口获取id参数值。 |
