...
description: "讲解设置群插件快捷入口 URL 的方式，覆盖跳转到普通页面、H5 微应用、小程序三种场景，并说明如何通过链接获取来源群信息。"
---
...
| pc_slide | pc_slide=true 时，PC 端会在侧边栏打开该页面。 |
...
| agentId | 和 appId 二选一，如果同时存在，优先用 app_id | 应用id。 |
| corpid | 是 | 企业corpId。 |
