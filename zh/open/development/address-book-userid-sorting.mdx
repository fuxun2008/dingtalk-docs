...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| userIdList | Array of String | 是 | 用户userId，可通过[通过免登码获取用户信息](https://open.dingtalk.io/document/development/obtain-the-userid-of-a-user-by-using-the-log-free#)获得userid参数值。 |
