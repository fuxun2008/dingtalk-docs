---
title: "通讯录 userId 排序"
description: "调用本接口可按用户姓名拼音对 userId 列表进行排序,并返回错误码用于异常排查。"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| userIdList | Array of String | 是 | 用户userId，可通过[通过免登码获取用户信息](/zh/open/development/obtain-the-userid-of-a-user-by-using-the-log-free#)获得userid参数值。 |
