...
| subjectDeptIds | Array of Long | 否 | 需要限制查看通讯录的部门ID列表，可调用[获取部门列表](https://open.dingtalk.io/document/development/obtain-the-department-list-v2#)接口获取dept_id。      subjectUserIds、subjectDeptIds、subjectTagIds三个参数内元素个数之和不能超过50。 |
