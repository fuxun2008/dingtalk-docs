---
title: "获取权限列表"
description: "调用本接口，根据指定id（文件uuid、知识库rootNodeId、知识库节点nodeId)和操作者id，查询用户文件权限列表。"
---
...
| --- | --- | --- | --- |
| 名称 | 类型 | 是否必填 | 描述 |
| unionId | String | 是 | 用户unionId，调用[查询用户详情](https://open.dingtalk.com/document/development/query-user-details)接口获取。 |
