---
title: "获取权限列表"
description: "调用本接口可根据文件 uuid、知识库 rootNodeId 或节点 nodeId 与操作者 id 查询用户对该对象的文件权限列表。"
---
...
| 名称 | 类型 | 是否必填 | 描述 |
| --- | --- | --- | --- |
| unionId | String | 是 | 用户unionId，调用[查询用户详情](/zh/open/development/query-user-details)接口获取。 |
