---
title: "组件属性"
description: "讲解自定义组件 propTypes 属性定义的配置方法，通过声明可配置属性提升组件的灵活性与业务适配能力。"
---
...
组件的属性类型基本类似于常见的数据类型，分别有：**文本、布尔、数字、对象、数组、函数、元素**七种类型，每个数据类型又对应若干个[设置器](#设置器)，以满足用户对数据不同维度的处理需求。（如下图所示）
<Frame>
