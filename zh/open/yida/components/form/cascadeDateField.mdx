...
description: "CascadeDateField 日期区间组件参考，介绍区间格式与日期限制等属性配置，通过弹出面板选择起止日期。"
---
...
<iframe src="https://www.aliwork.com/developer/cascade-date-field-v2?isRenderNav=false" width="100%" height="480" frameBorder="0"></iframe>
...
| `format` | 日期区间组件显示格式 | `'YYYY' \| 'YYYY-MM' \| 'YYYY-MM-DD' \| 'YYYY-MM-DD HH:mm' \| 'YYYY-MM-DD HH:mm'YYY-MM-DD HH:mm:ss` | `'YYY-MM-DD'` |
