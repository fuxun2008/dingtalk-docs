---
title: "TableField 明细"
description: "TableField 明细组件参考，详解子表单字段配置、行操作与数据读写方式，用于一条主表数据关联多条明细的提交场景。"
---
...
<iframe src="https://www.aliwork.com/developer/table-field-v2?isRenderNav=false" width="100%" height="480" frameBorder="0"></iframe>
