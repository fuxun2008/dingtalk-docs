...
description: "NumberField 数字输入框组件参考，介绍精度、步长、上下限等属性配置，自动校验并订正输入的数值。"
---
...
<iframe src="https://www.aliwork.com/developer/number-field-v2?isRenderNav=false" width="100%" height="480" frameBorder="0"></iframe>
