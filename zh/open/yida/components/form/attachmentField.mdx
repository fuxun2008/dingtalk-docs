...
description: "AttachmentField 上传附件组件文档，介绍文件类型限制、数量上限与上传事件等属性配置，用于表单中的文件上传提交。"
---
...
<iframe src="https://www.aliwork.com/developer/attachment-field-v2?isRenderNav=false" width="100%" height="480" frameBorder="0"></iframe>
