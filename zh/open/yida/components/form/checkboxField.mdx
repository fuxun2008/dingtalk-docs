...
description: "CheckboxField 多选组件参考，介绍选项数据源、默认值与状态切换用法，支持在一组选项中进行多项勾选。"
---
...
<iframe src="https://www.aliwork.com/developer/check-v2?isRenderNav=false" width="100%" height="480" frameBorder="0"></iframe>
...
| `iconPosition` | 手机端Icon位置 | `'left' \| 'right'` | `'left'` |
