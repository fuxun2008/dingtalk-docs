---
title: "Icon 图标"
description: "Icon 图标组件参考，介绍宜搭内置图标的选择方式与尺寸设置，为页面增加直观的视觉标识。"
---
...
<iframe src="https://www.aliwork.com/developer/icon-v2?isRenderNav=false" width="100%" height="480" frameBorder="0"></iframe>
