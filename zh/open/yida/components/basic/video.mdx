---
title: "Video 视频播放"
description: "Video 视频播放组件文档，介绍视频地址、封面与播放控制等属性配置，支持 mp4、mov 等 HTML 原生视频格式。"
---
...
<iframe src="https://www.aliwork.com/developer/video-v2?isRenderNav=false" width="100%" height="480" frameBorder="0"></iframe>
...
| `playbackRate` | 倍数列表 | `array` | `[ 0.8, 1, 1.5, 2 ]` |
