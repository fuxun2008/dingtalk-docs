---
title: "Timeline 时间轴"
description: "Timeline 时间轴组件文档，介绍节点内容与状态配置，按时间顺序垂直展示流程或事件信息。"
---
...
<iframe src="https://www.aliwork.com/developer/timeLine-v2?isRenderNav=false" width="100%" height="480" frameBorder="0"></iframe>
