---
title: "服务端开放API"
description: "汇总宜搭服务端开放 API 的能力范围与接入入口，指引开发者通过钉钉开放平台完成服务端集成，实现表单数据的后端读写操作。"
---
...
- 企业内部应用，详情请参考[添加接口调用权限](/zh/open/development/add-api-permission)。
...
- 企业内部应用请参考[获取企业内部应用的 accessToken](https://open.dingtalk.com/document/orgapp-server/obtain-the-access_token-of-an-internal-app#topic-2056397)。
