...
description: "如果您需要了解文档酷应用Manifest，请参考本文档。"
---
...
如果你已经了解了文档酷应用Manifest，需要[接入文档酷应用](/zh/open/dingstart/access-document-coolapp)。

**说明** 

如果你需要开发文档酷应用，详情参考[脚本服务和 UI 页面](/zh/open/dingstart/develop-document-coolapp-script-services-and-ui-pages)。
