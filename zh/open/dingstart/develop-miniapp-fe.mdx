---
title: "开发小程序前端"
description: "在钉钉开发者工具中，您可以进行小程序的开发、调试、预览和发布等操作。本文将为您详细介绍如何使用钉钉开发者工具完成小程序前端开发的全流程。更多有关钉钉开发者工具的信息，参考。"
---

在钉钉开发者工具中，您可以进行小程序的开发、调试、预览和发布等操作。本文将为您详细介绍如何使用钉钉开发者工具完成小程序前端开发的全流程。更多有关钉钉开发者工具的信息，参考[小程序开发工具](/document/download/miniapp-tool#)。
...
小程序开发和调试完成后，你需要进行[上传小程序](/zh/open/dingstart/upload-miniapp)。
