...
发通知消息时，可以在内容中以模板参数语法包含id，钉钉会将其替换为成员名或部门名，涉及服务端api：[发送工作通知](/zh/open/development/asynchronous-sending-of-enterprise-session-messages)
...
接入安全渲染组件后，你需要[导入资源到计算巢](/zh/open/dingstart/import-resources-compute-nest)。
