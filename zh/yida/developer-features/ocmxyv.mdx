---
title: "JS 动作面板"
description: "本文介绍了如何在宜搭中使用动作面板编写JS代码，实现业务逻辑或逻辑判断。包括支持的版本、代码输入方法、动作绑定、获取回调函数参数、API使用手册、调试JS代码的方法以及子表单API优化等内容。"
---
...
<Frame>
  ![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/png/1737015844731-ad478285-3fda-4b0d-b0e8-596af7d467ad.png)
</Frame>
...
<Frame>
  ![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/gif/1612074286808-a1956698-7d26-411a-8371-5b0cc36edc6e.gif)
</Frame>
...
<Frame>
  ![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/png/1737016009385-d856fa1a-d645-4c0b-a3f3-35678a8a7743.png)
</Frame>
...
详情请参考：[https://developers.aliwork.com/docs/api/about](/zh/open/yida/api/about)
...
在 JS 函数中，可以使用 `debugger` 关键字，以阻断程序做调试，以下视频演示下如何基础使用 `debugger` 。

<video controls preload="metadata" poster="https://img.alicdn.com/imgextra/i4/6000000006586/O1CN01lAfNT81yWR9Bjwz3m_!!6000000006586-0-tbvideo.jpg" src="https://yida-support.oss-cn-shanghai.aliyuncs.com/static/mp4/297506084042.mp4"></video>
...
https://www.yuque.com/jiushen/blog/xswitch-readme
...
<Frame>
  ![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/png/1612689855924-4e2ec645-b338-4809-884c-198944ffdd9f.png)
</Frame>
...
<Frame>
  ![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/png/1647423747345-7d1dff67-9c5d-4b79-a0b5-e8dcfbaba838.png)
</Frame>
...
<Frame>
  ![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/png/1623833737725-e5fb8096-20f9-407c-a843-e6f0a5039add.png)
</Frame>
...
宜搭域名是 https://www.yidaapps.com 所以，受到浏览器安全限制，只能请求 https 的接口，不能请求 http 。更加不能请求本地的类似 http://192.168.xxx 的接口。

<Frame>
  ![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/png/1615972497816-4e73fa3c-7f4d-484d-b49e-e69bf4964b3b.png)
</Frame>
...
2、允许 www.yidaapps.com [**跨站访问**](http://www.ruanyifeng.com/blog/2016/04/cors.html)。不然会报：cross site policy 错误。
