---
title: "图片裁剪上传（高阶）"
description: "该页面介绍了如何通过封装自定义组件来实现图片剪裁上传功能，包括案例背景、效果演示以及详细的操作步骤。特别强调了此组件仅用于学习，并非官方标准组件。"
---

<Note>
- 该组件在 [自定义组件案例 - 图片裁剪上传（中阶）](/zh/yida/form/eu0e6k) 的基础上做了进步的封装，从而较少用户使用成本。
...
<video controls preload="metadata" poster="https://img.alicdn.com/imgextra/i1/6000000000661/O1CN018XI6yg1GkmXO3uHdL_!!6000000000661-0-tbvideo.jpg" src="https://yida-support.oss-cn-shanghai.aliyuncs.com/static/mp4/347867432564.mp4"></video>
