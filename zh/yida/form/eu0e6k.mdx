---
title: "自定义组件案例 - 图片裁剪上传（中阶）"
description: "介绍如何通过普通组件创建一个表单组件，特别是图片剪裁上传功能的实现方法。适用于学习目的，并非官方标准组件。包括使用场景、效果演示及具体操作步骤。"
---
...
<video controls preload="metadata" poster="https://img.alicdn.com/imgextra/i3/6000000000194/O1CN01X0beAh1DItZcctKZQ_!!6000000000194-0-tbvideo.jpg" src="https://yida-support.oss-cn-shanghai.aliyuncs.com/static/mp4/348970090686.mp4"></video>
