...
<Warning>
未升级到新版信息架构的组织，请 [**点此查看**](https://docs.aliwork.com/docs/yida_support/cap0ag)使用手册
</Warning>
...
<AccordionGroup>
<Accordion title="5.1 如何限制附件最小上传数量？">
...
<Accordion title="5.3 为什么上传的图片无法旋转？">
...
<Accordion title="5.4 如何获取附件在线预览地址？">
  ...
  export function onChange({ value }) {
    ...
    this.$('单行组件唯一标识').setValue("https://www.aliwork.com"+value[0].imgURL)
  }
  ```
</Accordion>
</AccordionGroup>
