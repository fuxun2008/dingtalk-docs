...
| **Before（配置繁琐、数据条数存在上限、无法嵌套查询）**<br />比如“产品”对应原材料的表，目前用子表的方案实现，**子表数据量上限为500条**，且**子表无法再嵌套关联子表。**<br />![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/png/1672228898146-ba0f5d54-e6bf-4caf-9c60-f85766a92d44.png) | **After（简单、直接、高效、易理解、提高场景数据适配上限、支持递归嵌套查询）**<br />直接引用“关联查询”组件，查出关联表的明细进行展示，无需用子表内每个字段默认值数据联动的方式 配置，提高最佳实践的配置效率，降低操作和理解成本，同时支持关联查询子表信息。<br />![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/png/1672228956331-f118c666-b185-4cf1-b32e-0de2efb5609d.png) |
|---|---|
