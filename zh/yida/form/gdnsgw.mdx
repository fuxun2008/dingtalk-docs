---
title: "自定义样式介绍"
description: "页面介绍了不同版本（免费版、轻享版、专业版、专属版）的功能对比，特别是自定义页面样式的能力。还详细解释了CSS布局相关属性如内边距、外边距及边框等的使用方法。"
---
...
<Warning>
未升级到新版信息架构的组织，请 [**点此查看**](https://docs.aliwork.com/docs/yida_support/eatgkx)使用手册
</Warning>
...
<Frame>
  ![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/png/1639382309991-2bfe58b4-8f0b-47e6-be16-a45cd98929cb.png)
</Frame>
...
<Frame>
  ![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/gif/1646893100523-4a8a2ad7-7e91-4fc1-9375-f9f88da9d715.gif)
</Frame>
...
<Frame>
  ![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/png/1623822814728-a27821e6-808b-405a-badd-da28245554ed.png)
</Frame>
