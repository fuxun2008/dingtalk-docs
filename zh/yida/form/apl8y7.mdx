---
title: "自定义组件案例 - 应用列表"
description: "本文档介绍了如何创建和配置一个自定义组件，用于展示应用列表。包括使用场景、效果演示及具体操作步骤如新建组件、开启schema导入功能等。"
---
...
<Frame>
  ![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/png/1661771889176-bbd0c0bd-009d-4441-9e68-022773cb7cdf.png)
</Frame>
