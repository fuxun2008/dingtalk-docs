---
title: "表单设计"
description: "本页面介绍了宜搭中表单的设计步骤和使用场景，包括添加组件、设置组件属性及表单属性等关键步骤，并解答了关于外设集成与表单数量限制的常见问题。"
---

<Warning>
未升级到新版信息架构的组织，请 [**点此查看**](https://docs.aliwork.com/docs/yida_support/hq54gz)使用手册
</Warning>
...
<Frame>
  ![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/png/1638935610887-327ba726-0748-429e-bafe-cc5de9ed3b5f.png)
</Frame>
...
<Frame>
  ![](https://yida-support.oss-cn-shanghai.aliyuncs.com/static/png/1638935654903-98bd3838-3240-43f6-93f9-e47171e224bf.png)
</Frame>
