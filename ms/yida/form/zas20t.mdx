---
title: "Contoh Komponen Tersuai: Pengaki Halaman"
description: "Pengaki halaman muncul di bahagian bawah halaman web dan biasanya mengandungi maklumat hak cipta dan pautan berkaitan. Dokumen ini menerangkan cara membina pengaki halaman dengan mencipta komponen tersuai dan mengaktifkan fungsi import skema."
polished: true
---
...
- Rujuk komponen ini untuk mempelajari cara mengkonfigurasikan atribut, menyesuaikan diri dengan pelbagai peranti, dan banyak lagi.
- Komponen ini disediakan untuk tujuan pembelajaran sahaja dan bukan komponen standard rasmi.
</Note>

## 1. Kes Penggunaan

**Pengaki halaman** muncul di bahagian bawah halaman web. Ia biasanya mengandungi maklumat hak cipta dan pautan berkaitan, menjadikannya lebih mudah bagi pelawat untuk menavigasi antara halaman.

## 3. Langkah-langkah

##### 2. Aktifkan fungsi import skema. Prosesnya adalah sama seperti dalam Pereka bentuk borang YiDA. Untuk maklumat lanjut, rujuk:
...
##### 3. Tampal skema di bawah ke dalam konsol skema pereka bentuk komponen, kemudian klik Import skema.
