---
title: "Contoh Komponen Tersuai - Senarai Aplikasi"
description: "Pelajari cara mencipta dan mengkonfigurasikan komponen tersuai yang memaparkan senarai aplikasi. Panduan ini merangkumi kes penggunaan, demo kesan, dan langkah khusus seperti mencipta komponen serta mengaktifkan import schema."
polished: true
---
...
- Gunakan komponen ini sebagai rujukan untuk mengkonfigurasikan atribut dan sokongan pelbagai peranti.
- Komponen ini disediakan untuk tujuan pembelajaran sahaja dan bukan komponen standard yang ditawarkan oleh platform.
</Note>

## 1. Kes Penggunaan

Ciri **Senarai aplikasi** biasa digunakan pada halaman paparan.

## 3. Langkah

##### 2. Aktifkan ciri import skema. Prosesnya sama seperti dalam pereka bentuk borang YiDA. Untuk butiran, lihat yang berikut:

- Buka pereka bentuk komponen, buka konsol pelayar, dan jalankan kod di bawah.
        ...
        "__propTypes__": [
          {
            ...
            "__batchEditFormatToLines__": {
              ...
              "name": "urlParams",
              "description": "Parameters from the current page URL. For example, in aliwork.com/APP_xxxx/workbench?id=1&name=YiDA, retrieve YiDA via this.state.urlParams.name.",
