---
title: "Muat naik pemangkasan imej (peringkat pertengahan)"
description: "Pelajari cara membina komponen borang daripada komponen umum di YiDA dengan tumpuan pada ciri muat naik imej berserta pemangkasan — untuk tujuan pembelajaran sahaja, bukan komponen standard rasmi."
polished: true
---

<Note>
- Komponen ini boleh dijadikan rujukan untuk membina komponen borang daripada komponen umum.
- Nota: Komponen ini hanya untuk tujuan pembelajaran dan bukan komponen standard yang disediakan secara rasmi.
</Note>

## 1. Kes penggunaan

![](https://gw.alicdn.com/imgextra/i4/O1CN017oefi1OzZnD8JcKk_!!6000000002995-2-tps-4096-2182.png)


- YiDA melancarkan ciri komponen tersuai yang menyokong pembinaan komponen secara low-code. Walau bagaimanapun, ciri ini tidak menyokong komponen borang — hanya komponen berorientasikan paparan sahaja yang boleh dibina.
- Namun begitu, dokumentasi menyatakan bahawa borang sedia ada boleh digunakan untuk penyimpanan data. Berdasarkan pendekatan ini, satu komponen muat naik dengan pemangkasan imej telah dibina dengan menjana borang baharu untuk menyimpan data, seolah-olah mensimulasikan komponen borang sebenar.

## 3. Langkah-langkah

##### 2. Aktifkan ciri Import schema — pendekatan yang sama seperti Pereka bentuk borang YiDA. Untuk butiran lanjut, rujuk:
...
##### 3. Tampal schema berikut ke dalam konsol schema pereka bentuk komponen, kemudian klik Import schema
...
1. Pendekatan ini pada dasarnya mengikat komponen borang sedia ada untuk penyimpanan data, supaya data dapat dihantar.
2. Kelemahannya ialah terdapat sedikit kos penggunaan — anda perlu mengawal sendiri keterlihatan komponen yang diikat.
3. Pemangkasan imej menggunakan react-cropper yang bersifat sumber terbuka: https://www.npmjs.com/package/react-cropper. Oleh sebab pemasangan kebergantungan NPM belum disokong, satu-satunya pilihan ialah memuatkannya secara dinamik melalui CDN.
