---
title: "Pemotongan dan Muat Naik Gambar (Lanjutan)"
description: "Halaman ini menerangkan cara melaksanakan pemotongan dan muat naik gambar dengan membungkus komponen tersuai, merangkumi latar belakang, demo, dan langkah-langkah terperinci. Perhatikan bahawa komponen ini disediakan untuk tujuan pembelajaran sahaja dan bukan komponen standard rasmi."
polished: true
---

<Note>
- Komponen ini dibungkus lanjut berdasarkan [Contoh komponen tersuai - Pemotongan dan muat naik gambar (pertengahan)](/ms/yida/form/eu0e6k), yang mengurangkan kos penggunaan bagi pengguna.

- Perhatian: Komponen ini hanya untuk tujuan pembelajaran dan bukan komponen standard yang disediakan secara rasmi.
</Note>

## 1. Latar Belakang

![](https://gw.alicdn.com/imgextra/i3/O1CN01d6nRYmiO9TH8JcKk_!!6000000002670-2-tps-4096-2182.png)


- Komponen YiDA memperkenalkan ciri komponen tersuai yang menyokong pembinaan komponen secara low-code. Namun, ia tidak menyokong komponen borang — hanya komponen jenis paparan yang dapat dibina.
- Dokumentasi menyatakan bahawa borang sedia ada boleh digunakan untuk penyimpanan. Berdasarkan pendekatan ini, sebuah komponen pemotongan dan muat naik gambar dibina dengan menjana borang baharu untuk menyimpan data, sekali gus mensimulasikan komponen borang palsu.

## 3. Langkah-langkah

##### 2. Aktifkan ciri import schema, dengan cara yang sama seperti Pereka bentuk borang YiDA. Rujuk yang berikut:

- Buka pereka bentuk komponen, buka konsol, dan jalankan kod berikut.

```javascript
document.querySelector('.lc-left-area-bottom div:last-child').style.display = 'block'
```

##### 3. Tampal schema di bawah ke dalam konsol schema pereka bentuk komponen, kemudian klik Import schema.
...
## 4. Prinsip di Sebalik Kes Ini

1. Berdasarkan kes 2, kes ini terutamanya memanfaatkan keupayaan menulis kod dalam sifat konfigurasi "apabila nilai berubah" komponen. Kod tersebut menjana schema yang secara automatik mencipta borang yang digunakan untuk menyimpan data.
2. Pengguna hanya perlu klik "Aktifkan penyimpanan borang" untuk menggunakannya.
3. Pemotongan gambar dikuasakan oleh react-cropper sumber terbuka (https://www.npmjs.com/package/react-cropper). Oleh sebab pemasangan kebergantungan NPM belum lagi disokong, pemuatan dinamik melalui CDN adalah satu-satunya pilihan.
