...
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Ya | Kredensial akses yang digunakan untuk memanggil API ini. Dapatkan dengan memanggil API [Dapatkan access token bagi aplikasi dalaman](/open/development/obtain-the-access-token-of-an-internal-app#). |
...
| objectStaffIds | Array of String | Tidak | Senarai nilai `userId` bagi pekerja yang hendak disembunyikan. Untuk mendapatkan `userId`, panggil [Dapatkan maklumat pengguna melalui kod log masuk senyap](/open/development/obtain-the-userid-of-a-user-by-using-the-log-free#).      Jumlah bilangan elemen merentasi `objectStaffIds`, `objectDeptIds`, dan `objectTagIds` tidak boleh melebihi 50. |
...
| objectTagIds | Array of Long | Tidak | Senarai nilai `roleId` bagi peranan yang hendak disembunyikan. Untuk mendapatkan `id`, panggil [Dapatkan senarai peranan](/open/development/obtains-a-list-of-enterprise-roles#).      Jumlah bilangan elemen merentasi `objectStaffIds`, `objectDeptIds`, dan `objectTagIds` tidak boleh melebihi 50. |
| excludeStaffIds | Array of String | Tidak | Senarai nilai `userId` bagi pekerja yang tidak terjejas oleh tetapan penyembunyian ini. Untuk mendapatkan `userId`, panggil [Dapatkan maklumat pengguna melalui kod log masuk senyap](/open/development/obtain-the-userid-of-a-user-by-using-the-log-free#).      Jumlah bilangan elemen merentasi `excludeStaffIds`, `excludeDeptIds`, dan `excludeTagIds` tidak boleh melebihi 50. |
...
| excludeTagIds | Array of Long | Tidak | Senarai ID peranan yang tidak terjejas oleh tetapan penyembunyian ini. Untuk mendapatkan `id`, panggil [Dapatkan senarai peranan](/open/development/obtains-a-list-of-enterprise-roles#).      Jumlah bilangan elemen merentasi `excludeStaffIds`, `excludeDeptIds`, dan `excludeTagIds` tidak boleh melebihi 50. |
...
Jika ralat dikembalikan apabila anda memanggil API ini, rujuk dokumen [Kod ralat global](/open/development/server-api-error-codes-1) untuk penyelesaiannya.
