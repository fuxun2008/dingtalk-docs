...
Langkah 1: Panggil API [Initialize a multipart upload object](/open/development/initialize-a-multipart-upload-object) untuk mendapatkan pengenal muat naik `uploadKey`.
...
Langkah 4: Gunakan `uploadKey` yang diperoleh dalam Langkah 1 untuk memanggil API [Serahkan fail](/open/development/submittal-file) untuk melengkapkan muat naik.
...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| unionId | String | Ya | unionId bagi pengendali. Panggil API [Dapatkan butiran pengguna](/open/development/query-user-details#) untuk mendapatkannya. |

### Isi permintaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| uploadKey | String | Ya | Pengenal muat naik yang unik. Panggil API [Mulakan objek muat naik multipart](/open/development/initialize-a-multipart-upload-object#) untuk mendapatkan `uploadKey`. |
