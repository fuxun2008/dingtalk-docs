...
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Ya | Kredensial akses yang digunakan untuk memanggil API ini. Dapatkan melalui API [Dapatkan access token aplikasi dalaman](/open/development/obtain-the-access-token-of-an-internal-app). |
...
| icon | String | Tidak | Gambar Profil kumpulan. Hantar mediaId, yang boleh diperoleh melalui API [Muat naik fail media](/open/development/upload-media-files). |
