---
title: "Dapatkan maklumat organisasi"
description: "Panggil API ini untuk mendapatkan maklumat storan organisasi DingTalk, seperti jumlah kapasiti storan dan ruang yang telah digunakan."
---

Panggil API ini untuk mendapatkan maklumat storan organisasi. Contohnya, ruang storan ialah 100 GB dan 953.5 MB telah digunakan.
...
| Kebenaran diperlukan | permission-Storage.Org.Read-Organization storage read permission |
...
| --- | --- | --- |
| org | Object | Maklumat organisasi. |
| corpId | String | ID Organisasi. |
| partitions | Array | Senarai maklumat kapasiti partition. |
| partitionType | String | Jenis partition.   - **PUBLIC_OSS_PARTITION**: Partition storan OSS Public Cloud. - **MINI_OSS_PARTITION**: Partition storan MiniOSS khusus. |
| quota | Object | Maklumat kapasiti. |
| used | Long | Kapasiti yang telah digunakan, dalam bait. |
| max | Long | Kapasiti maksimum, dalam bait. |
| reserved | Long | Kapasiti pra-peruntukan yang tinggal, dalam bait.      Anda boleh pra-memperuntukkan kapasiti kepada aplikasi atau ruang di Admin Console. Medan ini menunjukkan kapasiti pra-peruntukan yang tinggal, iaitu bahagian kapasiti pra-peruntukan yang belum digunakan. Jika tiada kapasiti pra-peruntukan dikonfigurasikan, medan ini kosong. |
| type | String | Jenis kapasiti.   - **SHARE**: Kapasiti organisasi yang dikongsi. - **PRIVATE**: Kapasiti khusus. |
...
| 403 | permissionDenied | %s | Pengguna tidak mempunyai kebenaran untuk mendapatkan maklumat organisasi. |
