...
Langkah 1: Panggil API [Dapatkan maklumat muat naik fail](/open/development/obtain-file-upload-informations) untuk mendapatkan maklumat yang diperlukan untuk memuat naik fail.
...
- Apabila jenis ruang storan ialah USER, semua pengguna dengan kebenaran ke atas ruang tersebut mempunyai hak operasi. Pekerja lain mesti memanggil API [Tambah kebenaran](/open/development/add-permissions-file) untuk memberi kebenaran.
- Apabila jenis ruang storan ialah APP, mana-mana operator mesti memanggil API [Tambah kebenaran](/open/development/add-permissions-file) untuk memberi kebenaran.
...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| uploadKey | String | Ya | Pengecam unik bagi fail yang hendak ditambah. Panggil API [Dapatkan maklumat muat naik fail](/open/development/obtain-file-upload-informations#) untuk mendapatkan nilai parameter uploadKey. |
...
Jika ralat dikembalikan semasa anda memanggil API ini, cari penyelesaian mengikut mesej ralat dalam dokumen [Kod ralat global](/open/development/server-api-error-codes-1).
