...
Langkah 3: Dapatkan kelayakan akses aplikasi dengan mengikut [Dapatkan access token aplikasi dalaman](/open/development/obtain-the-access-token-of-an-internal-app).
...
2. Berdasarkan `chatId`, panggil Server API [Tanya maklumat Sembang Kumpulan](/open/development/obtain-a-group-session) untuk mendapatkan maklumat Sembang Kumpulan.
3. Urus Sembang Kumpulan dengan menggunakan chatId-nya.

   - Berdasarkan `chatId`, panggil Server API baharu [Dapatkan OpenConversationId Sembang Kumpulan](/open/development/obtain-group-openconversationid) untuk mendapatkan `openConversationId`.
   ...
   - Berdasarkan `chatId`, panggil Server API [Lumpuhkan Sembang Peribadi](/open/development/set-private-chat) untuk mengawal sama ada Ahli kumpulan boleh bersembang secara peribadi.
   - Berdasarkan `chatId`, panggil Server API [Kemas kini nama panggilan kumpulan bagi ahli kumpulan](/open/development/set-a-group-nickname) untuk menetapkan nama panggilan ahli kumpulan.
   - Berdasarkan `chatId`, panggil Server API [Dapatkan pautan Kod QR sertai sembang](/open/development/obtain-a-qr-code-link). Pengguna lain dalam Organisasi Anda boleh mengklik pautan untuk memohon menyertai Sembang Kumpulan.
...
Selesaikan proses [Penciptaan dan konfigurasi aplikasi](/open/dingstart/create-application).
...
Berdasarkan client ID dan Client Secret yang diperoleh pada Langkah 1, dapatkan kelayakan akses aplikasi dengan mengikut [Dapatkan access token aplikasi dalaman](/open/development/obtain-the-access-token-of-an-internal-app).
