...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| spaceId | String | Ya | ID ruang. Panggil API [Add a space](/ms/open/development/add-space#) dan gunakan nilai parameter `id` yang dikembalikan. |

### Parameter pertanyaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| unionId | String | Ya | unionId pengendali. Panggil API [Query user details](/ms/open/development/query-user-details#) untuk mendapatkannya. |
...
Jika ralat berlaku semasa anda memanggil API ini, rujuk dokumen [Global error codes](/ms/open/development/server-api-error-codes-1) untuk penyelesaian berdasarkan mesej ralat.
