...
Prasyarat: Selesaikan aliran [Penciptaan dan konfigurasi aplikasi](/ms/open/dingstart/create-application).
...
1. Panggil Server API [Hantar Notifikasi Kerja](/ms/open/development/asynchronous-sending-of-enterprise-session-messages) untuk menghantar Notifikasi Kerja dan mendapatkan ID Tugas unik `task_id` bagi mesej tersebut.
2. Dengan ID Tugas unik `task_id`, panggil Server API [Dapatkan kemajuan penghantaran Notifikasi Kerja](/ms/open/development/obtain-the-sending-progress-of-asynchronous-sending-of-enterprise-session) untuk menyemak kemajuan penghantaran.
3. Dengan ID Tugas unik `task_id`, panggil Server API [Dapatkan hasil penghantaran Notifikasi Kerja](/ms/open/development/gets-the-result-of-sending-messages-asynchronously-to-the-enterprise) untuk melihat hasil penghantaran.
4. Dengan ID Tugas unik `task_id`, panggil Server API [Kemas kini bar status Notifikasi Kerja](/ms/open/development/update-work-notification-status-bar) untuk mengemas kini Notifikasi Kerja.
5. Dengan ID Tugas unik `task_id`, panggil Server API [Tarik Balik Notifikasi Kerja](/ms/open/development/notification-of-work-withdrawal) untuk menarik balik Notifikasi Kerja.

## Prasyarat

Selesaikan aliran [Penciptaan dan konfigurasi aplikasi](/ms/open/dingstart/create-application).
