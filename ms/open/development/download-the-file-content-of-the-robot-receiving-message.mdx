...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| downloadCode | String | Ya | Kod muat turun yang dikembalikan oleh bot kepada pembangun selepas pengguna menghantar mesej fail kepada bot. Untuk maklumat lanjut, lihat [Bot menerima mesej](/open/development/receive-message#). |
