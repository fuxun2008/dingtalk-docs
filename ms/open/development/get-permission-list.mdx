...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| dentryUuid | String | Ya | File uuid. Panggil API [Carian Fail](/open/development/search-for-files) atau API [Dapatkan maklumat dentryUuid](/open/development/api-getuuidbydentryid) untuk mendapatkan medan dentryUuid daripada respons. |

### Parameter kueri

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| unionId | String | Ya | unionId pengguna. Panggil API [Tanyakan butiran pengguna](/open/development/query-user-details) untuk mendapatkannya. |
...
Jika ralat berlaku semasa memanggil API ini, cari penyelesaiannya dalam dokumentasi [Kod ralat global](/open/development/server-api-error-codes-1) berdasarkan Mesej ralat.
