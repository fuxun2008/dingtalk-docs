...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| dentryUuid | String | Ya | UUID fail. Untuk mendapatkan nilai ini, panggil API [Carian Fail](/ms/open/development/search-for-files) atau API [Dapatkan dentryUuid](/ms/open/development/api-getuuidbydentryid), dan baca medan `dentryUuid` daripada respons. |
...
Jika ralat dikembalikan semasa anda memanggil API ini, rujuk dokumentasi [Kod ralat global](/ms/open/development/server-api-error-codes-1) untuk penyelesaian.
