...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| unionId | String | Ya | unionId pengendali. Panggil API [Semak butiran pengguna](/ms/open/development/query-user-details) untuk mendapatkannya. |
| roomId | String | Ya | ID Bilik. Panggil API [Semak senarai bilik mesyuarat](/ms/open/development/check-the-meeting-room-list) untuk mendapatkannya. |
...
| groupId | Long | Tidak | ID Kumpulan yang menjadi milik Bilik. Panggil API [Semak senarai Kumpulan bilik mesyuarat](/ms/open/development/query-meeting-rooms-groups) untuk mendapatkannya. |
...
Jika ralat dikembalikan semasa memanggil API ini, rujuk dokumen [Kod ralat global](/ms/open/development/server-api-error-codes-1) untuk penyelesaian.
