...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| dentryUuid | String | Ya | Uuid fail. Panggil API [Carian Fail](/open/development/search-for-files) atau API [Dapatkan maklumat dentryUuid](/open/development/api-getuuidbydentryid) untuk mendapatkan medan dentryUuid daripada parameter respons. |

### Parameter pertanyaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| unionId | String | Ya | UnionId pengguna. Panggil API [Pertanyaan butiran pengguna](/open/development/query-user-details) untuk mendapatkannya. |
