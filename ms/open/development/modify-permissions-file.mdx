---
title: "Kemas kini kebenaran"
description: "Panggil API ini untuk mengemas kini kebenaran fail bagi ahli mengikut uuid fail, rootNodeId atau nodeId Knowledge Base, unionId operator, dan role id."
---

Panggil API ini untuk mengemas kini kebenaran fail bagi pengguna kebenaran berdasarkan maklumat seperti ID yang ditentukan (uuid fail, rootNodeId Knowledge Base, atau nodeId nod Knowledge Base), unionId operator, dan ID peranan kebenaran.
...
| Keperluan kebenaran | permission-Storage.Permission.Write-Kebenaran Tulis untuk maklumat kebenaran storan organisasi |
...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| dentryUuid | String | Ya | Uuid fail. Panggil API [Carian Fail](/ms/open/development/search-for-files) atau API [Dapatkan maklumat dentryUuid](/ms/open/development/api-getuuidbydentryid) untuk mendapatkan medan dentryUuid daripada parameter respons. |

### Parameter pertanyaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| unionId | String | Ya | UnionId pengguna. Panggil API [Pertanyaan butiran pengguna](/ms/open/development/query-user-details) untuk mendapatkannya. |

### Isi permintaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| roleId | String | Ya | ID peranan. Nilai enum:   - **OWNER**: Pemilik, dengan skop kebenaran berikut:    - PermissionPrivilegeEnum.INFO   - PermissionPrivilegeEnum.LIST   - PermissionPrivilegeEnum.PREVIEW   - PermissionPrivilegeEnum.READ   - PermissionPrivilegeEnum.WRITE   - PermissionPrivilegeEnum.DOWNLOAD   - PermissionPrivilegeEnum.ADD   - PermissionPrivilegeEnum.DELETE   - PermissionPrivilegeEnum.MODIFY   - PermissionPrivilegeEnum.COPY   - PermissionPrivilegeEnum.RENAME   - PermissionPrivilegeEnum.READ_PERMISSION   - PermissionPrivilegeEnum.WRITE_PERMISSION   - PermissionPrivilegeEnum.ASSIGN - **MANAGER**: Pengurus, dengan skop kebenaran berikut:    - PermissionPrivilegeEnum.INFO   - PermissionPrivilegeEnum.LIST   - PermissionPrivilegeEnum.PREVIEW   - PermissionPrivilegeEnum.READ   - PermissionPrivilegeEnum.WRITE   - PermissionPrivilegeEnum.DOWNLOAD   - PermissionPrivilegeEnum.ADD   - PermissionPrivilegeEnum.DELETE   - PermissionPrivilegeEnum.MODIFY   - PermissionPrivilegeEnum.COPY   - PermissionPrivilegeEnum.RENAME   - PermissionPrivilegeEnum.READ_PERMISSION   - PermissionPrivilegeEnum.WRITE_PERMISSION - **EDITOR**: Editor, dengan skop kebenaran berikut:    - PermissionPrivilegeEnum.INFO   - PermissionPrivilegeEnum.LIST   - PermissionPrivilegeEnum.PREVIEW   - PermissionPrivilegeEnum.READ   - PermissionPrivilegeEnum.WRITE   - PermissionPrivilegeEnum.DOWNLOAD   - PermissionPrivilegeEnum.ADD - **DOWNLOADER**: Pemapar dan pemuat turun, dengan skop kebenaran berikut:    - PermissionPrivilegeEnum.INFO   - PermissionPrivilegeEnum.LIST   - PermissionPrivilegeEnum.PREVIEW   - PermissionPrivilegeEnum.READ   - PermissionPrivilegeEnum.DOWNLOAD - **READER**: Lihat sahaja, dengan skop kebenaran berikut:    - PermissionPrivilegeEnum.INFO   - PermissionPrivilegeEnum.LIST   - PermissionPrivilegeEnum.PREVIEW |
| members | Array | Ya | Senarai pengguna kebenaran. Saiz maksimum ialah 30. |
| type | String | Ya | Jenis pengguna kebenaran. Nilai enum:   - **ORG**: Organisasi - **DEPT**: Jabatan - **TAG**: Tag tersuai - **CONVERSATION**: Sembang - **USER**: Pengguna |
| id | String | Ya | ID pengguna kebenaran:   - Apabila `type=ORG`, id ialah ID organisasi. - Apabila `type=DEPT`, id ialah ID jabatan. - Apabila `type=TAG`, id ialah ID tag. - Apabila `type=CONVERSATION`, id ialah ID sembang. - Apabila `type=USER`, id ialah ID pekerja. |
| corpId | String | Tidak | Organisasi yang memiliki kebenaran ini.       - Jika ID organisasi diberikan, kebenaran akan dikosongkan secara automatik apabila ahli berkenaan keluar daripada organisasi. - Apabila memberType ialah dept, ID organisasi diperlukan. |
| option | Object | Tidak | Parameter pilihan. |
| duration | Long | Tidak | Tempoh sah, dalam saat.       - Buat masa ini, hanya Ruang yang OwnerType-nya APP menyokong kebenaran sementara. - Nilai maksimum ialah 3600. |
    ...
    public static void main(String[] args_) throws Exception {
        ...
        try {
            ...
            if (!com.aliyun.teautil.Common.empty(err.code) && !com.aliyun.teautil.Common.empty(err.message)) {
                // err mengandungi atribut code dan message, yang dapat membantu pembangun mengesan punca isu
            }
