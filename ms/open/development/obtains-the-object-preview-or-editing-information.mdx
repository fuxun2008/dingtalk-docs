...
| version | Long | Tidak | Nombor versi bagi fail yang ditentukan. Panggil API [Dapatkan senarai fail atau folder](/ms/open/development/get-a-list-of-files-or-folders) untuk mendapatkan nilai parameter id. |
...
Jika ralat dikembalikan semasa memanggil API ini, semak mesej ralat dalam dokumen [Kod ralat global](/ms/open/development/server-api-error-codes-1) untuk mencari penyelesaian.
