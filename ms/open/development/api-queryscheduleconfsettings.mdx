...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| scheduleConferenceId | String | Ya | ID mesyuarat berjadual. Dapatkan daripada medan `scheduleConferenceId` yang dikembalikan oleh API [Cipta mesyuarat berjadual](/open/development/create-appointment-meeting#). |
