---
title: "Dapatkan butiran item kitar semula"
description: "Panggil API ini untuk mendapatkan butiran item dalam Tong Sampah, termasuk ID Ruang asal, laluan, saiz, dan nama fail atau folder tersebut."
---

Panggil API ini untuk mendapatkan butiran item tertentu dalam Tong Sampah, termasuk ID Ruang tempat item tersebut asalnya berada, laluan asal, saiz, nama, dan maklumat lain.
...
| Keperluan kebenaran | permission-Storage.RecycleBin.Read-Kebenaran Baca untuk Tong Sampah storan Organisasi |
...
| recycleItemId | String | Ya | ID item kitar semula. Panggil API [Dapatkan senarai item kitar semula](/ms/open/development/gets-the-list-of-recycle-items#) untuk mendapatkan nilai parameter `id`. |
...
| --- | --- | --- |
| item | Object | Maklumat item kitar semula. |
| id | String | ID item kitar semula. |
| spaceId | String | ID Ruang tempat Fail atau Folder asal berada. |
| dentryId | String | ID Fail atau Folder asal. |
| size | Long | Saiz Fail atau Folder asal, dalam bait. |
...
| operatorId | String | unionId pengguna yang melakukan tindakan padam. |
| operatorTime | String | Masa pemadaman, dalam format ISO 8601. Contoh: 2022-07-29T14:55Z. |
...

{
  "item" : {
    ...
    "size" : 512,
    "type" : "FILE",
    "originalName" : "Folder Ujian",
    "originalPath" : "./Folder Ujian",
    "operatorId" : "chyxxxxx",
...
| 403 | permissionDenied | %s | Pengguna tidak mempunyai Kebenaran Lihat untuk Fail (atau Folder) asal item kitar semula |
