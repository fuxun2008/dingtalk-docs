...
| recycleItemId | String | Ya | ID item kitar semula. Panggil API [Dapatkan senarai item kitar semula](/open/development/gets-the-list-of-recycle-items#) untuk mendapatkan nilai parameter `id`. |
