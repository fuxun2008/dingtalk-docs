...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| conferenceId | String | Tidak | ID Mesyuarat. Panggil API [Create a Video Meeting](/ms/open/development/create-a-video-conference#) untuk mendapatkan nilai parameter conferenceId. |

### Parameter pertanyaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| unionId | String | Tidak | unionId bagi Pengguna. Panggil API [Query user details](/ms/open/development/query-user-details#) untuk mendapatkan nilai parameter unionid. |
...
Jika Ralat berlaku semasa memanggil API ini, cari penyelesaiannya dalam dokumen [Global error codes](/ms/open/development/server-api-error-codes-1) berdasarkan Mesej ralat.
