---
title: "Dapatkan dentryUuid"
description: "Panggil API ini untuk mendapatkan dentryUuid bagi sesuatu fail berdasarkan spaceId dan dentryId."
---

Mendapatkan dentryUuid bagi sesuatu fail berdasarkan spaceId dan dentryId.
...
| Kebenaran yang diperlukan | permission-Document.WorkspaceDocument.Read-Kebenaran membaca dokumen Knowledge Base |
...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| dentryId | String | Ya | ID fail semasa. |
...
| operatorId | String | Ya | unionId bagi pengendali. Panggil API [Dapatkan butiran pengguna](/ms/open/development/query-user-details) untuk mendapatkan nilai parameter unionid. |
    ...
    public static void main(String[] args_) throws Exception {
        ...
        try {
            ...
            if (!com.aliyun.teautil.Common.empty(err.code) && !com.aliyun.teautil.Common.empty(err.message)) {
                // err mengandungi atribut code dan message yang membantu mengesan isu ini
            }
...
| 403 | permissionDenied | The operator has no permission. | Pengguna semasa tidak mempunyai kebenaran untuk melaksanakan tindakan ini. |
