...
| operatorId | String | Ya | unionId bagi pengendali. Panggil API [Dapatkan butiran pengguna](/open/development/query-user-details) untuk mendapatkan nilai parameter unionid. |
