...
Langkah 2: Panggil API [Dapatkan maklumat muat naik fail multipart](/open/development/obtains-the-information-about-multipart-uploads-of-an-object) untuk mendapatkan maklumat muat naik bagi setiap bahagian.

Langkah 3: Muat naik setiap bahagian secara gelung (loop).

Langkah 4: Gunakan `uploadKey` yang diperoleh pada Langkah 1 untuk memanggil API [Commit File](/open/development/submittal-file) bagi menyelesaikan muat naik.
...
Jika ralat dikembalikan semasa anda memanggil API ini, cari mesej ralat dalam dokumen [Kod ralat global](/open/development/server-api-error-codes-1) untuk mendapatkan penyelesaian.
