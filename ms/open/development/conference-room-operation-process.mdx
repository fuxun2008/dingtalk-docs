...
Langkah 3: Dapatkan kredensial akses aplikasi dengan mengikuti [Dapatkan access token aplikasi dalaman](/ms/open/development/obtain-the-access-token-of-an-internal-app). Access token digunakan untuk mengesahkan pemanggil semasa memanggil API.

Langkah 4: Panggil API bilik mesyuarat:

1. Panggil Server API [Cipta bilik mesyuarat](/ms/open/development/create-a-meeting-room). Medan `result` yang dikembalikan oleh API ialah ID bilik mesyuarat.
2. Dengan ID bilik mesyuarat, panggil Server API [Kemas kini maklumat bilik mesyuarat](/ms/open/development/update-meeting-room-information) untuk mengemas kini maklumat bilik mesyuarat.
3. Panggil Server API [Tanya senarai bilik mesyuarat](/ms/open/development/check-the-meeting-room-list) untuk mendapatkan senarai bilik mesyuarat.
4. Dengan ID bilik mesyuarat, panggil Server API [Tanya butiran bilik mesyuarat](/ms/open/development/check-meeting-room-details) untuk mendapatkan butiran bilik mesyuarat tertentu.
5. Dengan ID bilik mesyuarat, panggil Server API [Padam bilik mesyuarat](/ms/open/development/delete-a-meeting-room) untuk memadam bilik mesyuarat.
...
Menggunakan client ID dan Client Secret daripada Langkah 1, dapatkan kredensial akses aplikasi dengan mengikuti [Dapatkan access token aplikasi dalaman](/ms/open/development/obtain-the-access-token-of-an-internal-app).
