...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| userIdList | Array of String | Ya | ID pengguna. Dapatkan nilai parameter userid dengan memanggil [Dapatkan ID pengguna menggunakan kod log masuk senyap](/open/development/obtain-the-userid-of-a-user-by-using-the-log-free#). |
...
Jika ralat dikembalikan semasa anda memanggil API ini, rujuk penyelesaian dalam dokumen [Kod ralat global](/open/development/server-api-error-codes-1) berdasarkan mesej ralat.
