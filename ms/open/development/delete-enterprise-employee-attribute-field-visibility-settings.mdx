...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| settingId | Long | Ya | ID tetapan. Dapatkan nilai parameter id dengan memanggil API [Tetapkan keterlihatan atribut pekerja](/open/development/add-or-update-the-hidden-settings-of-the-employee-property#). |
