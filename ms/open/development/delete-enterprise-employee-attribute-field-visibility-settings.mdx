---
title: "Padam tetapan keterlihatan atribut pekerja"
description: "Panggil API ini untuk memadam tetapan keterlihatan medan atribut pekerja perusahaan di DingTalk, lengkap dengan parameter permintaan dan medan respons."
---

Panggil API ini untuk memadam tetapan keterlihatan medan atribut pekerja.

## Penerangan panggilan API

Selepas organisasi memanggil API untuk menetapkan keterlihatan atribut pekerja, anda boleh memanggil API ini untuk memadam tetapan tersembunyi medan atribut pekerja.
...
| Medan | Nilai |
| --- | --- |
| URL HTTP | `https://api.dingtalk.io/v1.0/contact/staffAttributes/visibilitySettings/{settingId}` |
| Kaedah HTTP | DELETE |
...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| settingId | Long | Ya | ID tetapan. Dapatkan nilai parameter id dengan memanggil API [Tetapkan keterlihatan atribut pekerja](/ms/open/development/add-or-update-the-hidden-settings-of-the-employee-property#). |
...
| --- | --- | --- |
| result | Boolean | Sama ada pemadaman berjaya. true menunjukkan berjaya. |
...
| --- | --- | --- | --- |
| 400 | parameter.error | Parameter error | Parameter settingId tidak sah |
