...
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Ya | Kredensial akses untuk memanggil API ini. Untuk mendapatkannya, panggil API [Dapatkan access token bagi aplikasi dalaman](/open/development/obtain-the-access-token-of-an-internal-app). |

## Parameter body

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| openConversationId | String | Ya | ID kumpulan terbuka (open group ID). Untuk mendapatkan nilai `openConversationId`, panggil API [Cipta sembang kumpulan](/open/development/create-common-group-new-version-v2). |
| userIds | Array of String | Ya | Senarai nilai `userid` pekerja dalam organisasi. Untuk mendapatkan nilai `userid_list`, panggil API [Tanya senarai ID pengguna jabatan](/open/development/query-the-list-of-department-userids). |
