...
Prasyarat: Lengkapkan aliran [Cipta dan konfigurasikan aplikasi](/ms/open/dingstart/create-application).
...
Langkah 3: Dapatkan kredensial akses aplikasi [Dapatkan access token bagi aplikasi dalaman](/ms/open/development/obtain-the-access-token-of-an-internal-app). Semasa memanggil API, gunakan access token untuk mengesahkan pemanggil.

Langkah 4: Panggil Server API untuk Kalendar:

1. Panggil Server API [Acara Baharu](/ms/open/development/create-schedule) untuk mencipta satu acara. Dapatkan `id` acara.
2. Berdasarkan `id` acara, panggil Server API [Ubah suai acara](/ms/open/development/modify-event) untuk mengubah suai maklumat acara.
3. Berdasarkan `id` acara, panggil Server API [Tanya butiran tentang satu acara](/ms/open/development/query-details-about-an-event) untuk mendapatkan butiran acara.
4. Berdasarkan `id` acara, panggil Server API [Padam Acara](/ms/open/development/delete-event) untuk memadam acara yang telah dicipta.

## Prasyarat

Lengkapkan aliran [Cipta dan konfigurasikan aplikasi](/ms/open/dingstart/create-application).
...
Gunakan client ID dan Client Secret daripada Langkah 1 untuk mendapatkan [access_token bagi aplikasi dalaman](/ms/open/development/obtain-orgapp-token).
