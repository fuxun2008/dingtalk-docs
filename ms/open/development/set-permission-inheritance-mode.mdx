...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| dentryUuid | String | Ya | UUID fail. Dapatkan nilai parameter respons `dentryUuid` dengan memanggil API [Carian Fail](/open/development/search-for-files) atau [Dapatkan maklumat dentryUuid](/open/development/api-getuuidbydentryid). |

### Parameter pertanyaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| unionId | String | Ya | unionId pengguna. Dapatkan nilai parameter unionid dengan memanggil API [Tanya butiran pengguna](/open/development/query-user-details). |
