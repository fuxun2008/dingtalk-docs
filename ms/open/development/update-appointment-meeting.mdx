...
| scheduleConferenceId | String | Ya | ID mesyuarat yang ditempah. Perolehnya daripada medan `scheduleConferenceId` yang dikembalikan oleh API [Cipta mesyuarat yang ditempah](/open/development/create-appointment-meeting#). |
