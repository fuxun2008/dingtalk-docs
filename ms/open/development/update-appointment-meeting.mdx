---
title: "Kemas kini mesyuarat yang ditempah"
description: "Panggil API ini untuk mengemas kini mesyuarat yang ditempah dalam DingTalk, termasuk tajuk serta masa mula dan tamat mesyuarat."
---

Kemas kini tajuk, masa mula, masa tamat, dan maklumat lain bagi mesyuarat yang ditempah.
...
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Ya | Kredensial akses yang digunakan untuk memanggil API ini. Perolehnya seperti berikut:   - Untuk aplikasi dalaman, panggil API [Peroleh access token aplikasi dalaman](/ms/open/development/obtain-the-access-token-of-an-internal-app#). - Untuk aplikasi perusahaan pihak ketiga, panggil API [Peroleh access token perusahaan yang diberi kuasa](https://open.dingtalk.com/document/development/obtain-the-access-token-of-the-authorized-enterprise-1#). |

### Isi permintaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| creatorUnionId | String | Ya | unionId pencipta mesyuarat yang ditempah. |
| scheduleConferenceId | String | Ya | ID mesyuarat yang ditempah. Perolehnya daripada medan `scheduleConferenceId` yang dikembalikan oleh API [Cipta mesyuarat yang ditempah](/ms/open/development/create-appointment-meeting#). |
| title | String | Ya | Tajuk mesyuarat yang ditempah. Panjang maksimum ialah 50 aksara. |
| startTime | Long | Ya | Masa mula mesyuarat yang ditempah, sebagai cap masa UTC dalam milisaat. |
| endTime | Long | Ya | Masa tamat mesyuarat yang ditempah, sebagai cap masa UTC dalam milisaat. |
...

{
  ...
  "title" : "Tajuk mesyuarat yang ditempah",
