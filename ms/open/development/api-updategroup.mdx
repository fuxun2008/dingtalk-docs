...
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Wajib | Kredensial akses untuk memanggil API ini. Dapatkan melalui API [Dapatkan access token aplikasi dalaman](/open/development/obtain-the-access-token-of-an-internal-app). |

### Isi permintaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| chatid | String | Wajib | ID sembang kumpulan. Dapatkan daripada parameter chatid yang dikembalikan oleh API [Cipta sembang kumpulan](/open/development/create-common-group-new-version-v2).  chatid yang diperoleh melalui pemanggilan JSAPI bahagian hadapan tidak disokong. |
| name | String | Tidak wajib | Nama kumpulan. Panjang: 1 hingga 20 aksara. |
| owner | String | Tidak wajib | userId pemilik kumpulan. Dapatkan userId melalui API [Tanya pengguna mengikut nombor telefon](/open/development/query-users-by-phone-number).  Pengguna mestilah salah seorang ahli dalam useridlist sembang tersebut. |
...
| add_extidlist | Array of String | Tidak wajib | Senarai unionId. Dapatkan melalui API [Tanya butiran pengguna](/open/development/query-users-by-phone-number). |
| del_extidlist | Array of String | Tidak wajib | Senarai unionId. Dapatkan melalui API [Tanya butiran pengguna](/open/development/query-users-by-phone-number). |
| icon | String | Tidak wajib | mediaId Gambar Profil kumpulan. Dapatkan parameter media_id melalui API [Muat naik fail media](/open/development/upload-media-files). |
