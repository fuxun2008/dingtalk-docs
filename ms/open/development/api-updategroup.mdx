---
title: "Kemas kini sembang kumpulan"
description: "Panggil API ini untuk mengemas kini maklumat asas dan ahli sembang kumpulan yang ditentukan mengikut chatid, termasuk nama kumpulan, pemilik kumpulan, senarai ahli dan avatar kumpulan."
---

Panggil API ini untuk mengemas kini maklumat asas dan ahli sembang kumpulan yang ditentukan mengikut chatid. Gunakannya untuk mengubah suai maklumat berkaitan kumpulan, termasuk nama kumpulan, pemilik kumpulan, senarai ahli dan Gambar Profil kumpulan. Ia digunakan dalam senario seperti Admin kumpulan mengubah suai Tetapan kumpulan atau menyesuaikan Ahli kumpulan.
...
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Wajib | Kredensial akses untuk memanggil API ini. Dapatkan melalui API [Dapatkan access token aplikasi dalaman](/ms/open/development/obtain-the-access-token-of-an-internal-app). |

### Isi permintaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| chatid | String | Wajib | ID sembang kumpulan. Dapatkan daripada parameter chatid yang dikembalikan oleh API [Cipta sembang kumpulan](/ms/open/development/create-common-group-new-version-v2).  chatid yang diperoleh melalui pemanggilan JSAPI bahagian hadapan tidak disokong. |
| name | String | Tidak wajib | Nama kumpulan. Panjang: 1 hingga 20 aksara. |
| owner | String | Tidak wajib | userId pemilik kumpulan. Dapatkan userId melalui API [Tanya pengguna mengikut nombor telefon](/ms/open/development/query-users-by-phone-number).  Pengguna mestilah salah seorang ahli dalam useridlist sembang tersebut. |
| ownerType | String | Tidak wajib | Jenis pemilik kumpulan.   - **emp**: Pekerja organisasi - **ext**: Kenalan luaran |
| add_useridlist | Array of String | Tidak wajib | Senarai userId. |
| del_useridlist | Array of String | Tidak wajib | Senarai userId. |
| add_extidlist | Array of String | Tidak wajib | Senarai unionId. Dapatkan melalui API [Tanya butiran pengguna](/ms/open/development/query-users-by-phone-number). |
| del_extidlist | Array of String | Tidak wajib | Senarai unionId. Dapatkan melalui API [Tanya butiran pengguna](/ms/open/development/query-users-by-phone-number). |
| icon | String | Tidak wajib | mediaId Gambar Profil kumpulan. Dapatkan parameter media_id melalui API [Muat naik fail media](/ms/open/development/upload-media-files). |
| managementOptions | Object | Tidak wajib | Atribut kumpulan. |
| mentionAllAuthority | Integer | Tidak wajib | Skop penggunaan @all.   - **0** (Lalai): Semua ahli boleh menggunakan @all. - **1**: Hanya pemilik kumpulan boleh menggunakan @all. |
| showHistoryType | Integer | Tidak wajib | Sama ada ahli baharu boleh melihat 100 sembang lepas yang terkini.   - **1**: Dibenarkan. - **0**: Tidak dibenarkan.   Jika tidak dinyatakan, ahli baharu tidak boleh melihat sembang lepas. |
| validationType | Integer | Tidak wajib | Sama ada pengesahan diperlukan untuk menyertai kumpulan.   - **0** (Lalai): Tiada pengesahan. - **1**: Pengesahan diperlukan. |
| searchable | Integer | Tidak wajib | Sama ada kumpulan boleh dicari.   - 0 (Lalai): Tidak boleh dicari. - 1: Boleh dicari. |
| chatBannedType | Integer | Tidak wajib | Sama ada mengaktifkan Bisukan ahli untuk kumpulan.   - **0** (Lalai): Tidak dibisukan. - **1**: Bisukan Semua. |
| managementType | Integer | Tidak wajib | Jenis pengurusan kumpulan.   - **0** (Lalai): Semua ahli boleh menguruskan. - **1**: Hanya pemilik kumpulan boleh menguruskan. |
...
public class Sample {
    ...
    /**
     * <b>penerangan</b> :
     * <p>Memulakan Client akaun dengan Token</p>
     * @return Client
     * 
     * @throws Exception
     */
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkim_1_0.models.UpdateGroupRequest updateGroupRequest = new com.aliyun.dingtalkim_1_0.models.UpdateGroupRequest()
                .setChatid("chatxxxx")
                .setName("Sembang Seluruh Kakitangan.")
        ...
        try {
            ...
            if (!com.aliyun.teautil.Common.empty(err.code) && !com.aliyun.teautil.Common.empty(err.message)) {
                // err mengandungi atribut code dan message, yang membantu mengesan punca isu semasa pembangunan
            }
...
func _main (args []*string) (_err error) {
  ...
  updateGroupRequest := &dingtalkim_1_0.UpdateGroupRequest{
    ...
    Name: tea.String("Sembang Seluruh Kakitangan."),
...
namespace AlibabaCloud.SDK.Sample
{
    public class Sample 
    {
        ...
        /// <description>
        /// <para>Memulakan Client akaun dengan Token</para>
        /// </description>
        /// 
        /// <returns>
        /// Client
...
| --- | --- | --- | --- |
| 400 | parameter.invalid | Parameter input tidak sah | Masukkan parameter wajib seperti yang ditetapkan oleh API. |
| 400 | permession.checkFailed | Semakan kebenaran gagal | Semakan kebenaran gagal. |
| 400 | permession.checkFailed | Pemilik kumpulan tidak berada dalam skop keterlihatan aplikasi | Pemilik kumpulan tidak berada dalam skop keterlihatan aplikasi. |
| 500 | system.error | Cuba Lagi. Jika isu berterusan, hantar tiket. | Cuba Lagi. Jika isu berterusan, hantar tiket. |
