...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| dentryUuid | String | Ya | UUID fail. Panggil API [Carian Fail](/ms/open/development/search-for-files) atau API [Dapatkan maklumat dentryUuid](/ms/open/development/api-getuuidbydentryid) untuk mendapatkan nilai parameter respons `dentryUuid`. |
