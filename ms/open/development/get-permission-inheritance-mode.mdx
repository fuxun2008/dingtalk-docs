...
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Ya | Kredensial akses yang digunakan untuk memanggil API ini. Untuk mendapatkannya, panggil API [Dapatkan access token bagi aplikasi dalaman](/open/development/obtain-the-access-token-of-an-internal-app). |

### Parameter laluan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| dentryUuid | String | Ya | UUID fail. Untuk mendapatkannya, panggil API [Carian Fail](/open/development/search-for-files) atau [Dapatkan maklumat dentryUuid](/open/development/api-getuuidbydentryid) dan ambil nilai medan `dentryUuid` daripada respons. |

### Parameter pertanyaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| unionId | String | Ya | unionId pengguna. Untuk mendapatkannya, panggil API [Semak maklumat terperinci pengguna](/open/development/query-user-details) dan ambil nilai parameter unionid. |
...
Jika berlaku ralat semasa anda memanggil API ini, semak penyelesaian dalam dokumen [Kod ralat global](/open/development/server-api-error-codes-1) berdasarkan mesej ralat.
