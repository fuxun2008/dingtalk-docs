...
Jika ralat dikembalikan semasa memanggil API ini, rujuk dokumen [Global error codes](/ms/open/development/server-api-error-codes-1) untuk penyelesaian berdasarkan mesej ralat.
