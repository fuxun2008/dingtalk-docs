...
Langkah 3: Dapatkan kredensial akses aplikasi dengan mengikuti [Dapatkan access token aplikasi dalaman](/open/development/obtain-the-access-token-of-an-internal-app). Semasa memanggil API, access token digunakan untuk mengesahkan identiti pemanggil.

Langkah 4: Panggil API bilik mesyuarat:

1. Panggil Server API [Cipta kumpulan bilik mesyuarat](/open/development/create-meeting-room-groups) dan dapatkan medan `result` daripada Respons, iaitu ID kumpulan bilik mesyuarat.
2. Gunakan ID kumpulan bilik mesyuarat untuk memanggil Server API [Kemas kini kumpulan bilik mesyuarat](/open/development/update-meeting-room-groups) bagi mengemas kini maklumat kumpulan bilik mesyuarat.
3. Panggil Server API [Tanya senarai kumpulan bilik mesyuarat](/open/development/query-meeting-rooms-groups) untuk mendapatkan senarai kumpulan bilik mesyuarat.
4. Gunakan ID kumpulan bilik mesyuarat untuk memanggil Server API [Tanya kumpulan bilik mesyuarat](/open/development/query-meeting-room-groups) bagi mendapatkan maklumat terperinci tentang satu kumpulan bilik mesyuarat.
5. Gunakan ID kumpulan bilik mesyuarat untuk memanggil Server API [Padam kumpulan bilik mesyuarat](/open/development/delete-a-conference-room-group) bagi memadam kumpulan bilik mesyuarat.
...
Gunakan client ID dan Client Secret yang diperoleh dalam Langkah 1 untuk mendapatkan access token Aplikasi dengan mengikuti [Dapatkan access token aplikasi dalaman](/open/development/obtain-the-access-token-of-an-internal-app).
