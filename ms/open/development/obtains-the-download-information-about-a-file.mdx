...
<Note>
Jika fail terlalu besar dan anda perlu mendapatkannya secara berperingkat, tambah medan headers dalam contoh di atas: `headers.put("Range","bytes=0-499");`. Untuk maklumat lanjut, lihat [Muat turun sebahagian kandungan dengan menentukan Range](/open/development/use-range-download-a-part-of-content).
</Note>
...
| dentryId | String | Ya | ID fail. Panggil API [Dapatkan senarai fail atau folder](/open/development/get-a-list-of-files-or-folders#) atau API [Dapatkan spaceId melalui dentryUuid](/open/development/api-getdentryidbyuuid#) untuk mendapatkan nilai parameter id. |

### Parameter pertanyaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| unionId | String | Ya | unionId bagi operator. Panggil API [Pertanyaan butiran pengguna](/open/development/query-user-details#) untuk mendapatkannya. |
...
| version | Long | Tidak | Nombor versi fail. Panggil API [Dapatkan senarai versi fail](/open/development/obtains-a-list-of-file-versions#) untuk mendapatkan versi. |
...
Jika ralat dikembalikan apabila anda memanggil API ini, cari penyelesaian berdasarkan mesej ralat dalam dokumen [Kod ralat global](/open/development/server-api-error-codes-1).
