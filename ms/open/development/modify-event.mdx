...
- Untuk menambah atau mengeluarkan peserta acara, gunakan API [Tambah peserta acara](/open/development/add-schedule-participant#) dan [Keluarkan peserta acara](/open/development/delete-schedule-participant#).
