...
Jika ralat dikembalikan semasa anda memanggil API ini, semak penyelesaiannya dalam dokumen [Kod ralat global](/ms/open/development/server-api-error-codes-1) berdasarkan mesej ralat tersebut.
