...
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Yes | Kredensial akses untuk memanggil API ini. Panggil API [Get the access token of an internal app](/open/development/obtain-the-access-token-of-an-internal-app) untuk mendapatkannya. |

### Parameter laluan

| Name | Type | Required | Description |
| --- | --- | --- | --- |
| workbookId | String | Yes | ID Fail Spreadsheet. `nodeId(dentryUuid)` yang dikembalikan oleh [Knowledge Base API](/open/development/knowledge-base-overview) ialah `workbookId` Spreadsheet tersebut. Panggil API [Get node](https://open.dingtalk.com/document/development/get-node) atau [Create Knowledge Base document](/open/development/create-team-space-document) untuk mendapatkannya. |
| sheetId | String | Yes | ID atau tajuk Helaian Kerja. Panggil API [Get all worksheets](/open/development/obtain-all-worksheets) untuk mendapatkan ID dan tajuk Helaian Kerja. |

### Parameter pertanyaan

| Name | Type | Required | Description |
| --- | --- | --- | --- |
| operatorId | String | Yes | unionId pengendali. Panggil API [Query user details](/open/development/query-user-details) untuk mendapatkannya. Jika pengendali tidak mempunyai kebenaran, API akan mengembalikan ralat `The operator has no permission`. |
...
Jika ralat berlaku semasa memanggil API ini, cari Mesej ralat dalam dokumentasi [Global error codes](/open/development/server-api-error-codes-1) untuk mendapatkan penyelesaian.
