...
Langkah 3: Panggil API [Hantar fail](/open/development/submittal-file) untuk melengkapkan muat naik fail.

### Penerangan

- Apabila jenis ruang storan ialah USER, pengguna yang mempunyai kebenaran ke atas ruang tersebut mempunyai kebenaran tindakan. Pekerja lain perlu memanggil API [Tambah kebenaran](/open/development/add-permissions-file) untuk kebenaran akses.
- Apabila jenis ruang storan ialah APP, sesiapa yang melakukan tindakan perlu memanggil API [Tambah kebenaran](/open/development/add-permissions-file) untuk kebenaran akses.
...
Jika ralat berlaku semasa memanggil API ini, cari mesej ralat dalam dokumen [Kod ralat global](/open/development/server-api-error-codes-1) untuk penyelesaian.
