...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| spaceId | String | Ya | ID ruang. Dapatkan nilai parameter `id` dengan memanggil API [Tambah ruang](/ms/open/development/add-space). |

## Parameter query

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| unionId | String | Ya | unionId pengendali. Dapatkan dengan memanggil API [Semak butiran pengguna](/ms/open/development/query-user-details). |
