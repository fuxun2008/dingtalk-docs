...
| Nama | Jenis | Wajib | Keterangan |
| --- | --- | --- | --- |
| unionId | String | Ya | Pengecal unik bagi seorang Pekerja dalam skop Akaun Syarikat pembangun semasa. Panggil API [Tanya butiran pengguna](/open/development/query-user-details#) untuk mendapatkan nilai parameter unionid. |
