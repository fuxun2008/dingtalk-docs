...
<Note>
Jika fail terlalu besar dan anda perlu mendapatkan sumber secara berperingkat, tambah pengepala berikut dalam contoh di atas: `headers.put("Range","bytes=0-499");`. Untuk butiran, lihat [Muat turun sebahagian kandungan dengan menentukan Range](/open/development/use-range-download-a-part-of-content).
</Note>
...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| spaceId | String | Ya | ID ruang. Panggil API [Dapatkan senarai nod](/open/development/get-node-list) untuk mendapatkan `dentryUuid` bagi nod Knowledge Base, kemudian panggil API [Dapatkan spaceId melalui dentryUuid](/open/development/api-getdentryidbyuuid) untuk mendapatkan `spaceId`. |
| dentryId | String | Ya | ID fail. Panggil API [Dapatkan senarai nod](/open/development/get-node-list) untuk mendapatkan `dentryUuid` bagi nod Knowledge Base, kemudian panggil API [Dapatkan spaceId melalui dentryUuid](/open/development/api-getdentryidbyuuid) untuk mendapatkan `dentryId`. |

### Parameter pertanyaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| unionId | String | Ya | unionId bagi pengendali. Dapatkan dengan memanggil API [Pertanyaan butiran pengguna](/open/development/query-user-details). |
...
| version | Long | Tidak | Versi Fail. Dapatkan dengan memanggil API [Dapatkan senarai versi fail](/open/development/obtains-a-list-of-file-versions). |
...
Jika ralat dikembalikan semasa memanggil API ini, dapatkan penyelesaian berdasarkan Mesej ralat dalam dokumen [Kod ralat global](/open/development/server-api-error-codes-1).
