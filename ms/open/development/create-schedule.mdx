...
- Untuk menambah atau membuang peserta acara, kami syorkan menggunakan API [Add event attendee](/open/development/add-schedule-participant#) dan [Remove event attendee](/open/development/delete-schedule-participant#).
...
Jika ralat berlaku semasa memanggil API ini, rujuk dokumen [Global error codes](/open/development/server-api-error-codes-1) untuk mencari penyelesaian berdasarkan Mesej ralat.
