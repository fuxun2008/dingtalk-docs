...
| logo | String | Tidak | Logo templat. Panggil API [Muat naik fail media](/open/development/upload-media-files#) untuk mendapatkan mediaId selepas memuat naik imej. Saiz imej: 240\*240. Saiz setiap imej tidak boleh melebihi 1 MB. |
...
| bgImgList | Array of String | Tidak | mediaId imej. Panggil API [Muat naik fail media](/open/development/upload-media-files#) untuk mendapatkannya. Anda boleh memuat naik sehingga 9 imej, dan saiz setiap imej tidak boleh melebihi 5 MB. |
...
| groupIds | Array of Long | Tidak | ID kumpulan. Panggil API [Tanya senarai kumpulan bilik mesyuarat](/open/development/query-meeting-rooms-groups#) untuk mendapatkannya. |
| roomIds | Array of String | Tidak | ID bilik. Panggil API [Tanya senarai bilik mesyuarat](/open/development/check-the-meeting-room-list#) untuk mendapatkannya. |
