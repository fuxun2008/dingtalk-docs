---
title: "Cipta templat skrin tersuai"
description: "Panggil API ini untuk mencipta templat skrin tersuai dengan menentukan nama templat, digunakan untuk memperibadikan kandungan yang dipaparkan pada skrin peranti."
---

Panggil API ini untuk mencipta templat skrin tersuai berdasarkan nama templat.
...
| Kebenaran diperlukan | permission-Rooms.DeviceTemplate.Write-Kebenaran tulis untuk skrin tersuai Bilik Mesyuarat DingTalk |

### Header permintaan

| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Ya | Kelayakan API. Panggil API [Dapatkan token pengguna](/ms/open/development/obtain-user-token#) untuk mendapatkannya. Apabila membina pautan untuk mendapatkan parameter `code` yang digunakan dalam permintaan untuk mendapatkan token pengguna, `scope` mesti merangkumi kedua-dua ID pengguna dan ID organisasi, iaitu `scope=openid corpid`. |
...
| logo | String | Tidak | Logo templat. Panggil API [Muat naik fail media](/ms/open/development/upload-media-files#) untuk mendapatkan mediaId selepas memuat naik imej. Saiz imej: 240\*240. Saiz setiap imej tidak boleh melebihi 1 MB. |
| orgName | String | Tidak | Nama organisasi yang dipaparkan pada templat. |
| customDoc | String | Tidak | Kandungan teks tersuai templat. |
| bgUrl | String | Tidak | URL latar belakang tersuai templat. |
| bgImgList | Array of String | Tidak | mediaId imej. Panggil API [Muat naik fail media](/ms/open/development/upload-media-files#) untuk mendapatkannya. Anda boleh memuat naik sehingga 9 imej, dan saiz setiap imej tidak boleh melebihi 5 MB. |
| instruction | Boolean | Tidak | Sama ada hendak memaparkan arahan:   - **true**: Papar - **false**: Jangan papar |
| bgType | Integer | Tidak | Jenis latar belakang tersuai templat:   - **1**: Imej - **2**: URL |
| isPicTop | Integer | Tidak | Sama ada hendak memaparkan bar maklumat Laman Utama:   - **0**: Papar - **1**: Jangan papar |
| hideServerCodeWhenProjecting | Boolean | Tidak | Sama ada hendak menyembunyikan kod tuang semasa penuangan skrin:   - **true**: Sembunyi - **false**: Jangan sembunyi |
| showCalendarTitle | Boolean | Tidak | Sama ada hendak memaparkan tajuk acara pada kad acara:   - **true**: Papar - **false**: Jangan papar |
| desensitizeUserName | Boolean | Tidak | Sama ada hendak menyamarkan nama penempah pada kad acara:   - **true**: Samarkan - **false**: Jangan samarkan |
| picturePlayInterval | Integer | Tidak | Selang masa karusel imej latar belakang tersuai, dalam saat. |
| showCalendarCard | Boolean | Tidak | Sama ada hendak memaparkan kad acara:   - **true**: Papar - **false**: Jangan papar |
| showFunctionCard | Boolean | Tidak | Sama ada hendak memaparkan kad fungsi:   - **true**: Papar - **false**: Jangan papar |
| deviceUnionIds | Array of String | Tidak | unionId peranti. Dapatkan parameter ini dengan melanggan peristiwa [Perubahan pengikatan peranti-bilik](https://open.dingtalk.com/document/development/org-event-overview#). |
| groupIds | Array of Long | Tidak | ID kumpulan. Panggil API [Tanya senarai kumpulan bilik mesyuarat](/ms/open/development/query-meeting-rooms-groups#) untuk mendapatkannya. |
| roomIds | Array of String | Tidak | ID bilik. Panggil API [Tanya senarai bilik mesyuarat](/ms/open/development/check-the-meeting-room-list#) untuk mendapatkannya. |
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkrooms_1_0.models.CreateDeviceCustomTemplateRequest createDeviceCustomTemplateRequest = new com.aliyun.dingtalkrooms_1_0.models.CreateDeviceCustomTemplateRequest()
                .setTemplateName("Templat ujian")
                .setLogo("$iwElAqNwbmcDBgTRAMgxxxx8FAgACattZWV0aW5nUm9vbQoAC9EYzg")
                .setOrgName("Perusahaan ujian")
                .setCustomDoc("Teks ujian")
...
class Sample:
    ...
    def main(
        ...
        create_device_custom_template_request = dingtalkrooms__1__0_models.CreateDeviceCustomTemplateRequest(
            template_name='Templat ujian',
            logo='$iwElAqNwbmcDBgTRAMgxxxx8FAgACattZWV0aW5nUm9vbQoAC9EYzg',
            org_name='Perusahaan ujian',
            custom_doc='Teks ujian',
...
func _main (args []*string) (_err error) {
  ...
  createDeviceCustomTemplateRequest := &dingtalkrooms_1_0.CreateDeviceCustomTemplateRequest{
    TemplateName: tea.String("Templat ujian"),
    Logo: tea.String("$iwElAqNwbmcDBgTRAMgxxxx8FAgACattZWV0aW5nUm9vbQoAC9EYzg"),
    OrgName: tea.String("Perusahaan ujian"),
    CustomDoc: tea.String("Teks ujian"),
