...
| Nama | Jenis | Wajib | Penerangan |
| --- | --- | --- | --- |
| operatorId | String | Ya | unionId bagi operator. Dapatkan dengan salah satu cara berikut:   - Panggil API [Pertanyaan butiran pengguna](/open/development/query-user-details#). - Panggil API [Dapatkan ID pengguna menggunakan kod log masuk senyap](/open/development/obtain-the-userid-of-a-user-by-using-the-log-free#). |
...
Jika ralat berlaku semasa memanggil API ini, cari penyelesaian dalam dokumentasi [Kod ralat global](/open/development/server-api-error-codes-1) berdasarkan mesej ralat.
