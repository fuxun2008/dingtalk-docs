...
<div style={{display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap', margin: '16px 0'}}>
  <img src="https://img.alicdn.com/imgextra/i1/O1CN01i1pTkxhqNnB0t0rj_!!6000000004726-2-tps-437-934.png" alt="Detail fitur identifikasi Error absensi foto" style={{width: '48%', minWidth: '240px', borderRadius: '8px', boxShadow: '0 2px 12px rgba(0,0,0,0.08)', margin: 0}} />
  <img src="https://img.alicdn.com/imgextra/i3/O1CN01R2rNto6x85I1p32y_!!6000000001005-2-tps-898-1882.png" alt="Kanban ringkasan data kualitas foto" style={{width: '48%', minWidth: '240px', borderRadius: '8px', boxShadow: '0 2px 12px rgba(0,0,0,0.08)', margin: 0}} />
</div>
