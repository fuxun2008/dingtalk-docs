---
title: "Menghapus data dalam rentang sel"
description: "Panggil API DingTalk Spreadsheet ini untuk menghapus data dalam rentang sel tanpa mengubah format yang ada — solusi cepat membersihkan konten sel via server API."
---

Panggil API ini untuk menghapus data dalam rentang sel, tanpa menghapus format.
...
| sheetId | String | Ya | ID atau judul lembar kerja.   - Untuk aplikasi internal, panggil API [Memperoleh semua lembar kerja](/id/open/development/obtain-all-worksheets#) untuk mendapatkan ID, atau berikan judul lembar kerja. - Untuk aplikasi perusahaan pihak ketiga, berikan judul lembar kerja.   Lihat gambar di bawah untuk cara melihat judul lembar kerja. |
| rangeAddress | String | Ya | Rentang sel yang akan dihapus, dalam format `sel kiri atas rentang:sel kanan bawah rentang`.  Misalnya, B2:C3 mewakili rentang yang ditunjukkan pada gambar di bawah. |

### Parameter query

| Nama | Tipe | Wajib | Deskripsi |
| --- | --- | --- | --- |
| operatorId | String | Ya | unionId dari operator. Panggil API [Kueri detail pengguna](/id/open/development/query-user-details#) untuk mendapatkannya. |
