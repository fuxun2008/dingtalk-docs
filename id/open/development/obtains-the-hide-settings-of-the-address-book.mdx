---
title: "Mendapatkan pengaturan penyembunyian Kontak"
description: "Panggil API DingTalk ini untuk mendapatkan pengaturan penyembunyian Kontak secara massal dan mengelola konfigurasi visibilitas Kontak Organisasi dengan mudah."
---

Panggil API ini untuk mengambil daftar pengaturan penyembunyian Kontak secara berhalaman.
...
| Izin | permission-Contact.Visibility.ReadWrite-Contacts data visibility management permission |
...
| Nama | Tipe | Wajib | Deskripsi |
| --- | --- | --- | --- |
| nextToken | Long | Tidak | Cursor pagination.   - Untuk panggilan pertama, atur parameter ini ke 0. - Untuk panggilan berikutnya, kirimkan nilai nextToken yang dikembalikan oleh panggilan sebelumnya. |
| maxResults | Integer | Tidak | Ukuran halaman. Nilai maksimum: 100. |
...
| Nama | Tipe | Deskripsi |
| --- | --- | --- |
| hasMore | Boolean | Menunjukkan apakah masih ada data lainnya.   - true: Ya - false: Tidak |
| nextToken | Long | Cursor untuk halaman berikutnya. String kosong menandakan akhir pagination. |
| list | Array | Daftar pengaturan penyembunyian Kontak. |
| name | String | Nama pengaturan. |
| description | String | Deskripsi pengaturan. |
| objectStaffIds | Array of String | Daftar userId karyawan yang akan disembunyikan. |
| objectDeptIds | Array of Long | Daftar ID departemen yang akan disembunyikan. |
| objectTagIds | Array of Long | Daftar ID peran yang akan disembunyikan. |
| excludeStaffIds | Array of String | Daftar userId pengguna yang tidak terpengaruh oleh pengaturan penyembunyian ini. |
| excludeDeptIds | Array of Long | Daftar ID departemen yang tidak terpengaruh oleh pengaturan penyembunyian ini. |
| excludeTagIds | Array of Long | Daftar ID peran yang tidak terpengaruh oleh pengaturan penyembunyian ini. |
| active | Boolean | Menunjukkan apakah aturan aktif.   - true: Aktif - false: Nonaktif |
...

{
  ...
  "list" : [ {
    "name" : "Aturan uji",
    "description" : "Disembunyikan dari deptA tetapi terlihat oleh user1.",
...
| 500 | system.error | Failed to get the settings | Gagal mendapatkan pengaturan |
