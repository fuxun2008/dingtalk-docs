---
title: "Mengurutkan ID pengguna di Kontak"
description: "Panggil API ini untuk mengurutkan daftar ID pengguna berdasarkan pinyin nama pengguna di DingTalk, lengkap dengan kode error untuk memudahkan pemecahan masalah."
---

# Mengurutkan ID pengguna di Kontak
...
| --- | --- | --- | --- |
| x-acs-dingtalk-access-token | String | Ya | Kredensial akses untuk memanggil API ini. Dapatkan dengan memanggil [Mendapatkan access token dari organisasi yang diberi otorisasi untuk aplikasi pihak ketiga](https://open.dingtalk.com/document/development/obtain-the-access-token-of-the-authorized-enterprise-1#). |

### Isi permintaan

| Nama | Tipe | Wajib | Deskripsi |
| --- | --- | --- | --- |
| userIdList | Array of String | Ya | ID pengguna. Dapatkan nilai parameter userid dengan memanggil [Mendapatkan ID pengguna menggunakan kode login senyap](/id/open/development/obtain-the-userid-of-a-user-by-using-the-log-free#). |
| sortType | Integer | Tidak | Metode pengurutan. Nilai yang valid:   - **0**: Urutkan berdasarkan pinyin nama secara menaik. - **1**: Urutkan berdasarkan pinyin nama secara menurun. |
...
| --- | --- | --- | --- |
| 500 | listsize.too.long | The userId list contains more than 100 entries. | Daftar userId berisi lebih dari 100 entri. |
