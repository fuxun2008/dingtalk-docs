---
title: "Menghapus pengaturan visibilitas atribut pengguna"
description: "Panggil API ini untuk menghapus pengaturan visibilitas bidang atribut karyawan perusahaan di DingTalk, lengkap dengan parameter permintaan dan bidang respons."
---

Panggil API ini untuk menghapus pengaturan visibilitas bidang atribut karyawan.

## Deskripsi panggilan API

Setelah organisasi memanggil API untuk mengatur visibilitas atribut pengguna, Anda dapat memanggil API ini untuk menghapus pengaturan sembunyi bidang atribut karyawan.
...
| Izin yang diperlukan | permission-Contact.ReachableRule.ReadWrite-Management permissions for contacts data visibility |
...
| Nama | Tipe | Wajib | Deskripsi |
| --- | --- | --- | --- |
| settingId | Long | Ya | ID pengaturan. Dapatkan nilai parameter id dengan memanggil API [Mengatur visibilitas atribut pengguna](/id/open/development/add-or-update-the-hidden-settings-of-the-employee-property#). |
...
| Nama | Tipe | Deskripsi |
| --- | --- | --- |
| result | Boolean | Apakah penghapusan berhasil. true menandakan berhasil. |
...
| --- | --- | --- | --- |
| 400 | parameter.error | Parameter error | Parameter settingId tidak valid |
