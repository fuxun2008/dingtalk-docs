...
| --- | --- | --- | --- | --- |
| access_token | String | Ya | 6ed1bxxx | Kredensial aplikasi yang digunakan untuk memanggil API ini. Dapatkan melalui API untuk memperoleh access_token dari aplikasi internal. |
