---
title: "Pencarian File"
description: "Panggil API File Search DingTalk untuk mencari dan mengambil informasi file yang cocok berdasarkan unionId operator dan kata kunci, lengkap dengan filter kategori, pembuat, dan rentang waktu."
---

Panggil API ini untuk mengambil informasi file berdasarkan unionId operator dan kata kunci.
...
| Izin yang diperlukan | permission-Storage.Dentry.Search-Izin pencarian file |
...
| dentryCategories | Array of String | Tidak | Membatasi kategori file. |
| creatorIds | Array of String | Tidak | Membatasi berdasarkan pembuat. |
| modifierIds | Array of String | Tidak | Membatasi berdasarkan pengubah. |
| createTimeRange | Object | Tidak | Membatasi rentang waktu pembuatan.      Jika tidak ditentukan, semua waktu pembuatan disertakan secara default. |
| startTime | Long | Tidak | Stempel waktu mulai. |
| endTime | Long | Tidak | Stempel waktu akhir. |
| visitTimeRange | Object | Tidak | Membatasi rentang waktu kunjungan.    Jika tidak ditentukan, semua waktu kunjungan disertakan secara default. |
| startTime | Long | Tidak | Stempel waktu mulai. |
| endTime | Long | Tidak | Stempel waktu akhir. |
...
| Nama | Tipe | Deskripsi |
| --- | --- | --- |
| items | Array | Daftar hasil pencarian. Ukuran maksimum: 50. |
| dentryUuid | String | UUID file. |
| name | String | Nama file. |
| creator | Object | Pembuat. |
| userId | String | ID pengguna. |
| name | String | Nama. |
| modifier | Object | Pengubah. |
| userId | String | ID pengguna. |
| name | String | Nama. |
| nextToken | String | Cursor paginasi. Nilai yang tidak kosong menunjukkan bahwa masih ada data yang tersedia. |
...
Jika API ini mengembalikan error, cari solusinya di dokumen [Kode error global](/id/open/development/server-api-error-codes-1) berdasarkan pesan error.
...
| 400 | paramError.searchScopes | %s | Error parameter - searchScopes |
| 400 | paramError.searchTargets | %s | Error parameter - searchTargets |
| 400 | paramError.dentryTypes | %s | Error parameter - dentryTypes |
| 400 | paramError.dentryCategories | %s | Error parameter - dentryCategories |
| 400 | paramError.createTimeRange | %s | Error parameter - createTimeRange |
| 400 | paramError.modifiedTimeRange | %s | Error parameter - modifiedTimeRange |
| 400 | paramError.visitTimeRange | %s | Error parameter - visitTimeRange |
| 403 | spaceNotAccessible | %s | Ruang tidak dapat diakses |
| 403 | workspaceNotAccessible | %s | Knowledge Base tidak dapat diakses |
| 403 | workspaceTeamNotAccessible | %s | Grup Pengetahuan tidak dapat diakses |
