...
| --- | --- | --- | --- | --- |
| access_token | String | Ya | 6ed1xxxx | Kredensial aplikasi untuk memanggil API ini. Dapatkan melalui API untuk memperoleh [access_token dari aplikasi internal](/id/open/development/obtain-orgapp-token). |
