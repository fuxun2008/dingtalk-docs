---
title: "Mendapatkan informasi organisasi"
description: "Panggil API DingTalk untuk mendapatkan informasi penyimpanan organisasi, seperti total kapasitas penyimpanan dan ruang yang telah digunakan."
---

Panggil API ini untuk mengambil informasi penyimpanan organisasi. Misalnya, ruang penyimpanan sebesar 100 GB dan 953,5 MB telah digunakan.
...
| Bidang | Nilai |
| --- | --- |
| URL HTTP | `https://api.dingtalk.io/v1.0/storage/orgs/{corpId}` |
| Metode HTTP | GET |
| Tipe aplikasi yang didukung | appType-Internal app　appType-Third-party enterprise app |
| Izin yang diperlukan | permission-Storage.Org.Read-Organization storage read permission |
...
| Nama | Tipe | Wajib | Deskripsi |
| --- | --- | --- | --- |
| corpId | String | Ya | ID organisasi. |

### Parameter query

| Nama | Tipe | Wajib | Deskripsi |
| --- | --- | --- | --- |
| unionId | String | Ya | unionId pengguna. Panggil API [Query detail pengguna](/id/open/development/query-user-details#) untuk mendapatkannya. |
...
| Nama | Tipe | Deskripsi |
| --- | --- | --- |
| org | Object | Informasi organisasi. |
| corpId | String | ID organisasi. |
| partitions | Array | Daftar informasi kapasitas partisi. |
| partitionType | String | Tipe partisi.   - **PUBLIC_OSS_PARTITION**: Partisi penyimpanan Public Cloud OSS. - **MINI_OSS_PARTITION**: Partisi penyimpanan MiniOSS khusus. |
| quota | Object | Informasi kapasitas. |
| used | Long | Kapasitas yang digunakan, dalam byte. |
| max | Long | Kapasitas maksimum, dalam byte. |
| reserved | Long | Sisa kapasitas yang telah dialokasikan sebelumnya, dalam byte.      Anda dapat mengalokasikan kapasitas ke suatu aplikasi atau ruang di admin console. Bidang ini menunjukkan sisa kapasitas yang telah dialokasikan sebelumnya, yaitu bagian yang belum digunakan dari kapasitas yang telah dialokasikan. Jika tidak ada kapasitas yang dialokasikan sebelumnya, bidang ini kosong. |
| type | String | Tipe kapasitas.   - **SHARE**: Kapasitas organisasi bersama. - **PRIVATE**: Kapasitas khusus. |
...
| 403 | permissionDenied | %s | Pengguna tidak memiliki izin untuk mendapatkan informasi organisasi. |
