---
title: "Query daftar catatan pengunduran diri"
description: "Panggil API ini untuk mengambil daftar catatan pengunduran diri karyawan di organisasi DingTalk — termasuk tanggal resign, nomor telепон, dan cara karyawan meninggalkan organisasi."
---

Panggil API ini untuk mengambil daftar catatan pengunduran diri Organisasi Anda, termasuk tanggal pengunduran diri, nomor telепон, dan cara setiap karyawan yang mengundurkan diri meninggalkan organisasi.

## Deskripsi panggilan API

Sebagai contoh, dalam aplikasi Smart HR sebuah organisasi, catatan pengunduran diri dari 1 Juni 2022 hingga 7 Juni 2022 ditampilkan di bawah ini. Tanggal pengunduran diri karyawan Xiaoding 2 adalah 7 Juni 2022, dan tanggal pengunduran diri DingTalk Test adalah 7 Juni 2022.

Panggil API ini untuk mengambil catatan pengunduran diri dari 1 Juni 2022 hingga 7 Juni 2022, dan Anda dapat memperoleh informasi seperti waktu karyawan Xiaoding 2 dan DingTalk Test meninggalkan organisasi, nomor telепон mereka, serta cara mereka meninggalkan organisasi.
...
| Izin yang diperlukan | permission-Contact.Common.Read-Izin baca untuk data Kontak dasar |
...
| Nama | Tipe | Wajib | Deskripsi |
| --- | --- | --- | --- |
| startTime | String | Ya | Waktu mulai. Format: `YYYY-MM-DDTHH:mm:ssZ` (ISO 8601/RFC 3339). |
| endTime | String | Tidak | Waktu akhir. Format: `YYYY-MM-DDTHH:mm:ssZ` (ISO 8601/RFC 3339). - Jika parameter ini tidak ditentukan, waktu mulai harus berada dalam rentang 365 hari dari waktu saat ini. - Jika parameter ini ditentukan, interval antara waktu mulai dan waktu akhir tidak boleh melebihi 365 hari. |
| nextToken | String | Tidak | Cursor paginasi. - Untuk query pertama, atur parameter ini ke 0. - Untuk query berikutnya, atur parameter ini ke nilai nextToken yang dikembalikan oleh panggilan sebelumnya ke API ini. |
| maxResults | Integer | Ya | Jumlah maksimum entri per halaman. Nilai maksimum: 50. |
...
| Nama | Tipe | Deskripsi |
| --- | --- | --- |
| nextToken | String | Token paginasi untuk permintaan berikutnya. |
| records | Array | Daftar catatan pengunduran diri. |
| userId | String | userId karyawan. |
| name | String | Nama karyawan. |
| stateCode | String | Kode panggilan internasional. |
| mobile | String | Nomor telепон. |
| leaveTime | String | Waktu karyawan meninggalkan organisasi. Format: `YYYY-MM-DDTHH:mm:ssZ` (ISO 8601/RFC 3339). |
| leaveReason | String | Cara karyawan meninggalkan organisasi. Nilai yang valid: - **oapi**: Dihapus melalui panggilan API. - **cancel**: Akun dibatalkan. - **leave**: Pengunduran diri secara sukarela. - **unknown**: Alasan tidak diketahui. - **delete**: Dihapus oleh admin. |
