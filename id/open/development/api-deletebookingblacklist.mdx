---
title: "Menghapus pengguna dari daftar blokir pemesanan ruangan"
description: "Panggil API ini untuk menghapus pengguna dari daftar blokir pemesanan ruang rapat di DingTalk dan memulihkan izin pemesanan mereka dengan cepat."
---

Panggil API ini untuk menghapus pengguna dari daftar blokir pemesanan ruangan.
...
| Nama | Tipe | Wajib | Deskripsi |
| --- | --- | --- | --- |
| blacklistUnionIds | Array of String | Tidak | unionId dari pengguna daftar blokir. Jumlah unionId tidak boleh melebihi 100. |
| unionId | String | Tidak | unionId dari operator. |
...
| Nama | Tipe | Deskripsi |
| --- | --- | --- |
| result | Boolean | Apakah pemanggilan API berhasil. |
...
| 400 | user.over.limit | User Over Limit | Jumlah ID pengguna daftar blokir melebihi batas |
