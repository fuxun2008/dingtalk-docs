---
title: "Mendapatkan informasi unduhan file"
description: "Panggil API ini untuk mendapatkan informasi unduhan file di ruang penyimpanan, termasuk URL unduhan, guna menerapkan proses unduh file di DingTalk."
---

Panggil API ini untuk mendapatkan informasi unduhan file di ruang penyimpanan.
...
Langkah 2: Jalankan proses unduh. Lihat contoh berikut:

```java
public static void main(String[] args) {
        String url = ""; // internalResourceUrls yang dikembalikan oleh API dapatkan informasi unduhan.
        String path = "/Users/xxxxx/Downloads/test.txt"; // Jalur target untuk unduhan file.
        // Header yang dikembalikan oleh API dapatkan informasi unduhan.
        Map<String, String> headers = "" // Header yang diperoleh dari API dapatkan informasi unduhan.
...
<Note>
Jika file terlalu besar dan Anda perlu mengambilnya secara bertahap, tambahkan bidang headers pada contoh di atas: `headers.put("Range","bytes=0-499");`. Untuk detailnya, lihat [Mengunduh sebagian konten dengan menentukan Range](/id/open/development/use-range-download-a-part-of-content).
</Note>
...
| dentryId | String | Ya | ID file. Panggil API [Mendapatkan daftar file atau folder](/id/open/development/get-a-list-of-files-or-folders#) atau API [Mendapatkan spaceId berdasarkan dentryUuid](/id/open/development/api-getdentryidbyuuid#) untuk mendapatkan nilai parameter id. |

### Parameter kueri

| Nama | Tipe | Wajib | Deskripsi |
| --- | --- | --- | --- |
| unionId | String | Ya | unionId dari operator. Panggil API [Mengkueri detail pengguna](/id/open/development/query-user-details#) untuk mendapatkannya. |
...
| version | Long | Tidak | Nomor versi file. Panggil API [Mendapatkan daftar versi file](/id/open/development/obtains-a-list-of-file-versions#) untuk mendapatkan versinya. |
| preferIntranet | Boolean | Tidak | Apakah akan mengutamakan transmisi intranet. Parameter ini memerlukan konfigurasi transmisi intranet penyimpanan khusus. - true: Ya (default) - false: Tidak |
    ...
    public static void main(String[] args_) throws Exception {
        ...
        try {
            ...
            if (!com.aliyun.teautil.Common.empty(err.code) && !com.aliyun.teautil.Common.empty(err.message)) {
                // err contains code and message properties, which help locate issues
            }
...
| Nama | Tipe | Deskripsi |
| --- | --- | --- |
| protocol | String | Protokol unduhan file. - **HEADER_SIGNATURE**: Permintaan bertanda tangan pada header |
| headerSignatureInfo | Object | Informasi permintaan bertanda tangan pada header. Bidang ini berlaku ketika nilai bidang protocol adalah HEADER_SIGNATURE. |
| resourceUrls | Array of String | Beberapa URL unduhan. URL yang tercantum lebih awal memiliki prioritas lebih tinggi. |
...
| internalResourceUrls | Array of String | URL intranet. Bidang ini saat ini belum memiliki kasus penggunaan. Abaikan saja. |
...
Jika terjadi error saat Anda memanggil API ini, temukan solusi berdasarkan pesan error di dokumen [Kode error global](/id/open/development/server-api-error-codes-1).
...
| 400 | fileArchived | %s | File telah diarsipkan. Pembatalan pengarsipan dipicu secara otomatis. Coba lagi nanti. |
