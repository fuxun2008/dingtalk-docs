---
title: "Perbarui rapat yang telah dijadwalkan"
description: "Panggil API ini untuk memperbarui rapat yang telah dijadwalkan di DingTalk, termasuk judul serta waktu mulai dan waktu berakhir, guna mengelola jadwal Rapat Video secara efisien."
---

Perbarui judul, waktu mulai, waktu berakhir, dan informasi lain dari rapat yang telah dijadwalkan.
...
| title | String | Ya | Judul rapat yang telah dijadwalkan. Panjang maksimum adalah 50 karakter. |
| startTime | Long | Ya | Waktu mulai rapat yang telah dijadwalkan, sebagai stempel waktu UTC dalam milidetik. |
| endTime | Long | Ya | Waktu berakhir rapat yang telah dijadwalkan, sebagai stempel waktu UTC dalam milidetik. |
...

{
  ...
  "title" : "Judul rapat yang dijadwalkan",
...
public class Sample {
    ...
    public static void main(String[] args_) throws Exception {
        ...
        com.aliyun.dingtalkconference_1_0.models.UpdateScheduleConferenceRequest updateScheduleConferenceRequest = new com.aliyun.dingtalkconference_1_0.models.UpdateScheduleConferenceRequest()
                ...
                .setTitle("Judul rapat yang dijadwalkan")
...
func _main (args []*string) (_err error) {
  ...
  updateScheduleConferenceRequest := &dingtalkconference_1_0.UpdateScheduleConferenceRequest{
    ...
    Title: tea.String("Judul rapat yang dijadwalkan"),
...
| Nama | Tipe | Deskripsi |
| --- | --- | --- |
| success | Boolean | Apakah pemanggilan API berhasil. |
...
Jika pemanggilan API mengembalikan error, cari solusinya di dokumen [Kode error global](/id/open/development/server-api-error-codes-1) berdasarkan pesan error.
...
| 400 | resourceCancel | Schedule conference has canceled | Rapat yang telah dijadwalkan telah dibatalkan |
