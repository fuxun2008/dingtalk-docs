...
1. Untuk alur konfigurasi lengkap, lihat [Catatan Rilis 2022.08.16 — YiDA Cool Dasbor (Layanan Data + Kartu Data Cool)](https://docs.aliwork.com/docs/yida_support/yida_updates/mw0bmqngpgz6sxba/gnpfzt).
...
Buka Data Factory > Layanan Data > Buat Bidang Formula, dan gunakan Formula untuk mengonversi ke persentase. Lihat konfigurasi di bawah ini sebagai referensi. Untuk detail lengkap, lihat [Catatan Rilis 2022.08.16 — YiDA Cool Dasbor (Layanan Data + Kartu Data Cool)](https://docs.aliwork.com/docs/yida_support/yida_updates/mw0bmqngpgz6sxba/gnpfzt).
