---
title: "Contoh komponen kustom - Daftar aplikasi"
description: "Panduan membuat dan mengonfigurasi komponen kustom Yida untuk menampilkan daftar aplikasi — mencakup skenario penggunaan, demo tampilan, dan langkah impor schema di desainer formulir."
polished: true
---

<Note>
- Gunakan komponen ini sebagai referensi untuk mengonfigurasi atribut dan dukungan multi-perangkat.
- Perhatian: komponen ini disediakan hanya untuk tujuan pembelajaran dan bukan komponen standar yang ditawarkan oleh platform.
</Note>

## 1. Skenario penggunaan

Fitur **Daftar aplikasi** umumnya digunakan pada halaman tampilan.
...
##### 2. Aktifkan fitur impor schema. Prosesnya sama seperti pada desainer formulir Yida. Untuk detail selengkapnya, lihat langkah berikut:

- Buka desainer komponen, buka console browser, lalu jalankan kode di bawah ini.

```javascript
document.querySelector('.lc-left-area-bottom div:last-child').style.display = 'block'
```

##### 3. Tempel schema di bawah ini ke console schema pada desainer komponen, lalu klik Impor schema.
        ...
        "__propTypes__": [
          {
            ...
            "__batchEditFormatToLines__": {
              ...
              "__initMethods__": {
              "type": "js",
              "source": "function (exports, module) { /*tetapkan kode actions di sini*/ }",
              "compiled": "function (exports, module) { /*tetapkan kode actions di sini*/ }"
            }
            },
              "propTypes": [
              {
              ...
              "name": "urlParams",
              "description": "Parameter dari URL halaman saat ini. Misalnya, pada aliwork.com/APP_xxxx/workbench?id=1&name=Yida, ambil Yida melalui this.state.urlParams.name.",
