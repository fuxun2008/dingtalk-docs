...
<CardGroup cols={2}>
  <Card title="Ringkasan solusi terbuka Process Center" icon="sitemap" href="/zh/approval/open-solution-overview">
    Ringkasan empat solusi untuk mengintegrasikan sistem bisnis perusahaan ke DingTalk Persetujuan OA
  </Card>
  <Card title="Integrasi proses dan halaman DingTalk" icon="link" href="/zh/approval/open-dingtalk-process">
