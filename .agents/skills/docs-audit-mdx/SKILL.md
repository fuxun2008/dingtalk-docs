...
name: docs-audit-mdx
version: 1.0.0
description: "Audit MDX quality (broken bold, ++text++ residue, syntax defects) and probe DingTalk external dead links in one pass, producing a report or applying fixes. Use before committing a translation batch or as a periodic health check."
description_zh: "MDX 质量审计 + 外链死链清理：串起 audit_mdx_quality.py 与 check_external_links.py，一次性出报告或落盘修复。"
user-invocable: true
argument-hint: "[--root <name>] [--apply]"
---
# MDX 质量审计 + 外链死链清理
