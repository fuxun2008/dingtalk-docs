---
name: docs-translate-batch
version: 1.0.0
description: "Batch-translate a whole zh/<root>/ product directory into English and Japanese with glossary constraints, image/video stripping, link-prefix correction and dead-link verification. Supports resume and force retranslation."
description_zh: "产品目录级批量翻译（zh → en + ja）：整个产品目录批量翻译，含词库约束、图视频剥离、链接前缀修正、死链验证。"
user-invocable: true
argument-hint: "<root> [--force] [--limit N]"
---
# 产品目录级批量翻译（zh → en + ja）
