---
name: docs-glossary-sync
version: 1.0.0
description: "Merge the official zh-en-ja glossary CSV exports maintained by the language team into scripts/glossary/zh-en.json and zh-ja.json consumed by the translation pipeline, and report the merge diff and conflicts."
description_zh: "翻译词库同步：把官方「中文-英文-日文」词库 csv 合并进项目，生成 scripts/glossary/zh-en.json 与 zh-ja.json。"
user-invocable: true
argument-hint: "[--dry-run] [--source <csv-path>]"
---
# 翻译词库同步
